...
import { deleteTags, fetchItems, fetchTags, writeItems } from "../../src/api/utils";
...
jest.mock("../../src/api/utils", () => {
	...
	return {
		...originalModule,
		deleteTags: jest.fn(originalModule.deleteTags),
		writeItems: jest.fn(originalModule.writeItems)
	};
});
