 ...
 * @param {(ZoteroAPI.Item)[]} datastore - The items to categorize 
 * @returns {{items: ZoteroAPI.ItemTop[], pdfs: ZoteroAPI.ItemAttachment[], notes: (ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]}} The categorized object
 */
 ...
 * @param {(ZoteroAPI.Item)[]} arr - The library's contents, including top-level items, attachments and notes/annotations
 ...
 * @param {ZoteroAPI.ItemAttachment[]} pdfs - The Zotero item's attached PDFs
 * @param {(ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]} notes - The Zotero item's notes and annotations
 * @param {Map<String, String>} roamCitekeys - The map of citekey pages in the Roam graph. Each entry contains the page's UID.
 ...
 * @param {ZoteroAPI.ItemAttachment} pdf - The Zotero PDF entry
 * @param {ZoteroAPI.ItemTop} parent - The Zotero PDF's parent item
 * @param {ZoteroAPI.ItemAnnotation[]} annotations - The Zotero PDF's linked annotations
...
/**
 * @typedef {CleanSemanticItem & {
 * inGraph: (Boolean|String), 
 * inLibrary: (Boolean|{children: {pdfs: ZoteroAPI.ItemAttachment[], notes: (ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]}, raw: ZoteroAPI.ItemTop})
 * }}
 * CleanSemanticReturn
 */
 ...
 * @param {{items?: ZoteroAPI.ItemTop[], pdfs?: ZoteroAPI.ItemAttachment[], notes?: (ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]}} datastore - The categorized list of Zotero items to match against 
 ...
 * @param {ZoteroAPI.Item[]} datastore - The list of Zotero items to match against 
 ...
 * @param {ZoteroAPI.ItemTop} a - The first item to compare
 * @param {ZoteroAPI.ItemTop} b - The second item to compare
 * @returns {(-1|1)} The comparison outcome
 */
 ...
 * @param {ZoteroAPI.ItemAnnotation} annotation - The (raw) annotation to be formatted
 ...
 * @param {ZoteroAPI.ItemAnnotation[]} annotations - The (raw) array of annotations to be formatted 
 ...
 * @param {{ZoteroAPI.ItemNote}[]} notes - The (raw) array of notes to be formatted
 ...
 * @param {ZoteroAPI.ItemTop} item - The item to convert 
 ...
 * @param {ZoteroAPI.ItemAnnotation[]} annotations - The Zotero annotations to format
 ...
 * @param {ZoteroAPI.ItemNote[]} notes - The Zotero notes to format
 ...
 * @param {ZoteroAPI.ItemAttachment} pdfItem - The targeted Zotero PDF item
 ...
 * @param {{pdfs?: ZoteroAPI.ItemAttachment[], notes?: (ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]}} data - The items among which children are to be identified 
 ...
 * @param {{items?: ZoteroAPI.ItemTop[], notes?: (ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]}} data - The items among which connections are to be identified 
 ...
 * @param {ZoteroAPI.ItemAnnotation[]} annotations - The list of annotations to simplify
 ...
 * @param {ZoteroAPI.Collection} parent - The parent collection
 * @param {ZoteroAPI.Collection[]} children - Child collections among which to identify the parent's children
 ...
 * @param {ZoteroAPI.Collection[]} arr - The array of Zotero collections to sort
 * @returns The sorted array
 */
