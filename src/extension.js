...
export default class ZoteroRoam {
     ...
     * @param {(ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]} notes 
     * @returns 
     */
	formatNotes(notes) {
     ...
     * @param {ZoteroAPI.ItemTop} item - The targeted item
     ...
     * @param {ZoteroAPI.ItemTop} item - The targeted item
     * @param {ZoteroAPI.ItemAttachment[]} pdfs - The item's linked PDFs, if any
     * @param {(ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]} notes - The item's linked notes, if any
     * @returns 
     */
     ...
     * @param {ZoteroAPI.Item} item - The targeted item
 ...
 * @param {(ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]} notes - The Array of Zotero notes/annotations
 ...
 * @param {ZoteroAPI.Item} item - The targeted Zotero item
 ...
 * @param {ZoteroAPI.ItemTop} item - The targeted Zotero item
 * @param {ZoteroAPI.ItemAttachment[]} pdfs - The item's PDFs, if any
 * @param {(ZoteroAPI.ItemNote|ZoteroAPI.ItemAnnotation)[]} notes - The item's linked notes, if any
 * @param {{
 * annotationsSettings: SettingsAnnotations,
 * notesSettings: SettingsNotes,
