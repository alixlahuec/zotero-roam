/* @alixlahuec/zotero-roam | 0.6.65 | 2021-11-06 */
...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.65",data:{items:[],collections:[],semantic:new Map,libraries:new Map,keys:[],roamPages:[]},librarySearch:{autocomplete:null},activeImport:{libraries:[],currentLib:{}},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations",activeImport:null},webImport:{currentBlock:null,activeImport:null},tagSelection:{cit_panel:null,aux_panel:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{var a=e.sort((t,a)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==a.key)?-1:1);return Array.from(new Set(a.map(e=>e.value.key))).map(t=>a.find(e=>e.value.key==t))}},selector:"#zotero-roam-search-autocomplete",placeHolder:"Search by title, year, authors (last names), citekey, tags",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t,highlight=['<span class="zr-search-match">',"</span>"]),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,tabSelect:!0,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
                            ...
                            `,e.closest("#zotero-roam-library-rendered").setAttribute("has-results","true"))}},resultItem:{tag:"li",class:"zotero-roam-search_result",id:"zotero-roam-search_result",highlight:!1,element:(e,t)=>{let a="";a=t.value.inGraph?(e.setAttribute("in-graph","true"),'<span class="bp3-icon bp3-icon-symbol-circle"></span>'):(e.setAttribute("in-graph","false"),'<span class="bp3-icon bp3-icon-minus"></span>'),e.setAttribute("data-item-type",t.value.itemType);let{title:o,authors:r,meta:i}=t.value;switch(r+=t.value.year?` (${t.value.year})`:"",t.key){case"title":o=t.match;break;case"authorsString":case"year":r=`<span class="zr-search-match">${r}</span>`}e.innerHTML=`
                        <div label="${t.value.key}" class="bp3-menu-item">
                            ...
                            <span class="zr-secondary" style="font-size:0.8em;">@${t.value.key}</span>
                            ${a}
                            </span>
            ...
            `;let i=new Map(zoteroRoam.utils.getAllRefPages());var n="added-on"==o?"timestamp":"meta";let s=t.map(t=>{var e=zoteroRoam.data.items.find(e=>e.key==t),a=e.meta.parsedDate?`(${new Date(e.meta.parsedDate).getUTCFullYear()})`:"",o=e.meta.creatorSummary+" "||"",r=i.get("@"+t)||!1;return{abstract:e.data.abstractNote||"",key:t,meta:`${o}${a}`,title:e.data.title||"",inGraph:r,added:e.data.dateAdded,itemType:e.data.itemType,timestamp:zoteroRoam.utils.makeTimestamp(e.data.dateAdded)}}).sort((e,t)=>e[`${n}`].toLowerCase()<t[`${n}`].toLowerCase()?-1:1);t=s.map(t=>{let a="";if(t.inGraph){let e="@"+t.key;a=zoteroRoam.utils.renderBP3ButtonGroup("Go to page",{buttonClass:"zotero-roam-list-item-go-to-page",divClass:"bp3-minimal bp3-small",icon:"symbol-circle",modifier:"bp3-intent-success",buttonModifier:`data-uid="${t.inGraph}" data-citekey="${e.slice(1)}"`})}else a=zoteroRoam.utils.renderBP3Button_group("Add to Roam",{icon:"minus",buttonClass:"bp3-minimal bp3-intent-warning bp3-small zotero-roam-add-to-graph"});return`
                ...
                <div class="bp3-menu-item" label="${t.key}">
                    ...
                    <div class="bp3-text-overflow-ellipsis bp3-fill zotero-roam-item-contents">
                        ...
                        <span class="zotero-roam-list-item-key zr-auxiliary">[${t.key}]</span>
