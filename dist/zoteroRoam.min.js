            ...
            `,t.appendChild(R),zoteroRoam.interface.citations.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.citations.input=document.querySelector("#zotero-roam-citations-autocomplete"),zoteroRoam.interface.citations.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-overlay-close`),Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll(".zotero-roam-page-control")).forEach(t=>{t.addEventListener("click",e=>{zoteroRoam.interface.changePage(goto=t.getAttribute("goto"))})}),d.addEventListener("click",function(e){let a=e.target.closest("button");if(a)if(a.classList.contains("zotero-roam-citation-copy-doi"))zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value=a.dataset.doi,zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").select(),document.execCommand("copy");else if(a.classList.contains("zotero-roam-citation-toggle-abstract")){let e=a.querySelector(".bp3-button-text"),t=a.closest(".zotero-roam-citations-search_result").querySelector(".zotero-roam-citation-abstract");"none"==t.style.display?(t.style.display="block",e.innerHTML="Hide Abstract"):(t.style.display="none",e.innerHTML="Show Abstract")}else a.classList.contains("zotero-roam-citation-add-import")&&zoteroRoam.interface.triggerImport(type="citations",element=a.closest(".bp3-menu-item"))})},fillDashboardOverlay(){let e=document.querySelector(".zotero-roam-dashboard-overlay .main-panel"),t=[{name:"tag-manager",icon:"tag",title:"Tag Manager",description:'Rename, merge, and delete tags - harmonize tags between <span data-tag-source="roam">Roam</span> and <span data-tag-source="zotero">Zotero</span>'}],a=document.createElement("div");a.classList.add("side-section");let o=document.createElement("div");o.classList.add("bp3-tabs"),o.classList.add("bp3-vertical");let r=document.createElement("ul");r.classList.add("bp3-tab-list"),r.setAttribute("role","tablist"),t.forEach((e,t)=>{r.innerHTML+=`
                ...
                <div class="bp3-tab-panel" role="tabpanel" name="${e.name}" ${0==t?"":'aria-hidden="true"'}>
                    <div class="zr-tab-panel-header">
                        <span class="zr-auxiliary">${e.description}</span>
                ...
                `}),e.appendChild(a),e.appendChild(i);let n=document.querySelector('.zotero-roam-dashboard-overlay .bp3-tab-panel[name="tag-manager"]');n.innerHTML+=`
