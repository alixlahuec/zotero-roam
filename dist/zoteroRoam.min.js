...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},autoComplete:null,config:{autoComplete:{data:{src:async function(){return 0==zoteroRoam.data.items.length?[]:zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)},key:["title","authorsLastNames","year","tagsString","key"],cache:!1,results:e=>{return Array.from(new Set(e.map(e=>e.index))).map(t=>e.find(e=>e.index===t))}},selector:"#zotero-search-autocomplete",searchEngine:"strict",trigger:{event:["input","focus"]},highlight:!0,maxResults:100,sort:(e,t)=>e.value.authors.toLowerCase()<t.value.authors.toLowerCase()?-1:e.value.authors.toLowerCase()>t.value.authors.toLowerCase()?1:0,resultsList:{className:"zotero-search-results-list",idName:"zotero-search-results-list",container:e=>{e.classList.add("bp3-menu")}},resultItem:{element:"li",className:"zotero-search_result",idName:"zotero-search_result",content:(e,t)=>{var o,a=`<span class="zotero-search-item-metadata"> ${e.value.meta}</span>`,r=`<span class="zotero-search-item-title" style="font-weight:bold;color:black;display:block;">${"title"==e.key?e.match:e.value.title}</span>`,n=`<span class="bp3-menu-item-label zotero-search-item-key">${"key"==e.key?e.match:e.value.key}</span>`;let i="";e.value.year&&(o="year"==e.key?e.match:e.value.year,i=`<span class="zotero-search-item-year"> (${o})</span>`);let s="";e.value.authors&&(s="authorsLastNames"==e.key?`<span class="zotero-search-item-authors autoComplete_highlighted">${e.value.authors}</span>`:`<span class="zotero-search-item-authors">${e.value.authors}</span>`);let c="";e.value.tagsString&&(o="tagsString"==e.key?e.match:e.value.tagsString,c=`<span class="zotero-search-item-tags" style="font-style:italic;color:#c1c0c0;display:block;">${o}</span>`),t.innerHTML=`<a label="${e.value.key}" class="bp3-menu-item bp3-popover-dismiss">
                                            ...
                                            ${n}
                                            </a>`}},noResults:(e,t)=>{t(zoteroRoam.autoComplete,e,e.results);const o=document.createElement("li");o.setAttribute("class","no_result"),o.setAttribute("tabindex","1"),o.innerHTML=`<span style="display: flex; align-items: center; font-weight: 100; color: rgba(0,0,0,.2);">Found No Results for "${e.query}"</span>`,document.querySelector(`#${zoteroRoam.autoComplete.resultsList.idName}`).appendChild(o)},onSelection:t=>{zoteroRoam.interface.search.input.blur();var o=document.querySelector("#zotero-quick-copy-mode").checked;if(1==zoteroRoam.config.params.always_copy||o&&!zoteroRoam.config.params.override_quickcopy.overridden){let e=document.querySelector("input.clipboard-copy-utility");switch(zoteroRoam.config.params.quick_copy_format){case"citation":e.value=`[]([[@${t.selection.value.key}]])`;break;case"tag":e.value=`#[[@${t.selection.value.key}]]`;break;case"pageref":e.value=`[[@${t.selection.value.key}]]`;case"citekey":default:e.value=`@${t.selection.value.key}`}e.select(),document.execCommand("copy"),o&&!zoteroRoam.config.params.override_quickcopy.overridden?zoteroRoam.interface.toggleSearchOverlay("hide"):zoteroRoam.interface.renderSelectedItem(t)}}},params:{override_quickcopy:{overridden:!1},always_copy:!1,quick_copy_format:"citekey"},requests:{},shortcuts:[],userSettings:{}},data:{items:[],collections:[]},funcmap:{DEFAULT:"zoteroRoam.formatting.getItemMetadata"},typemap:{artwork:"Illustration",audioRecording:"Recording",bill:"Legislation",blogPost:"Blog post",book:"Book",bookSection:"Chapter",case:"Legal case",computerProgram:"Data",conferencePaper:"Conference paper",document:"Document",email:"Letter",encyclopediaArticle:"Encyclopaedia article",film:"Film",forumPost:"Forum post",hearing:"Hearing",instantMessage:"Instant message",interview:"Interview",journalArticle:"Article",letter:"Letter",magazineArticle:"Magazine article",manuscript:"Manuscript",map:"Image",newspaperArticle:"Newspaper article",patent:"Patent",podcast:"Podcast",presentation:"Presentation",radioBroadcast:"Radio broadcast",report:"Report",statute:"Legislation",thesis:"Thesis",tvBroadcast:"TV broadcast",videoRecording:"Recording",webpage:"Webpage"},addAutoCompleteCSS(){let e=document.createElement("style");e.textContent=`ul#zotero-search-results-list::before{content:attr(aria-label);}
