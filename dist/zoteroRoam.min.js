                            ...
                            <br>(* searchable fields are : title, year, authors, tags, citekey. A more fully-featured search will be available down the road)`,n.appendChild(s);let c=document.createElement("div");c.classList.add("bp3-input-group");let l=document.createElement("input");l.id="zotero-search-autocomplete",l.tabIndex="1",l.type="text",l.classList.add("bp3-input"),l.classList.add("bp3-fill"),l.style="margin-bottom:20px;",c.appendChild(l),n.appendChild(c);let d=document.createElement("div");d.id="zotero-search-selected-item",d.classList.add("bp3-card"),d.style="width:95%;margin:0 auto;display:none;";let u=document.createElement("div");u.classList.add("selected-item-header");let m=document.createElement("div");m.classList.add("selected-item-body"),d.appendChild(u),d.appendChild(m),n.appendChild(d),i.innerHTML=`<div class="bp3-dialog-footer-actions">
                                    ...
                                    <div class="item-citekey">
                                        <div class="bp3-control-group">
                                            <div class="bp3-input-group bp3-fill"><input type="text" class="bp3-input" value="${a}" readonly></div>
                                        </div>
