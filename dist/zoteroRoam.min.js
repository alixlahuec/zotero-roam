/* @alixlahuec/zotero-roam | 0.6.30 | 2021-07-24 */
...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.30",data:{items:[],collections:[],semantic:[],libraries:[],keys:[]},librarySearch:{autocomplete:null},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations"},tagSelection:{autocomplete:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{const t=Array.from(new Set(e.map(e=>e.value.key))).map(t=>e.filter(e=>e.value.key==t).sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1)[0]);return t.sort((e,t)=>0==e.value.authors.length?2:e.value.authors.toLowerCase()<t.value.authors.toLowerCase()||0==t.value.authors.length?0:1)}},selector:"#zotero-roam-search-autocomplete",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            `;var x=h.uid||"";document.querySelector("button.item-add-metadata").addEventListener("click",function(){console.log("Importing metadata..."),zoteroRoam.handlers.importItemMetadata(a,x,{popup:!0})}),Array.from(document.querySelectorAll(".item-citekey-section .copy-buttons a.bp3-button[format]")).forEach(o=>{o.addEventListener("click",e=>{switch(o.getAttribute("format")){case"citekey":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`${a}`;break;case"citation":var t=`${r.meta.creatorSummary||""}${n||""}`;zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`[${t}]([[${a}]])`;break;case"tag":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`#[[${a}]]`;break;case"page-reference":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`[[${a}]]`}zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").select(),document.execCommand("copy")})});try{let t=document.querySelector("button.item-see-notes");t.addEventListener("click",function(){let e=t.querySelector(".bp3-button-text").innerHTML;switch(!0){case e.startsWith("Show"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Show","Hide");break;case e.startsWith("Hide"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Hide","Show")}})}catch(e){}switch(document.querySelector("#zotero-roam-library-rendered").setAttribute("view","item"),zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")){case"true":document.querySelector("h4.item-title").focus();break;case"false":zoteroRoam.interface.toggleSearchOverlay("show",{focus:!1})}},clearSelectedItem(){try{zoteroRoam.interface.search.selectedItemDiv.children.forEach(e=>{e.innerHTML=""})}catch(e){Array.from(zoteroRoam.interface.search.selectedItemDiv.children).forEach(e=>{e.innerHTML=""})}zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML="","visible"==zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").getAttribute("side-panel")&&zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),document.querySelector("#zotero-roam-library-rendered").setAttribute("view","search")},checkEditingMode(){let e=document.querySelector("textarea.rm-block-input");e&&null==e.getAttribute("zotero-tribute")&&(document.querySelectorAll(".zotero-roam-tribute").forEach(e=>e.remove()),e.setAttribute("zotero-tribute","active"),new Tribute(zoteroRoam.config.tribute).attach(e),e.addEventListener("tribute-replaced",o=>{if("zotero"==o.detail.item.source){let e=document.querySelector("textarea.rm-block-input");var a=o.detail.context.mentionTriggerChar+o.detail.context.mentionText,r=o.detail.context.mentionPosition,i=o.detail.item.original.value;let t=o.target.defaultValue;o=zoteroRoam.utils.escapeRegExp(a),o=new RegExp(o,"g"),o=t.replaceAll(o,(e,t)=>t==r?i:e);zoteroRoam.interface.tributeTrigger=a,zoteroRoam.interface.tributeBlockTrigger=e,zoteroRoam.interface.tributeNewText=o,Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value").set.call(e,o);o=new Event("input",{bubbles:!0});e.dispatchEvent(o)}}))},addToImport(e){var t=e.querySelector(".zotero-roam-citation-identifier-link").innerText,o=e.querySelector(".zotero-roam-search-item-title").innerText,a=e.querySelector(".zotero-roam-citation-origin").innerText;null==zoteroRoam.interface.activeImport?(zoteroRoam.interface.activeImport={libraries:zoteroRoam.utils.getLibraries(),items:[],currentLib:{},pages:zoteroRoam.utils.getRoamPages(),outcome:null},zoteroRoam.tagSelection.autocomplete.init(),zoteroRoam.interface.renderImportOptions(),zoteroRoam.interface.addToImport(e),zoteroRoam.interface.citations.overlay.querySelector('button[role="add"]').removeAttribute("disabled"),zoteroRoam.interface.citations.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible")):(zoteroRoam.interface.citations.overlay.querySelector('button[role="done"]')&&zoteroRoam.interface.clearImportPanel(action="reset"),zoteroRoam.interface.activeImport.items.includes(t)||(zoteroRoam.interface.activeImport.items.push(t),zoteroRoam.interface.citations.overlay.querySelector(".import-items").innerHTML+=`
                ...
                `:"",i.parentElement.appendChild(m);let e=page.parentElement.querySelector(".zotero-roam-page-menu");null==e&&(e=document.createElement("div"),e.classList.add("zotero-roam-page-menu"),e.classList.add("bp3-card"),zoteroRoam.config.params.theme&&e.classList.add(zoteroRoam.config.params.theme),m.appendChild(e));var p=d.includes("addMetadata")?zoteroRoam.utils.renderBP3Button_group(string="Add metadata",{buttonClass:"bp3-minimal zotero-roam-page-menu-add-metadata",icon:"add"}):"",u=d.includes("importNotes")&&c.notes?zoteroRoam.utils.renderBP3Button_group(string="Import notes",{buttonClass:"bp3-minimal zotero-roam-page-menu-import-notes",icon:"comment"}):"",g=d.includes("viewItemInfo")?zoteroRoam.utils.renderBP3Button_group(string="View item information",{buttonClass:"bp3-minimal zotero-roam-page-menu-view-item-info",icon:"info-sign"}):"",h=d.includes("openZoteroLocal")?zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-local",target:zoteroRoam.formatting.getLocalLink(o,{format:"target"}),linkAttribute:'target="_blank"',icon:"application"}):"",y=d.includes("openZoteroWeb")?zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-web",target:zoteroRoam.formatting.getWebLink(o,{format:"target"}),linkAttribute:'target="_blank"',icon:"cloud"}):"",f=d.includes("pdfLinks")&&c.pdfItems?c.pdfItems.map(e=>{var t="group"==e.library.type?`groups/${e.library.id}`:"library",t=["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`zotero://open-pdf/${t}/items/${e.data.key}`:e.data.url,e=e.data.filename||e.data.title;return zoteroRoam.utils.renderBP3Button_link(string=e,{linkClass:"bp3-minimal zotero-roam-page-menu-pdf-link",icon:"paperclip",target:t,linkAttribute:'target="_blank"'})}).join(""):"";let t=[];d.includes("connectedPapers")&&t.push(zoteroRoam.utils.renderBP3Button_link(string="Connected Papers",{icon:"layout",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-connected-papers",linkAttribute:'target="_blank"',target:`https://www.connectedpapers.com/${o.data.DOI?"api/redirect/doi/"+n:"search?q="+encodeURIComponent(o.data.title)}`})),d.includes("semanticScholar")&&t.push(n?zoteroRoam.utils.renderBP3Button_link(string="Semantic Scholar",{icon:"bookmark",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-semantic-scholar",linkAttribute:'target="_blank"',target:`https://api.semanticscholar.org/${n}`}):""),d.includes("googleScholar")&&t.push(zoteroRoam.utils.renderBP3Button_link(string="Google Scholar",{icon:"learning",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-google-scholar",linkAttribute:'target="_blank"',target:`https://scholar.google.com/scholar?q=${o.data.DOI?n:encodeURIComponent(o.data.title)}`}));let l="",a=null;if(d.includes("citingPapers")&&n&&(a=await zoteroRoam.handlers.getSemantic(n),a.data)){let o=a.citations.filter(e=>e.doi).map(e=>e.doi);var b=a.references.filter(e=>e.doi).map(e=>e.doi);let t=[...o,...b];if(0<t.length){let s=zoteroRoam.data.items.filter(e=>e.data.DOI).filter(e=>t.includes(zoteroRoam.utils.parseDOI(e.data.DOI)));if(s.forEach((e,t)=>{e=zoteroRoam.utils.parseDOI(e.data.DOI);o.includes(e)?s[t].type="citing":s[t].type="cited"}),l="",l+=zoteroRoam.utils.renderBP3Button_group(string=`${0<b.length?b.length:"No"} references`,{buttonClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-references-total",icon:"citation",buttonAttribute:`data-doi="${n}" data-citekey="${itemCitekey}" ${0<b.length?"":"disabled"}`}),l+=zoteroRoam.utils.renderBP3Button_group(string=`${0<o.length?o.length:"No"} citing papers`,{buttonClass:"bp3-minimal bp3-intent-warning zotero-roam-page-menu-backlinks-total",icon:"chat",buttonAttribute:`data-doi="${n}" data-citekey="${itemCitekey}" ${0<o.length?"":"disabled"}`}),l+=zoteroRoam.utils.renderBP3Button_group(string=`${0<s.length?s.length:"No"} related library items`,{buttonClass:`bp3-minimal ${0<s.length?"":"bp3-disabled"} zotero-roam-page-menu-backlinks-button`,icon:"caret-down bp3-icon-standard rm-caret rm-caret-closed"}),0<s.length){let e=s.filter(e=>"citing"==e.type),t=s.filter(e=>"cited"==e.type),o=[],a=[];0<t.length&&(o=t.sort((e,t)=>e.meta.creatorSummary<t.meta.creatorSummary?-1:1).map(e=>{var t=zoteroRoam.utils.lookForPage("@"+e.key);return!0!==t.present?`
                                                ...
                                                </li>`})),0<e.length&&(a=e.sort((e,t)=>e.meta.creatorSummary<t.meta.creatorSummary?-1:1).map(e=>{var t=zoteroRoam.utils.lookForPage("@"+e.key);return!0!==t.present?`
                                                ...
                                                </li>`}));let r=[...o,...a];b=Math.ceil(r.length/2);let i=[],n=[];n=o.length>b?(i=o.slice(0,b),[...a,...o.slice(-(b-a.length))]):(i=r.slice(0,b),r.slice(-b)),l+=`
