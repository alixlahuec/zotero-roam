/* @alixlahuec/zotero-roam | 0.6.91 | 2021-12-06 */
...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.91",data:{items:[],collections:[],semantic:new Map,libraries:new Map,keys:[],roamPages:[],tags:{}},librarySearch:{autocomplete:null},activeImport:{libraries:[],currentLib:{}},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations",activeImport:null},webImport:{currentBlock:null,activeImport:null},tagSelection:{cit_panel:null,aux_panel:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{var a=e.sort((t,a)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==a.key)?-1:1);return Array.from(new Set(a.map(e=>e.value.key))).map(t=>a.find(e=>e.value.key==t))}},selector:"#zotero-roam-search-autocomplete",placeHolder:"Search by title, year, authors (last names), citekey, tags",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",document.getElementById("zotero-roam-library-rendered").removeAttribute("has-results"),!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t,highlight=['<span class="zr-search-match">',"</span>"]),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,tabSelect:!0,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,o.appendChild(r);let i=document.createElement("div");i.classList.add("header-bottom");let n=document.createElement("span");n.classList.add("zr-search-scope"),n.innerHTML='Zotero library <span class="bp3-icon bp3-icon-chevron-right"></span>';let s=document.createElement("input");s.id="zotero-roam-search-autocomplete",s.tabIndex="1",s.type="text",s.classList.add("bp3-input"),i.appendChild(n),i.appendChild(s),a.appendChild(o),a.appendChild(i),t.appendChild(a);let l=document.createElement("div");l.id="zotero-roam-library-rendered",l.setAttribute("view","search");let c=document.createElement("div");c.id="zotero-roam-library-search-div";let m=document.createElement("div");m.id="zotero-roam-search-selected-item";let d=document.createElement("div");d.classList.add("selected-item-header");let p=document.createElement("div");p.classList.add("selected-item-body"),m.appendChild(d),m.appendChild(p),l.appendChild(c),l.appendChild(m),t.appendChild(l);let u=document.createElement("div");u.classList.add("bp3-dialog-footer-actions"),u.innerHTML=`
            <div>
            ...
            `},closeAuxiliaryOverlay(){let e=document.querySelector(".zotero-roam-auxiliary-overlay");e.style.display="none",e.setAttribute("overlay-visible","false"),zoteroRoam.interface.clearImportPanel(action="close",type="weblinks")},closeCitationsOverlay(){zoteroRoam.interface.citations.overlay.style.display="none",zoteroRoam.interface.citations.input.value="",zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value="",zoteroRoam.interface.clearImportPanel(action="close",type="citations"),zoteroRoam.interface.citations.overlay.setAttribute("overlay-visible","false")},popContextOverlay(e,t){e.preventDefault();var a={left:e.pageX,top:e.pageY};return zoteroRoam.interface[`${t}`].position(a),zoteroRoam.interface.contextTarget=e.target,!1},async popContextMenu(e){zoteroRoam.interface.popContextOverlay(e,"contextMenu"),await zoteroRoam.utils.sleep(120);try{document.querySelector("body > .bp3-context-menu+.bp3-portal").style.display="none"}catch(e){}},popIconContextMenu(e){zoteroRoam.interface.popContextOverlay(e,"iconContextMenu")},popItemInformation(e){e=e.parentElement.dataset.linkTitle.replace("@","");zoteroRoam.interface.renderItemInPanel(e)},renderItemInPanel(e){let r=e.startsWith("@")?e:"@"+e,n=zoteroRoam.data.items.find(e=>e.key==r.slice(1));var s=n.meta.parsedDate?` (${new Date(n.meta.parsedDate).getUTCFullYear().toString()})`:"",t=0<n.data.creators.length?`<span class="zotero-roam-search-item-authors zr-highlight">${n.meta.creatorSummary||""}${s}</span>`:"";let a=n.data.publicationTitle||n.data.bookTitle||n.data.university||"";a=2<a.length?`<span class="zr-secondary">${a}</span>`:"";let o="";n.data.DOI?(f=zoteroRoam.utils.parseDOI(n.data.DOI))&&(o=`
                ...
                </span>`);var l=n.data.creators.map(e=>e.name||[e.firstName,e.lastName].filter(Boolean).join(" ")),c=n.data.creators.map(e=>e.creatorType);let m="";if(0<l.length)for(m="<strong>Contributors : </strong>",i=0;i<l.length;i++){var d=zoteroRoam.utils.lookForPage(title=l[i]),p=1==d.present?zoteroRoam.utils.renderPageReference(title=l[i],uid=d.uid):zoteroRoam.utils.renderBP3Tag(string=l[i],{modifier:"bp3-intent-primary item-creator-tag"}),d=c[i]&&"author"!=c[i]?` (${c[i]}) `:" ";m=m+p+d}var u=n.data.tags.map(e=>e.tag);let g="";if(0<u.length)for(g="<strong>Tags : </strong>",i=0;i<u.length;i++){var b=1==zoteroRoam.utils.lookForPage(title=u[i]).present?zoteroRoam.utils.renderPageTag(title=u[i]):zoteroRoam.utils.renderBP3Tag(string=u[i]);g=g+b+" "}let y=zoteroRoam.formatting.getItemCollections(n),h="";if(y){h="<strong>Collections : </strong>";try{h+=y.map(e=>zoteroRoam.utils.renderBP3Tag(string=e.data.name,{modifier:"bp3-intent-success bp3-round",icon:"projects"})).join(" ")}catch(e){console.log(y),console.log(e),console.error("Something went wrong while getting the item's collections data")}}var e=zoteroRoam.utils.lookForPage(r),f=1==e.present?'<span class="bp3-icon bp3-icon-symbol-circle"></span>':'<span class="bp3-icon bp3-icon-minus"></span>';let z=document.querySelector(".selected-item-header");z.innerHTML=`
