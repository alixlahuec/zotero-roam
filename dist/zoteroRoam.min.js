...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.30",data:{items:[],collections:[],scite:[],libraries:[],keys:[]},librarySearch:{autocomplete:null},citations:{pagination:null,autocomplete:null,currentDOI:""},config:{autoComplete:{data:{src:async function(){return 0==zoteroRoam.data.items.length?[]:zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{return Array.from(new Set(e.map(e=>e.value.key))).map(t=>e.filter(e=>e.value.key==t).sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1)[0])}},selector:"#zotero-roam-search-autocomplete",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),sort:(e,t)=>e.value.authors.toLowerCase()<t.value.authors.toLowerCase()?-1:e.value.authors.toLowerCase()>t.value.authors.toLowerCase()?1:0,resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            `;let u=document.createElement("div");u.classList.add("import-options"),u.style="display:flex;justify-content:space-between;font-size:0.85em;";let g=document.createElement("div");g.classList.add("options-library"),g.style="flex:1 0 50%;",g.innerHTML='<label class="bp3-label bp3-text-muted">Library</label><div class="options-library-list"></div>';let h=document.createElement("div");h.classList.add("options-collections"),h.style="flex:1 0 50%;",h.innerHTML='<label class="bp3-label bp3-text-muted">Collections</label><div class="options-collections-list"></div>',u.appendChild(g),u.appendChild(h);let y=document.createElement("div");y.classList.add("import-items"),y.classList.add("bp3-list-unstyled"),y.style="font-size:0.9em;margin:20px 0;";let f=document.createElement("div");f.innerHTML=zoteroRoam.utils.renderBP3Button_group("Cancel",{buttonClass:"import-cancel-button bp3-small"}),p.appendChild(importTitle),p.appendChild(importButton),o.appendChild(p),o.appendChild(importButton),o.appendChild(u),o.appendChild(y),o.appendChild(f);let b=document.createElement("div");b.classList.add("bp3-dialog-footer-actions"),b.innerHTML=`
            <input class="bp3-input clipboard-copy-utility" type="text" readonly style="opacity:0;">
            `,t.appendChild(b),zoteroRoam.interface.citations.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.citations.input=document.querySelector("#zotero-roam-citations-autocomplete"),zoteroRoam.interface.citations.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-search-close`),Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll(".zotero-roam-page-control")).forEach(t=>{t.addEventListener("click",e=>{zoteroRoam.interface.changePage(goto=t.getAttribute("goto"))})}),zoteroRoam.interface.citations.closeButton.addEventListener("click",zoteroRoam.interface.closeCitationsOverlay),zoteroRoam.interface.citations.overlay.querySelector(".import-button").addEventListener("click",zoteroRoam.handlers.importSelectedItems),zoteroRoam.interface.citations.overlay.querySelector(".import-cancel-button").addEventListener("click",zoteroRoam.interface.clearImportPanel)},renderCitationsPagination(){let e=document.querySelector("#zotero-roam-citations-pagination"),t=e.querySelector("ul");null==t&&(t=document.createElement("ul"),t.classList.add("zotero-roam-citations-search-results-list"),t.classList.add("bp3-menu"),t.tabIndex="-1",t.setAttribute("role","listbox"),e.appendChild(t));let o=zoteroRoam.citations.pagination.getCurrentPageData();e.querySelector(".zotero-roam-citations-results-count").innerHTML=`
