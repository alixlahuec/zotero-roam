...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.renderFunction=e.render,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),this.renderResults()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),this.renderResults()},this.renderResults=function(){zoteroRoam.utils.executeFunctionByName(this.renderFunction,window)}},version:"0.6.91",data:{items:[],collections:[],semantic:new Map,libraries:new Map,keys:[],roamPages:[],tags:{}},librarySearch:{autocomplete:null},activeImport:{libraries:[],currentLib:{}},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations",activeImport:null},webImport:{currentBlock:null,activeImport:null},tagSelection:{cit_panel:null,aux_panel:null},tagManager:{lists:{},pagination:null,activeDisplay:{library:null,by:"usage"}},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{var a=[...e].sort((t,a)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==a.key)?-1:1);return Array.from(new Set(a.map(e=>e.value.key))).map(t=>a.find(e=>e.value.key==t))}},selector:"#zotero-roam-search-autocomplete",placeHolder:"Search by title, year, authors (last names), citekey, tags",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",document.getElementById("zotero-roam-library-rendered").removeAttribute("has-results"),!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t,highlight=['<span class="zr-search-match">',"</span>"]),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,tabSelect:!0,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            `,document.querySelector(".zr-tag-stats").innerHTML=`Zotero has ${a.nTags} tags (${a.nAuto} / ${Math.round(a.nAuto/a.nTags*100)}% automatic) - Matched in ${o} groups - ${a.nRoam} are in Roam (${Math.round(a.nRoam/o*100)}%)`,e.innerHTML=t.map(e=>{var t=1==e.zotero.length&&(0==e.roam.length||1==e.roam.length&&e.zotero[0].tag==e.roam[0].title);let a=e.token,o="",r="Merge",i="git-merge";var n=zoteroRoam.utils.getTagUsage(e);return t?(a=e.zotero[0].tag,r="Edit",i=!1):o=`
            ...
            `},renderBP3_minimalradio(e,{varName:t,optValue:a,icon:o="",modifier:r=""}={}){return`
            <input type="radio" value="${a}" name="${t}" id="${t}_${a}" ${r} />
            ${o?`<span class="bp3-icon bp3-icon-${o}"></span>`:""}
            <label for="${t}_${a}">${e}</label>
            `},renderBP3Spinner(){return`
            ...
            `,i.appendChild(n),o.appendChild(r),o.appendChild(i);let s=document.createElement("div");s.classList.add("rendered-div"),s.style="width:96%;margin:0 auto;",a.appendChild(o),a.appendChild(s),e.appendChild(a);let l=document.createElement("div");l.classList.add("import-header"),l.innerHTML=`
            ...
            `;let c=document.createElement("div");c.classList.add("import-options");let d=document.createElement("div");d.classList.add("options-library-list");let m=document.createElement("div");m.classList.add("options-collections-list");let p=document.createElement("div");p.classList.add("options-tags");let u=document.createElement("div");u.classList.add("options-tags-select"),u.classList.add("bp3-input-group"),u.classList.add("bp3-small");let g=document.createElement("span");g.classList.add("bp3-icon"),g.classList.add("bp3-icon-tag"),g.classList.add("bp3-intent-primary");let b=document.createElement("input");b.id="zotero-roam-tagselector_auxiliary",b.tabIndex="1",b.type="text",b.classList.add("zotero-roam-tags-autocomplete"),b.classList.add("bp3-input"),b.classList.add("bp3-fill"),b.setAttribute("autocomplete","off");let y=document.createElement("div");y.classList.add("options-tags_selection"),y.setAttribute("data-tags","[]"),u.appendChild(g),u.appendChild(b),p.appendChild(u),p.appendChild(y),c.appendChild(d),c.appendChild(m),c.appendChild(p),t.setAttribute("zr-import","weblinks"),t.appendChild(l),t.appendChild(c),e.addEventListener("click",function(e){let a=e.target.closest("button");if(a)if(a.classList.contains("zotero-roam-citation-toggle-abstract")){let e=a.querySelector(".bp3-button-text"),t=a.closest(".zotero-roam-list-item").querySelector(".zotero-roam-citation-abstract");"none"==t.style.display?(t.style.display="block",e.innerHTML="Hide Abstract"):(t.style.display="none",e.innerHTML="Show Abstract")}else{var t,o;a.classList.contains("zotero-roam-add-to-graph")?(o=a.closest(".bp3-menu-item").getAttribute("label"),console.log("Importing metadata..."),zoteroRoam.handlers.importItemMetadata(title="@"+o,uid="",{popup:!0})):a.classList.contains("zotero-roam-list-item-go-to-page")&&(t=a.getAttribute("data-citekey"),(o=a.getAttribute("data-uid"))&&(console.log(`Navigating to @${t} (${o})`),zoteroRoam.interface.closeAuxiliaryOverlay(),roamAlphaAPI.ui.mainWindow.openPage({page:{uid:o}})))}else{let t=e.target.closest('input[type="checkbox"]');if(t&&"selectAll"==t.getAttribute("name")){var r=t.checked;let e=Array.from(document.querySelectorAll('.zotero-roam-auxiliary-overlay [name="explo-weblink"]'));e.forEach(e=>{e.checked=r}),zoteroRoam.interface.triggerImport(type="weblinks")}else t&&"explo-weblink"==t.getAttribute("name")&&zoteroRoam.interface.triggerImport(type="weblinks")}})},fillSearchOverlay(e=zoteroRoam.interface.search.overlayClass){let t=document.querySelector(`.${e}-overlay .bp3-dialog-body .main-panel`),a=document.createElement("div");a.classList.add("bp3-input-group"),a.classList.add("header-content");let o=document.createElement("div");o.classList.add("header-right");let r=document.createElement("div");r.classList.add("controls-top"),r.classList.add("zr-auxiliary"),r.innerHTML=`
            ...
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,o.appendChild(r);let i=document.createElement("div");i.classList.add("header-bottom");let n=document.createElement("span");n.id="zr-library-search-dialogtitle",t.closest('[role="dialog"]').setAttribute("aria-labelledby","zr-library-search-dialogtitle"),n.classList.add("zr-search-scope"),n.innerHTML='Zotero library <span class="bp3-icon bp3-icon-chevron-right"></span>';let s=document.createElement("input");s.id="zotero-roam-search-autocomplete",s.tabIndex="1",s.type="text",s.classList.add("bp3-input"),i.appendChild(n),i.appendChild(s),a.appendChild(o),a.appendChild(i),t.appendChild(a);let l=document.createElement("div");l.id="zotero-roam-library-rendered",l.setAttribute("view","search");let c=document.createElement("div");c.id="zotero-roam-library-search-div";let d=document.createElement("div");d.id="zotero-roam-search-selected-item";let m=document.createElement("div");m.classList.add("selected-item-header");let p=document.createElement("div");p.classList.add("selected-item-body"),d.appendChild(m),d.appendChild(p),l.appendChild(c),l.appendChild(d),t.appendChild(l);let u=document.createElement("div");u.classList.add("bp3-dialog-footer-actions"),u.innerHTML=`
            <div>
            ...
            `,t.appendChild(u),zoteroRoam.interface.search.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.search.input=document.querySelector("#zotero-roam-search-autocomplete"),zoteroRoam.interface.search.selectedItemDiv=document.querySelector("#zotero-roam-search-selected-item"),zoteroRoam.interface.search.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-overlay-close`),zoteroRoam.interface.search.updateButton=document.querySelector(`.${e}-overlay button.zotero-roam-update-data`)},fillCitationsOverlay(e=zoteroRoam.interface.citations.overlayClass){let t=document.querySelector(`.${e}-overlay .bp3-dialog-body .main-panel`),a=document.querySelector(`.${e}-overlay .bp3-dialog-body .side-panel-contents`),o=document.createElement("div");o.classList.add("bp3-input-group"),o.classList.add("header-content");let r=document.createElement("div");r.classList.add("header-left");let i=document.createElement("h5");i.id="zr-citations-search-dialogtitle",t.closest('[role="dialog"]').setAttribute("aria-labelledby","zr-citations-search-dialogtitle"),i.classList.add("panel-tt"),i.innerText="Citing Papers",r.appendChild(i);let n=document.createElement("div");n.classList.add("header-right");let s=document.createElement("div");s.classList.add("controls-top"),s.classList.add("zr-auxiliary"),s.innerHTML=`
            <button type="button" aria-label="Close" class="zotero-roam-overlay-close bp3-button bp3-minimal bp3-dialog-close-button">
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,n.appendChild(s);let l=document.createElement("div");l.classList.add("header-bottom");let c=document.createElement("input");c.id="zotero-roam-citations-autocomplete",c.tabIndex="1",c.type="text",c.classList.add("bp3-input"),c.setAttribute("aria-controls","zotero-roam-citations-pagination"),l.appendChild(c),o.appendChild(r),o.appendChild(n),o.appendChild(l);let d=document.createElement("div");d.id="zotero-roam-citations-pagination",t.appendChild(o),t.appendChild(d);let m=document.createElement("div");m.classList.add("import-header"),m.innerHTML=`
            ...
            ${zoteroRoam.utils.renderBP3Button_group("Add to Zotero",{buttonClass:"bp3-minimal bp3-intent-primary",icon:"inheritance",buttonAttribute:'disabled role="add" style="font-weight:600;"'})}
            `;let p=document.createElement("div");p.classList.add("import-options");let u=document.createElement("div");u.classList.add("options-library-list");let g=document.createElement("div");g.classList.add("options-collections-list");let b=document.createElement("div");b.classList.add("options-tags");let y=document.createElement("div");y.classList.add("options-tags-select"),y.classList.add("bp3-input-group"),y.classList.add("bp3-small");let h=document.createElement("span");h.classList.add("bp3-icon"),h.classList.add("bp3-icon-tag"),h.classList.add("bp3-intent-primary");let f=document.createElement("input");f.id="zotero-roam-tagselector_citations",f.tabIndex="1",f.type="text",f.classList.add("zotero-roam-tags-autocomplete"),f.classList.add("bp3-input"),f.classList.add("bp3-fill"),f.setAttribute("autocomplete","off");let z=document.createElement("div");z.classList.add("options-tags_selection"),z.setAttribute("data-tags","[]"),y.appendChild(h),y.appendChild(f),b.appendChild(y),b.appendChild(z),p.appendChild(u),p.appendChild(g),p.appendChild(b);let v=document.createElement("h5");v.innerText="Selected Items",v.classList.add("import-selection-header");let k=document.createElement("div");k.classList.add("import-items"),k.classList.add("bp3-list-unstyled"),a.setAttribute("zr-import","citations"),a.appendChild(m),a.appendChild(p),a.appendChild(v),a.appendChild(k);let R=document.createElement("div");R.classList.add("bp3-dialog-footer-actions"),R.innerHTML=`
            ...
            `,t.appendChild(R),zoteroRoam.interface.citations.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.citations.input=document.querySelector("#zotero-roam-citations-autocomplete"),zoteroRoam.interface.citations.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-overlay-close`),d.addEventListener("click",function(e){let a=e.target.closest("button");if(a)if(a.classList.contains("zotero-roam-citation-copy-doi"))zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value=a.dataset.doi,zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").select(),document.execCommand("copy");else if(a.classList.contains("zotero-roam-citation-toggle-abstract")){let e=a.querySelector(".bp3-button-text"),t=a.closest(".zotero-roam-citations-search_result").querySelector(".zotero-roam-citation-abstract");"none"==t.style.display?(t.style.display="block",e.innerHTML="Hide Abstract"):(t.style.display="none",e.innerHTML="Show Abstract")}else a.classList.contains("zotero-roam-citation-add-import")&&zoteroRoam.interface.triggerImport(type="citations",element=a.closest(".bp3-menu-item"))})},fillDashboardOverlay(){let e=document.querySelector(".zotero-roam-dashboard-overlay .main-panel"),t=[{name:"tag-manager",icon:"tag",title:"Tag Manager",description:'Rename, merge, and delete tags between <span data-tag-source="roam">Roam</span> and <span data-tag-source="zotero">Zotero</span>'}],a=document.createElement("div");a.classList.add("side-section");let o=document.createElement("div");o.classList.add("bp3-tabs"),o.classList.add("bp3-vertical");let r=document.createElement("ul");r.classList.add("bp3-tab-list"),r.setAttribute("role","tablist"),t.forEach((e,t)=>{r.innerHTML+=`
                <li class="bp3-tab" role="tab" name="${e.name}" ${0==t?'aria-selected="true"':""}>
                    <span class="bp3-icon bp3-icon-${e.icon}"></span>
                    ${e.title}
                </li>`}),o.appendChild(r),a.appendChild(o);let i=document.createElement("div");i.classList.add("main-section"),t.forEach((e,t)=>{i.innerHTML+=`
                ...
                `}),e.appendChild(a),e.appendChild(i);let n=document.querySelector('.zotero-roam-dashboard-overlay .bp3-tab-panel[name="tag-manager"] .zr-tab-panel-contents');n.innerHTML+=`
            ...
            `,e.addEventListener("click",o=>{let r=o.target.closest(".bp3-tab-panel");if(r){var i=r.getAttribute("name");if("tag-manager"==i)if(o.target.closest(".zr-tab-panel-popover")){let e=o.target.closest("button[zr-command]");e&&(zoteroRoam.handlers.modifySelectedTags(action=e.getAttribute("zr-command")),e.classList.add("bp3-disabled"),e.setAttribute("aria-disabled","true"))}else{let e=r.querySelector(".zr-tab-panel-popover");"true"==e.getAttribute("overlay-visible")&&(e.querySelector(".bp3-dialog-body").innerHTML="",e.querySelector(".bp3-dialog-footer").innerHTML="",e.style.display="none",e.setAttribute("overlay-visible","hidden"));let t=o.target.closest(".zr-tab-panel-toolbar"),a=o.target.closest(".zr-datalist-item");if(t){i=Array.from(t.querySelectorAll(".zr-datalist-sort_option input")).find(e=>1==e.checked).value;zoteroRoam.tagManager.activeDisplay.by!=i&&zoteroRoam.utils.updateTagPagination(libPath=zoteroRoam.tagManager.activeDisplay.library.path,{by:i})}else if(a){let e=o.target.closest("button[zr-action]");e&&zoteroRoam.interface.showTagActionsPopover(token=a.getAttribute("data-token"),action=e.getAttribute("zr-action"))}}}})},showTagActionsPopover(t,a="Edit"){let e=zoteroRoam.tagManager.pagination.data.find(e=>e.token==t),o=document.querySelector('.zotero-roam-dashboard-overlay .bp3-tab-panel[name="tag-manager"] .zr-tab-panel-popover'),r="";0<e.roam.length&&(r+=`
                <div class="col-half">
                <h4>Roam</h4>
                ${e.roam.map(e=>zoteroRoam.utils.renderBP3_option(string=e.title,type="checkbox",depth=0,{varName:"zr-tag-select",optValue:e.title,modifier:"Delete"==a?"":"checked",labelModifier:`data-tag-source="roam" data-uid="${e.uid}"`})).join("\n")}
                </div>
                `);let i=e.zotero.reduce((e,t)=>(e.has(t.tag)?e.set(t.tag,[...e.get(t.tag),t.meta.numItems]):e.set(t.tag,[t.meta.numItems]),e),new Map);r+=`
            <div class="col-half">
            <h4>Zotero</h4>
            ${Array.from(i.keys()).map(e=>zoteroRoam.utils.renderBP3_option(e+` <span class="zr-secondary zr-text-small">(${i.get(e).join(" + ")})</span>`,"checkbox",0,{varName:"zr-tag-select",optValue:e,modifier:"checked",labelModifier:'data-tag-source="zotero"'})).join("\n")}
            </div>
            `;let n="Delete",s="danger",l="trash",c="";"Delete"!=a&&(n="Edit/Merge",s="primary",l="arrow-right",c=`
                <div class="bp3-input-group">
                    <span class="bp3-icon bp3-icon-tag"></span>
                <input type="text" class="bp3-input" name="zr-tag-rename" spellcheck="false" placeholder="Rename tag(s) as ..." ${0<e.roam.length?'value="'+e.roam[0].title+'"':""}" />
                </div>
                `);var d=`
            <div class="zr-tab-panel-popover-footer">
                ${c}
                <div class="bp3-button-group bp3-minimal bp3-small">
                    ${zoteroRoam.utils.renderBP3Button_group(n,{buttonClass:`bp3-active bp3-intent-${s}`,icon:l,buttonAttribute:`zr-command="${a}"`})}
                </div>
            </div>
            `;o.querySelector(".bp3-dialog-body").innerHTML=r,o.querySelector(".bp3-dialog-footer").innerHTML=d,o.style.display="block",o.setAttribute("overlay-visible","true")},async handleImportPanelClicks(a){let o=a.target.closest("[zr-import]"),r=o.getAttribute("zr-import"),t=a.target.closest("button[role]");if(null!==t)switch(t.getAttribute("role")){case"cancel":zoteroRoam.interface.clearImportPanel(action="close",r);break;case"add":t.setAttribute("disabled","");var i=await zoteroRoam.handlers.importSelectedItems(o);"citations"==r?(zoteroRoam.citations.activeImport.outcome=i,zoteroRoam.interface.renderImportResults(i)):"weblinks"==r&&(zoteroRoam.webImport.activeImport.outcome=i),t.classList.remove("bp3-intent-primary");let e=t.querySelector(".bp3-icon");e.classList.remove("bp3-icon-inheritance"),e.classList.add("bp3-icon-tick"),e.setAttribute("icon","tick"),t.querySelector(".bp3-button-text").innerText="Done",t.classList.add("bp3-intent-success"),t.removeAttribute("disabled"),t.setAttribute("role","done");break;case"done":zoteroRoam.interface.clearImportPanel(action="reset",r)}if(null!==a.target.closest('input[name="library"]')&&zoteroRoam.interface.selectImportLibrary(r),null!==a.target.closest(".options-tags_selection")){let e=a.target.closest(".bp3-tag-remove");if(null!==e){let t=e.closest(".bp3-tag");try{let e=o.querySelector(".options-tags_selection");e.dataset.tags=JSON.stringify(JSON.parse(e.dataset.tags).filter(e=>e!=t.dataset.tag)),t.remove()}catch(a){console.error(a)}}}if(null!==a.target.closest(".import-items")){let e=a.target.closest("button.selected_remove-button");if(null!==e){let t=e.closest(".import-items_selected");try{"citations"==r&&(zoteroRoam.citations.activeImport.items=zoteroRoam.citations.activeImport.items.filter(e=>e!=t.dataset.identifier),t.remove(),zoteroRoam.interface.citations.overlay.querySelector(".import-selection-header").innerText=`Selected Items (${zoteroRoam.citations.activeImport.items.length})`,0==zoteroRoam.citations.activeImport.items.length&&(zoteroRoam.interface.citations.overlay.querySelector('button[role="add"]').setAttribute("disabled",""),zoteroRoam.interface.citations.overlay.querySelector(".import-selection-header").innerText="Selected Items"))}catch(a){console.error(a)}}}},renderCitationsPagination(){let e=document.querySelector("#zotero-roam-citations-pagination"),t=e.querySelector("ul");null==t&&(t=document.createElement("ul"),t.classList.add("zotero-roam-citations-search-results-list"),t.classList.add("bp3-menu"),t.tabIndex="-1",t.setAttribute("role","listbox"),e.appendChild(t));let a=zoteroRoam.citations.pagination.getCurrentPageData();e.closest(".main-panel").querySelector(".zotero-roam-citations-results-count").innerHTML=`
            ...
            <div class="item-additional-metadata">
                ...
                <p class="item-creators">${d}</p>
                <p class="item-tags">${g}</p>
            ...
            `,Array.from(document.querySelectorAll(".item-citekey-section .copy-buttons a.bp3-button[format]")).forEach(o=>{o.addEventListener("click",e=>{let t=zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility");switch(o.getAttribute("format")){case"citekey":t.value=`${r}`;break;case"citation":var a=`${n.meta.creatorSummary||""}${s||""}`;t.value=`[${a}]([[${r}]])`;break;case"tag":t.value=`#[[${r}]]`;break;case"page-reference":t.value=`[[${r}]]`}t.select(),document.execCommand("copy")})});try{let t=document.querySelector("button.item-see-notes");t.addEventListener("click",function(){let e=t.querySelector(".bp3-button-text").innerHTML;switch(!0){case e.startsWith("Show"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Show","Hide");break;case e.startsWith("Hide"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Hide","Show")}})}catch(e){}switch(document.querySelector("#zotero-roam-library-rendered").setAttribute("view","item"),zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")){case"true":document.querySelector("h4.item-title").focus();break;case"false":zoteroRoam.interface.toggleSearchOverlay("show",{focus:!1})}},clearSelectedItem(){try{zoteroRoam.interface.search.selectedItemDiv.children.forEach(e=>{e.innerHTML=""})}catch(e){Array.from(zoteroRoam.interface.search.selectedItemDiv.children).forEach(e=>{e.innerHTML=""})}zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML="","visible"==zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").getAttribute("side-panel")&&zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),document.querySelector("#zotero-roam-library-rendered").setAttribute("view","search")},checkEditingMode(){let e=document.querySelector("textarea.rm-block-input");e&&null==e.getAttribute("zotero-tribute")&&(document.querySelectorAll(".zotero-roam-tribute").forEach(e=>e.remove()),e.setAttribute("zotero-tribute","active"),new Tribute(zoteroRoam.config.tribute).attach(e),e.addEventListener("tribute-replaced",a=>{if("zotero"==a.detail.item.original.source){let e=document.querySelector("textarea.rm-block-input");var o=a.detail.context.mentionTriggerChar+a.detail.context.mentionText,r=a.detail.context.mentionPosition,i=a.detail.item.original.value;let t=a.target.defaultValue;a=zoteroRoam.utils.escapeRegExp(o),a=new RegExp(a,"g"),a=t.replaceAll(a,(e,t)=>t==r?i:e);zoteroRoam.interface.tributeTrigger=o,zoteroRoam.interface.tributeBlockTrigger=e,zoteroRoam.interface.tributeNewText=a,Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value").set.call(e,a);a=new Event("input",{bubbles:!0});e.dispatchEvent(a)}}))},triggerImport(e="citations",t=null){let a=document.querySelector(`[zr-import="${e}"]`);var o=("citations"==e?zoteroRoam.citations:zoteroRoam.webImport).activeImport;null==o?(zoteroRoam.data.roamPages=new Map(zoteroRoam.utils.getRoamPages()),zoteroRoam.tagSelection["citations"==e?"cit_panel":"aux_panel"].init(),zoteroRoam.activeImport.libraries=zoteroRoam.utils.getLibraries(),zoteroRoam.interface.renderImportOptions(e)):"citations"==e&&a.querySelector('button[role="done"]')&&zoteroRoam.interface.clearImportPanel(action="reset",e),"citations"==e?zoteroRoam.interface.renderImportCitations(t):"weblinks"==e&&zoteroRoam.interface.renderImportWeblinks(),!!o&&0<o.items.length&&zoteroRoam.activeImport.currentLib?a.querySelector('button[role="add"]').removeAttribute("disabled"):a.querySelector('button[role="add"]').setAttribute("disabled","")},renderImportCitations(e){let t=document.querySelector('[zr-import="citations"]');var a=e.querySelector(".zotero-roam-citation-identifier-link").innerText,o=e.querySelector(".zotero-roam-search-item-title").innerText,r=e.querySelector(".zotero-roam-citation-origin").innerText;null==zoteroRoam.citations.activeImport?(zoteroRoam.citations.activeImport={items:[],outcome:null},zoteroRoam.interface.triggerImport(type="citations",e),t.closest(".bp3-dialog").setAttribute("side-panel","visible")):zoteroRoam.citations.activeImport.items.includes(a)||(zoteroRoam.citations.activeImport.items.push(a),t.querySelector(".import-items").innerHTML+=`
                ...
                `,m.includes("sciteBadge")&&n.data.DOI&&null==o.parentElement.querySelector(".scite-badge")&&(f=zoteroRoam.inPage.makeSciteBadge(doi=l),o.parentElement.querySelector(".zotero-roam-page-menu-header").appendChild(f),window.__SCITE.insertBadges()),zoteroRoam.events.emit("menu-ready",{title:a,item:n,doi:l,uid:c.uid,children:d,semantic:i,div:p,context:p.closest(".roam-article")?"main":"sidebar"})}},renderCitekeyRefs(){var a=document.querySelectorAll("span[data-link-title^='@']");for(i=0;i<a.length;i++){let e=a[i],t=e.getElementsByClassName("rm-page-ref")[0];var o,r=e.getAttribute("data-zotero-bib"),n=e.getAttribute("data-link-title").slice(1);"inLibrary"==r&&(o=zoteroRoam.data.items.find(e=>e.key==n))?t.textContent=zoteroRoam.utils.formatItemReference(o,"inline"):t.textContent!="@"+n&&(t.textContent="@"+n)}},renderBacklinksItem_year(e,t,a=null){var o="reference"==t?"zr-highlight":"zr-highlight-2",r="reference"==t?"bp3-intent-primary":"bp3-intent-warning";return a?`
                ...
                </li>`},renderBacklinksList_year(e,t){let a=new Map(zoteroRoam.utils.getAllRefPages()),o=e.sort((e,t)=>{if(e.meta.parsedDate){if(t.meta.parsedDate){var a=new Date(e.meta.parsedDate).getUTCFullYear()-new Date(t.meta.parsedDate).getUTCFullYear();return a<0||0==a&&e.meta.creatorSummary<t.meta.creatorSummary?-1:1}return-1}return!t.meta.parsedDate&&e.meta.creatorSummary<t.meta.creatorSummary?-1:1}),r=o.filter(e=>"cited"==e.type).map(e=>{var t=a.get("@"+e.key)||null;return zoteroRoam.inPage.renderBacklinksItem_year(e,"reference",uid=t)}),i=o.filter(e=>"citing"==e.type).map(e=>{var t=a.get("@"+e.key)||null;return zoteroRoam.inPage.renderBacklinksItem_year(e,"citation",uid=t)});return`
            ...
            `},renderBacklinksList(e){let t=e.filter(e=>"citing"==e.type),a=e.filter(e=>"cited"==e.type),o=[],r=[];0<a.length&&(o=a.sort((e,t)=>e.meta.creatorSummary<t.meta.creatorSummary?-1:1).map(e=>{var t=zoteroRoam.utils.lookForPage("@"+e.key).uid||null;return zoteroRoam.inPage.renderBacklinksItem(e,"reference",uid=t)})),0<t.length&&(r=t.sort((e,t)=>e.meta.creatorSummary<t.meta.creatorSummary?-1:1).map(e=>{var t=zoteroRoam.utils.lookForPage("@"+e.key).uid||null;return zoteroRoam.inPage.renderBacklinksItem(e,"citation",uid=t)}));let i=[...o,...r];e=Math.ceil(i.length/2);let n=[],s=[];return s=o.length>e?(n=o.slice(0,e),[...r,...o.slice(e)]):(n=i.slice(0,e),i.slice(e)),`
            ...
            `},addWebImport(){var e=zoteroRoam.config.params.webimport.tags,t=e.constructor===Array?e:[e];let o=document.createElement("button");o.setAttribute("type","button"),o.classList.add("bp3-button"),o.classList.add("bp3-minimal"),o.classList.add("zotero-roam-explo-import"),o.innerHTML='<span icon="geosearch" class="bp3-icon bp3-icon-geosearch"></span>';let a=Array.from(document.querySelectorAll(".rm-block:not(.rm-block--ghost)")).filter(e=>zoteroRoam.utils.matchArrays(t,JSON.parse(e.getAttribute("data-page-links"))));a.forEach(e=>{var t=e.querySelectorAll(".rm-block a:not(.rm-alias--page):not(.rm-alias--block)");let a=e.firstChild;0<t.length?(e.setAttribute("data-zr-explo","true"),Array.from(a.classList).includes("zotero-roam-explo-import")||e.insertAdjacentElement("afterbegin",o.cloneNode(!0))):(e.setAttribute("data-zr-explo","false"),Array.from(a.classList).includes("zotero-roam-explo-import")&&a.remove())})}},zoteroRoam.formatting={getCreators(e,{creators_as:t="string",brackets:a=!0,use_type:o=!0}={}){let r=e.data.creators.map(e=>{var t=e.name?`${e.name}`:`${[e.firstName,e.lastName].filter(Boolean).join(" ")}`;return{name:t,type:e.creatorType,inGraph:zoteroRoam.utils.lookForPage(t)}});switch(t){case"identity":return r;case"array":return r.map(e=>e.name);case"string":default:return(1==o?r.map(e=>{return(1==a?`[[${e.name}]]`:e.name)+("author"==e.type?"":` (${e.type})`)}):r.map(e=>1==a?`[[${e.name}]]`:e.name)).join(", ")}},async getItemBib(e,{include:t="bib",style:a="apa",linkwrap:o=0,locale:r="en-US"}={}){r=e.bib||await zoteroRoam.handlers.requestItemBib(e,{include:t,style:a,linkwrap:o,locale:r});return zoteroRoam.utils.formatBib(r)},getChildrenInDataset(t){var e=zoteroRoam.data.items.filter(e=>e.data.parentItem==t.data.key&e.library.id==t.library.id);return 0<e.length&&e},getItemChildren(t,{pdf_as:a="links",notes_as:e="formatted",split_char:o=zoteroRoam.config.params.notes.split_char}={}){let r={pdfItems:!1,notes:!1},i=[];var n=zoteroRoam.formatting.getChildrenInDataset(t);switch(n?i=n:0<t.meta.numChildren&&(r.remoteChildren=!0),a){case"raw":var s=i.filter(e=>"application/pdf"==e.data.contentType);r.pdfItems=0!=s.length&&s;break;case"identity":let e=i.filter(e=>"application/pdf"==e.data.contentType);r.pdfItems=0!=e.length&&e.map(e=>({title:e.data.title,key:e.key,link:zoteroRoam.utils.makePDFLinks(e)}));break;case"links":r.pdfItems=zoteroRoam.utils.makePDFLinks(i.filter(e=>"application/pdf"==e.data.contentType))}var l=i.filter(e=>"note"==e.data.itemType);switch(e){case"raw":r.notes=0!=l.length&&l;break;case"formatted":r.notes=0!=l.length&&zoteroRoam.handlers.formatNotes(notes=l,use=zoteroRoam.config.params.notes.use,o)}return r},getItemCollections(a){return 0<a.data.collections.length&&a.data.collections.map(t=>zoteroRoam.data.collections.find(e=>e.key==t&&e.library.id==a.library.id))},getItemRelated(t,{return_as:a="citekeys",brackets:o=!0}={}){if(!t.data.relations||!t.data.relations["dc:relation"])return[];{let e=t.data.relations["dc:relation"];e.constructor===String&&(e=[e]);let n=[];var s=/(users|groups)\/([^\/]+)\/items\/(.+)/g;switch(e.forEach(e=>{let[,t,a,o]=Array.from(e.matchAll(s))[0];t=t.slice(0,-1),a=new Number(a);let r=null;for(let e=0;e<zoteroRoam.data.items.length;e++){var i=zoteroRoam.data.items[e];if(i.library.type==t&&i.library.id==a&&i.data.key==o){r=i;break}}r&&n.push(r)}),a){case"raw":return n;case"citekeys":default:return o?n.map(e=>`[[@${e.key}]]`):n.map(e=>e.key)}}},getItemType(e){let t=zoteroRoam.typemap[e.data.itemType]||e.data.itemType;return zoteroRoam.config.userSettings.typemap&&(t=zoteroRoam.config.userSettings.typemap[e.data.itemType]||t),t},getLocalLink(e,{format:t="markdown",text:a="Local library"}={}){var o=`zotero://select/${"group"==e.library.type?`groups/${e.library.id}`:"library"}/items/${e.data.key}`;switch(t){case"target":default:return o;case"markdown":return`[${a}](${o})`}},getWebLink(e,{format:t="markdown",text:a="Web library"}={}){var o=`https://www.zotero.org/${("user"==e.library.type?"users":"groups")+`/${e.library.id}`}/items/${e.data.key}`;switch(t){case"target":default:return o;case"markdown":return`[${a}](${o})`}},getTags(e){return e.data.tags.map(e=>"#[["+e.tag+"]]").join(", ")},getItemMetadata(e){let t=[];e.data.title&&t.push(`Title:: ${e.data.title}`),0<e.data.creators.length&&t.push(`Author(s):: ${zoteroRoam.formatting.getCreators(e,{creators_as:"string",brackets:!0,use_type:!0})}`),e.data.abstractNote&&t.push(`Abstract:: ${e.data.abstractNote}`),e.data.itemType&&t.push(`Type:: [[${zoteroRoam.formatting.getItemType(e)}]]`),t.push(`Publication:: ${e.data.publicationTitle||e.data.bookTitle||""}`),e.data.url&&t.push(`URL : ${e.data.url}`),e.data.dateAdded&&t.push(`Date Added:: ${zoteroRoam.utils.makeDNP(e.data.dateAdded,{brackets:!0})}`),t.push(`Zotero links:: ${zoteroRoam.formatting.getLocalLink(e,{format:format="markdown",text:text="Local library"})}, ${zoteroRoam.formatting.getWebLink(e,{format:format="markdown",text:text="Local library"})}`),0<e.data.tags.length&&t.push(`Tags:: ${zoteroRoam.formatting.getTags(e)}`);let a=zoteroRoam.formatting.getItemChildren(e,{pdf_as:"links",notes_as:"formatted"});if(a.pdfItems&&t.push(`PDF links : ${a.pdfItems.join(", ")}`),a.notes){let e={string:"[[Notes]]",children:[]};e.children.push(...a.notes.flat(1)),t.push(e)}return t}},zoteroRoam.shortcuts={actions:{closeSearchPanel:{defaultShortcut:{Escape:!0},execute(){let e=document.querySelector('.bp3-overlay[overlay-visible="true"]')||!1;e&&(e.classList.contains(`${zoteroRoam.interface.search.overlayClass}-overlay`)?zoteroRoam.interface.toggleSearchOverlay("hide"):e.classList.contains(`${zoteroRoam.interface.citations.overlayClass}-overlay`)?zoteroRoam.interface.closeCitationsOverlay():e.classList.contains("zotero-roam-auxiliary-overlay")?zoteroRoam.interface.closeAuxiliaryOverlay():e.classList.contains("zotero-roam-dashboard-overlay")&&zoteroRoam.interface.toggleDashboardOverlay())}},toggleSearchPanel:{defaultShortcut:{altKey:!0,q:!0},execute(){var e;"true"==zoteroRoam.interface.citations.overlay.getAttribute("overlay-visible")?zoteroRoam.interface.closeCitationsOverlay():"true"==document.querySelector(".zotero-roam-auxiliary-overlay").getAttribute("overlay-visible")?zoteroRoam.interface.closeAuxiliaryOverlay():(document,"true"==querySelector(".zotero-roam-dashboard-overlay").getAttribute("overlay-visible")?zoteroRoam.interface.toggleDashboardOverlay():(e="true"==zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")?"hide":"show",zoteroRoam.interface.toggleSearchOverlay(e)))}},toggleQuickCopy:{defaultShortcut:[],execute(){document.getElementById("zotero-roam-quick-copy-mode").click()}},importMetadata:{defaultShortcut:[],execute(){let e=document.querySelector("button.item-add-metadata");null!==e&&e.click()}},focusSearchBar:{defaultShortcut:[],execute(){let e=document.querySelector('.bp3-overlay[overlay-visible="true"]')||!1;e&&e.querySelector('input.bp3-input[type="text"]').focus()}},goToItemPage:{defaultShortcut:[],execute(){let e=document.querySelector("button.item-go-to-page");var t,a;e&&"true"==zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")&&(t=e.getAttribute("data-uid"),a="@"+e.getAttribute("data-citekey"),console.log(`Navigating to ${a} (${t})`),roamAlphaAPI.ui.mainWindow.openPage({page:{uid:t}}))}},copyCitekey:{defaultShortcut:[],execute(){let e=document.querySelector('.item-citekey-section .copy-buttons a.bp3-button[format="citekey"]');null!==e&&e.click()}},copyCitation:{defaultShortcut:[],execute(){let e=document.querySelector('.item-citekey-section .copy-buttons a.bp3-button[format="citation"]');null!==e&&e.click()}},copyTag:{defaultShortcut:[],execute(){let e=document.querySelector('.item-citekey-section .copy-buttons a.bp3-button[format="tag"]');null!==e&&e.click()}},copyPageRef:{defaultShortcut:[],execute(){let e=document.querySelector('.item-citekey-section .copy-buttons a.bp3-button[format="page-reference"]');null!==e&&e.click()}},toggleNotes:{defaultShortcut:[],execute(){let e=document.querySelector('.zotero-roam-search-overlay[overlay-visible="true"] button.item-see-notes');null!==e&&e.click()}}},sequences:{},getSequences(t){let a=zoteroRoam.config.shortcuts.filter(e=>e.action==t);if(0==a.length)return!1;{let e=a.map(e=>{let t=[];for(key in e.template){var a;1==e.template[key]&&(a=key.endsWith("Key")?key.slice(0,-3):key,t.push(a))}return t});return e.map(e=>e.join("-")).join(" or ")}},generateSequences(){for(action in zoteroRoam.shortcuts.actions){var e=zoteroRoam.shortcuts.getSequences(action);e&&(zoteroRoam.shortcuts.sequences[action]=e)}},makeSequenceText(e,t="",a){return`${t}<span class="zotero-roam-sequence">${zoteroRoam.shortcuts.sequences[e]}</span>`},setup(){let a={};Object.keys(zoteroRoam.shortcuts.actions).forEach(e=>{a[e]=zoteroRoam.shortcuts.actions[e].defaultShortcut});let o={};zoteroRoam.config.userSettings.shortcuts?Object.keys(zoteroRoam.shortcuts.actions).forEach(e=>{var{[e]:t=a[e]}=zoteroRoam.config.userSettings.shortcuts;o[e]=t}):o=a;let t=[];for(k in o)o[k].constructor===Object?t.push({action:k,template:o[k]}):o[k].constructor===Array&&o[k].forEach(e=>{t.push({action:k,template:e})});t.forEach(e=>{zoteroRoam.config.shortcuts.push(new zoteroRoam.Shortcut(e))})},setupSequences(){zoteroRoam.shortcuts.generateSequences();let a=zoteroRoam.shortcuts.sequences.toggleSearchPanel?zoteroRoam.shortcuts.makeSequenceText("toggleSearchPanel",pre="Toggle panel with "):"",o=zoteroRoam.shortcuts.sequences.closeSearchPanel?zoteroRoam.shortcuts.makeSequenceText("closeSearchPanel",pre="Exit with "):"";if(0<a.length|0<o.length){let e=document.createElement("span");e.style="font-size:0.8em;margin:3px;",e.innerHTML=`${[a,o].filter(Boolean).join(" / ")}  `;let t=zoteroRoam.interface.search.overlay.querySelector(".controls-top");if(t.insertBefore(e,zoteroRoam.interface.search.closeButton),0<o.length){let e=zoteroRoam.interface.citations.overlay.querySelector(".controls-top"),t=document.createElement("span");t.style="font-size:0.8em;margin:6px;",t.innerHTML=`${o}`,e.insertBefore(t,zoteroRoam.interface.citations.closeButton);let a=document.querySelector(".zotero-roam-auxiliary-overlay .controls-top");var r=t.cloneNode(!0);a.insertBefore(r,a.querySelector(".bp3-dialog-close-button"))}}r=zoteroRoam.shortcuts.sequences.toggleQuickCopy?zoteroRoam.shortcuts.makeSequenceText("toggleQuickCopy",pre=" "):"";0<r.length&&(zoteroRoam.interface.search.overlay.querySelector(".quick-copy-element").innerHTML+=r);r=zoteroRoam.shortcuts.sequences.focusSearchBar?zoteroRoam.shortcuts.makeSequenceText("focusSearchBar"):"";if(0<r.length){let t=document.createElement("span");t.classList.add("bp3-input-action"),t.style="height:30px;padding:5px;",t.innerHTML=`${r}`,Array.from(document.querySelectorAll(`#${zoteroRoam.interface.portal.id} input.bp3-input[type="text"]`)).forEach(e=>e.closest(".bp3-input-group").appendChild(t.cloneNode(!0)))}},verify(r){let i=r.key;var n="keydown"==r.type;let s=["altKey","ctrlKey","metaKey","shiftKey"];zoteroRoam.config.shortcuts=zoteroRoam.config.shortcuts.map(e=>{let{action:t,template:a,watcher:o}=e;return s.forEach(e=>{o[e]=r[e]}),a.hasOwnProperty(i)|a.hasOwnProperty(i.toLowerCase())&&(e=a.hasOwnProperty(i)?i:i.toLowerCase(),o[e]=n),{action:t,template:a,watcher:o}}),zoteroRoam.config.shortcuts.forEach(e=>{JSON.stringify(e.watcher)===JSON.stringify(e.template)&&zoteroRoam.shortcuts.actions[`${e.action}`].execute()})}},zoteroRoam.events={ready:{},"menu-ready":{},"metadata-added":{},"notes-added":{},update:{},write:{},emit(e,t={},a=document){t=new CustomEvent(`zotero-roam:${e}`,{bubbles:!0,cancelable:!0,detail:t});1==zoteroRoam.config.userSettings.logEvents&&console.log(t),a.dispatchEvent(t)},defaultHooks(){document.addEventListener("zotero-roam:metadata-added",e=>{let t=e.detail.title;var a=e.detail.uid;try{let e=document.querySelector(".item-in-graph");null!=e&&(e.innerHTML='<span class="bp3-icon-tick bp3-icon bp3-intent-success"></span><span> In the graph</span>');let t=document.querySelector(".item-go-to-page");null!=t&&(t.setAttribute("data-uid",a),t.removeAttribute("disabled"))}catch(e){}try{let e=document.querySelector(`.zotero-roam-auxiliary-overlay .bp3-menu-item[label="${t.slice(1)}"]`);null!=e&&(e.setAttribute("in-graph","true"),e.querySelector(".zotero-roam-add-to-graph").remove(),e.innerHTML+=zoteroRoam.utils.renderBP3ButtonGroup("Go to page",{buttonClass:"zotero-roam-list-item-go-to-page",divClass:"bp3-minimal bp3-small",icon:"symbol-circle",modifier:"bp3-intent-success",buttonModifier:`data-uid="${a}" data-citekey="${t.slice(1)}"`}))}catch(e){}try{var o=Array.from(document.querySelectorAll(`.related-item_listed[data-key="${t}"][in-graph="false"]`));if(0<o.length)for(link of o)link.outerHTML=zoteroRoam.inPage.renderBacklinksItem(paper=e.detail.item,type=link.getAttribute("item-type"),uid=a)}catch(e){}}),document.addEventListener("zotero-roam:update",async function(e){e=e.detail.data?e.detail.data.items:[];if(0<e.length)for(item of e){var t=zoteroRoam.utils.parseDOI(item.data.DOI),a=Array.from(document.querySelectorAll(".zotero-roam-page-added-on"));if(0<a.length){var o,r=zoteroRoam.utils.makeDNP(item.data.dateAdded,{brackets:!1});for(btn of a)if(btn.getAttribute("data-title")==r){let e=JSON.parse(btn.getAttribute("data-keys"));e.includes(item.key)||(e.includes(item.data.key)?btn.setAttribute("data-keys",JSON.stringify([...e.filter(e=>e!=item.data.key),item.key])):btn.setAttribute("data-keys",JSON.stringify([...e,item.key])),o=JSON.parse(btn.getAttribute("data-keys")).length,btn.querySelector(".bp3-button-text").innerText=`${o} item${1==o?"":"s"} added`)}}a=Array.from(document.querySelectorAll(".zotero-roam-page-tagged-with"));if(0<a.length)for(btn of a){var i=btn.getAttribute("data-title");let e=JSON.parse(btn.getAttribute("data-keys"));item.data.tags&&item.data.tags.map(e=>e.tag).includes(i)&&(e.includes(item.key)||(e.includes(item.data.key)?btn.setAttribute("data-keys",JSON.stringify([...e.filter(e=>e!=item.data.key),item.key])):btn.setAttribute("data-keys",JSON.stringify([...e,item.key])),i=JSON.parse(btn.getAttribute("data-keys")).length,btn.querySelector(".bp3-button-text").innerText=`${i} tagged item${1==i?"":"s"}`))}a=Array.from(document.querySelectorAll(".zotero-roam-page-abstract-mentions"));if(0<a.length)for(btn of a){var n=btn.getAttribute("data-title");let e=JSON.parse(btn.getAttribute("data-keys"));item.data.abstractNote&&item.data.abstractNote.includes(n)&&(e.includes(item.key)||(e.includes(item.data.key)?btn.setAttribute("data-keys",JSON.stringify([...e.filter(e=>e!=item.data.key),item.key])):btn.setAttribute("data-keys",JSON.stringify([...e,item.key])),n=JSON.parse(btn.getAttribute("data-keys")).length,btn.querySelector(".bp3-button-text").innerText=`${n} abstract${1==n?"":"s"}`))}if(t&&zoteroRoam.config.params.pageMenu.defaults.includes("citingPapers"))for(menu of Array.from(document.querySelectorAll(".zotero-roam-page-menu-citations[data-doi]"))){var s=menu.dataset.doi;let e=await zoteroRoam.handlers.getSemantic(s);if(e.data){let r=e.citations.map(e=>zoteroRoam.utils.parseDOI(e.doi)).filter(Boolean);s=e.references.map(e=>zoteroRoam.utils.parseDOI(e.doi)).filter(Boolean);let i=[...r,...s];if(i.includes(t)){let e=zoteroRoam.data.items.filter(e=>zoteroRoam.utils.parseDOI(e.data.DOI)),a=i.map(t=>e.find(e=>zoteroRoam.utils.parseDOI(e.data.DOI)==t)).filter(Boolean);a.forEach((e,t)=>{r.includes(e.data.DOI)?a[t].type="citing":a[t].type="cited"});let t=menu.querySelector(".zotero-roam-page-menu-backlinks-button");t.querySelector(".bp3-button-text").innerText=`${a.length} related library items`,t.classList.remove("bp3-disabled");let o=menu.querySelector(".zotero-roam-page-menu-backlinks-list");o?o.innerHTML=`${zoteroRoam.inPage.renderBacklinksList(a)}`:menu.innerHTML+=`
                                            ...
                                            `}}}}zoteroRoam.utils.refreshTagLists()}),document.addEventListener("zotero-roam:ready",e=>{zoteroRoam.utils.refreshTagLists(),zoteroRoam.utils.updateTagPagination(libPath=Array.from(zoteroRoam.data.libraries.keys())[0])})}},zoteroRoam.smartblocks={commands:{ZOTERORANDOMCITEKEY:{help:"Return one or more Zotero citekeys, with optional tag query",handler:e=>(e="1",t="")=>zoteroRoam.data.items.filter(e=>!["attachment","note","annotation"].includes(e.data.itemType)&&zoteroRoam.smartblocks.processQuery(t,e.data.tags.map(e=>e.tag))).map(e=>e.key).sort(()=>.5-Math.random()).slice(0,Number(e)||1)}},processQuery(e,t){let a=e.split(/([\|\&]?)([^\&\|\(\)]+|\(.+\))([\|\&]?)/).filter(Boolean);return a.includes("|")?zoteroRoam.smartblocks.eval_or(a.filter(e=>"|"!=e),t):zoteroRoam.smartblocks.eval_and(a.filter(e=>"&"!=e),t)},eval_and(t,a){let o=!0;for(let e=0;e<t.length&&1==o;e++)o=zoteroRoam.smartblocks.eval_term(t[e],a);return o},eval_or(t,a){let o=!1;for(let e=0;e<t.length&&0==o;e++)o=zoteroRoam.smartblocks.eval_term(t[e],a);return o},eval_term(e,t){if(e.startsWith("(")&&e.endsWith(")")){var a=e.slice(1,-1);return zoteroRoam.smartblocks.processQuery(a,t)}if(e.startsWith("-")){a=e.slice(1);return!t.includes(a)}return t.includes(e)},registerCommands(){Object.keys(zoteroRoam.smartblocks.commands).forEach(e=>{var{help:t,handler:a}=zoteroRoam.smartblocks.commands[`${e}`];window.roamjs.extension.smartblocks.registerCommand({text:e,help:t,handler:a})})},async use_smartblock_metadata(e,t){let a=e;a.targetUid=t.uid,a.variables||(a.variables={}),Object.keys(t).forEach(e=>{a.variables[`${e}`]=t[`${e}`]});try{return await window.roamjs.extension.smartblocks.triggerSmartblock(a),{success:!0}}catch(e){return console.log(e),{success:!1}}}},(()=>{if(void 0===window.zoteroRoam_settings)throw new Error("A zoteroRoam_settings object must be defined in order to use the extension. Read through the docs for basic setup examples.");zoteroRoam.config.userSettings=window.zoteroRoam_settings,zoteroRoam.config.userSettings.theme&&(zoteroRoam.config.params.theme=zoteroRoam.config.userSettings.theme),zoteroRoam.interface.create(),zoteroRoam.interface.setup(),zoteroRoam.addExtensionCSS(),window.addEventListener("hashchange",()=>{zoteroRoam.interface.toggleSearchOverlay("hide"),zoteroRoam.interface.closeAuxiliaryOverlay()});var e=zoteroRoam.config.userSettings.override_quickcopy||!1;e&&(zoteroRoam.config.params.override_quickcopy.key=e,window.addEventListener("keydown",e=>{e.key==zoteroRoam.config.params.override_quickcopy.key|1==e[zoteroRoam.config.params.override_quickcopy.key]&&(zoteroRoam.config.params.override_quickcopy.overridden=!0)}),window.addEventListener("keyup",e=>{e.key==zoteroRoam.config.params.override_quickcopy.key|0==e[zoteroRoam.config.params.override_quickcopy.key]&&(zoteroRoam.config.params.override_quickcopy.overridden=!1)}));var t,a,o,r,{always_copy:i=!1,quick_copy_format:e="citekey"}=zoteroRoam.config.userSettings;zoteroRoam.config.params.always_copy=i,zoteroRoam.config.params.quick_copy_format=e,zoteroRoam.config.userSettings.autocomplete&&({format:e="citation",trigger:a="",display:t="citekey"}=zoteroRoam.config.userSettings.autocomplete,zoteroRoam.config.params.autocomplete.format=e,zoteroRoam.config.params.autocomplete.display=t,0<a.length&&(zoteroRoam.config.tribute.trigger=a,zoteroRoam.config.params.autocomplete.enabled=!0)),zoteroRoam.config.userSettings.notes&&({use:t="text",split_char:a="\n",func:o="zoteroRoam.utils.formatItemNotes"}=zoteroRoam.config.userSettings.notes,zoteroRoam.config.params.notes.use=t,zoteroRoam.config.params.notes.split_char=a,zoteroRoam.config.params.notes.func=o),zoteroRoam.config.userSettings.pageMenu&&({defaults:o,trigger:r}=zoteroRoam.config.userSettings.pageMenu,o&&(zoteroRoam.config.params.pageMenu.defaults=o),r&&"function"==typeof r&&(zoteroRoam.config.params.pageMenu.trigger=r)),zoteroRoam.config.userSettings.webimport&&({tags:r=[]}=zoteroRoam.config.userSettings.webimport,zoteroRoam.config.params.webimport.tags=r),zoteroRoam.shortcuts.setup(),zoteroRoam.shortcuts.setupSequences(),zoteroRoam.handlers.setupUserRequests(),zoteroRoam.events.defaultHooks(),1==zoteroRoam.config.userSettings.autoload&&setTimeout(function(){zoteroRoam.extension.load()},1e3)})();