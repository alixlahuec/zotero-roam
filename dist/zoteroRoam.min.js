...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.25",data:{items:[],collections:[],scite:[],libraries:[],keys:[]},librarySearch:{autocomplete:null},citations:{pagination:null,autocomplete:null,currentDOI:""},config:{autoComplete:{data:{src:async function(){return 0==zoteroRoam.data.items.length?[]:zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{return Array.from(new Set(e.map(e=>e.value.key))).map(t=>e.filter(e=>e.value.key==t).sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1)[0])}},selector:"#zotero-roam-search-autocomplete",wrapper:!1,searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),sort:(e,t)=>e.value.authors.toLowerCase()<t.value.authors.toLowerCase()?-1:e.value.authors.toLowerCase()>t.value.authors.toLowerCase()?1:0,resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
                        ...
                        `,i=t.value.year?` (${t.value.year})`:"";let n="";t.value.authors&&(n="authorsString"==t.key||"year"==t.key?`<span class="zotero-roam-search-item-authors autoComplete_highlighted">${t.value.authors}${i}</span>`:`<span class="zotero-roam-search-item-authors">${zoteroRoam.utils.renderBP3Tag(t.value.authors+i,{modifier:"bp3-intent-primary"})}</span>`);let s="";t.value.tagsString&&(i="tagsString"==t.key?t.match:t.value.tagsString,s=`<span class="zotero-roam-search-item-tags" style="display:block;">${i}</span>`),e.innerHTML=`<div label="${t.value.key}" class="bp3-menu-item bp3-popover-dismiss">
                                            ...
                                            ${r}
                                            </div>`}},events:{input:{blur:e=>{},focus:e=>{zoteroRoam.interface.clearSelectedItem(),zoteroRoam.librarySearch.autocomplete.start()},keydown:e=>{zoteroRoam.interface.clearSelectedItem(),zoteroRoam.librarySearch.autocomplete.start()},results:e=>{0==e.detail.query.length?document.querySelector(".zotero-roam-library-results-count").innerHTML="":0<e.detail.query.length&&0==e.detail.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
                                <strong>No results</strong> for ${e.detail.query}
                                `)},selection:o=>{var a=o.detail;zoteroRoam.interface.search.input.blur(),document.querySelector(".zotero-roam-library-results-count").innerHTML="";o=document.querySelector("#zotero-roam-quick-copy-mode").checked;if(1==zoteroRoam.config.params.always_copy||o&&!zoteroRoam.config.params.override_quickcopy.overridden){let e=zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility"),t="";if("citation"===zoteroRoam.config.params.quick_copy_format){let e=`${a.selection.value.authors||""}`;a.selection.value.year&&(e+=` (${a.selection.value.year})`),t=`[${e}]([[@${a.selection.value.key}]])`}else t=zoteroRoam.utils.formatItemReference(item=a.selection.value,format=zoteroRoam.config.params.quick_copy_format);e.value=t,e.select(),document.execCommand("copy"),o&&!zoteroRoam.config.params.override_quickcopy.overridden?zoteroRoam.interface.toggleSearchOverlay("hide"):zoteroRoam.interface.renderItemInPanel("@"+a.selection.value.key)}else zoteroRoam.interface.renderItemInPanel("@"+a.selection.value.key)}}}},citationsSearch:{data:{src:async function(){return 0==zoteroRoam.citations.currentDOI.length?[]:zoteroRoam.data.scite.find(e=>e.doi==zoteroRoam.citations.currentDOI).simplified},keys:["year","title","keywords","authorsString","abstract","meta"],filter:e=>{return Array.from(new Set(e.map(e=>e.value.doi))).map(t=>e.filter(e=>e.value.doi==t).sort((t,o)=>zoteroRoam.config.citationsSearch.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.citationsSearch.data.keys.findIndex(e=>e==o.key)?-1:1)[0])}},selector:"#zotero-roam-citations-autocomplete",wrapper:!1,searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),resultsList:!1,events:{input:{keydown:e=>{zoteroRoam.citations.autocomplete.start()},results:o=>{if(0<o.detail.results.length)zoteroRoam.citations.pagination=new zoteroRoam.Pagination({data:o.detail.results.map(e=>e.value)}),zoteroRoam.interface.renderCitationsPagination();else if(0==o.detail.query.length)zoteroRoam.interface.popCitationsOverlay(doi=zoteroRoam.citations.currentDOI);else{let e=document.querySelector("#zotero-roam-citations-pagination");e.querySelector(".zotero-roam-citations-results-count").innerHTML=`
            ...
            `,t.appendChild(b),zoteroRoam.interface.search.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.search.input=document.querySelector("#zotero-roam-search-autocomplete"),zoteroRoam.interface.search.selectedItemDiv=document.querySelector("#zotero-roam-search-selected-item"),zoteroRoam.interface.search.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-search-close`),zoteroRoam.interface.search.updateButton=document.querySelector(`.${e}-overlay button.zotero-roam-update-data`)},fillCitationsOverlay(e=zoteroRoam.interface.citations.overlayClass){let t=document.querySelector(`.${e}-overlay .bp3-dialog-body .main-panel`),o=document.createElement("div");o.classList.add("bp3-input-group"),o.classList.add("header-content");let a=document.createElement("div");a.classList.add("header-left");let r=document.createElement("h5");r.innerText="Citing Papers";let i=document.createElement("p");i.classList.add("bp3-text"),i.classList.add("panel-subtitle"),i.innerText="Search by title, year, authors (last names), abstract, keywords, publication";let n=document.createElement("input");n.id="zotero-roam-citations-autocomplete",n.tabIndex="1",n.type="text",n.classList.add("bp3-input"),n.classList.add("bp3-intent-warning"),a.appendChild(r),a.appendChild(i),a.appendChild(n);let s=document.createElement("div");s.classList.add("header-right");let l=document.createElement("div");l.classList.add("controls-top"),l.innerHTML=`
            <button type="button" aria-label="Close" class="zotero-roam-search-close bp3-button bp3-minimal bp3-dialog-close-button">
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,s.appendChild(l),o.appendChild(a),o.appendChild(s);let c=document.createElement("div");c.id="zotero-roam-citations-pagination";let d=document.createElement("div");d.classList.add("bp3-button-group"),d.classList.add("bp3-minimal"),d.innerHTML=`
            ...
            `,t.innerHTML=o.map(t=>{var o,e=`<span class="zotero-roam-search-item-title" style="display:block;">${t.title} ${t.inLibrary?'<span icon="endorsed" class="bp3-icon bp3-icon-endorsed bp3-intent-success"></span>':""}</span>`,a=t.authors+(t.year?" ("+t.year+")":""),r=`<span class="zotero-roam-citation-metadata-contents">${zoteroRoam.utils.renderBP3Tag(a,{modifier:"bp3-intent-warning"})} ${t.meta}</span>`;let i="";for(o of Object.keys(t.links)){let e=[];switch(o){case"scite":e.push(`<span class="zotero-roam-citation-link" service="scite"><a href="${t.links[o]}" target="_blank">Scite</a></span>`);break;case"connectedPapers":e.push(`<span class="zotero-roam-citation-link" service="connected-papers"><a href="${t.links[o]}" target="_blank">Connected Papers</a></span>`);break;case"semanticScholar":e.push(`<span class="zotero-roam-citation-link" service="semantic-scholar"><a href="${t.links[o]}" target="_blank">Semantic Scholar</a></span>`);break;case"googleScholar":e.push(`<span class="zotero-roam-citation-link" service="google-scholar"><a href="${t.links[o]}" target="_blank">Google Scholar</a></span>`)}i+=e.join(" &#8226; ")}a=`
                <span class="bp3-menu-item-label zotero-roam-search-item-key">
                <a href="https://doi.org/${t.doi}" target="_blank" class="zotero-roam-citation-doi-link">${t.doi}</a>
            ...
            `;let R=document.querySelector(".selected-item-body");y=1==h.present?`data-uid="${h.uid}"`:"disabled",f=zoteroRoam.shortcuts.sequences.goToItemPage?zoteroRoam.shortcuts.makeSequenceText("goToItemPage",pre=" "):"",e=1==h.present?`https://roamresearch.com/${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${h.uid}`:"javascript:void(0)",e=`
            <div class="bp3-button-group bp3-minimal bp3-fill bp3-align-left">
            ${zoteroRoam.utils.renderBP3Button_link(string="Go to Roam page"+f,{linkClass:"item-go-to-page",icon:"arrow-right",iconModifier:"bp3-intent-primary",target:e,linkAttribute:y})}
            </div>
            `,y=`Import metadata  ${zoteroRoam.shortcuts.sequences.importMetadata?zoteroRoam.shortcuts.makeSequenceText("importMetadata",pre=" "):""}`,y=zoteroRoam.utils.renderBP3ButtonGroup(string=y,{buttonClass:"item-add-metadata",divClass:"bp3-minimal bp3-fill bp3-align-left",icon:"add",modifier:"bp3-intent-primary"});let k=zoteroRoam.formatting.getItemChildren(r,{pdf_as:"raw",notes_as:"raw"}),w="";if(k.remoteChildren)w+="<p>This item has children, but they were not returned by the API data request. This might be due to a request for 'items/top' rather than 'items'.</p>";else try{var $=k.pdfItems?k.pdfItems.map(e=>{var t=["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`zotero://open-pdf/library/items/${e.data.key}`:e.data.url,e=e.data.filename||e.data.title;return zoteroRoam.utils.renderBP3Button_link(string=e,{linkClass:"bp3-minimal item-pdf-link",icon:"paperclip",target:t})}).join(""):"No PDF attachments";w+=$,k.notes&&($=zoteroRoam.shortcuts.sequences.toggleNotes?zoteroRoam.shortcuts.makeSequenceText("toggleNotes",pre=" "):"",w+=`${zoteroRoam.utils.renderBP3Button_group(string="Show Notes"+$,{buttonClass:"bp3-minimal bp3-align-left bp3-fill item-see-notes",icon:"comment"})}`,zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML=`
                        <h4>Notes</h4>
                        <div class="item-rendered-notes">
                            ${k.notes.map(e=>e.data.note).join("<br>")}
                        </div>
                        `)}catch(e){console.log(k),console.log(pdfDiv),console.log(e),console.log("Something went wrong while getting the item's children data")}R.innerHTML=`
            <div class="item-additional-metadata">
                <p class="item-abstract">${r.data.abstractNote}</p>
