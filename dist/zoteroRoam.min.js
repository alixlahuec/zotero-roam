...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.30",data:{items:[],collections:[],scite:[],libraries:[],keys:[]},librarySearch:{autocomplete:null},citations:{pagination:null,autocomplete:null,currentDOI:""},tagSelection:{autocomplete:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e.sort((e,t)=>0==e.authors.length?2:e.authors.toLowerCase()<t.authors.toLowerCase()||0==t.authors.length?0:1)},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{return Array.from(new Set(e.map(e=>e.value.key))).map(t=>e.filter(e=>e.value.key==t).sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1)[0])}},selector:"#zotero-roam-search-autocomplete",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            `,document.head.append(e)}};var e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@10.1.5/dist/autoComplete.js",e.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(e),void 0===window.Tribute&&((t=document.createElement("script")).src="https://cdn.jsdelivr.net/npm/tributejs@5.1.3",t.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(t));var t=document.createElement("script");t.src="https://cdn.scite.ai/badge/scite-badge-latest.min.js",t.type="application/javascript",t.async=!0,document.getElementsByTagName("head")[0].appendChild(t)})(),zoteroRoam.utils={addBlock(e,t,o=0){window.roamAlphaAPI.createBlock({location:{"parent-uid":e,order:o},block:{string:t}})},escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")},executeFunctionByName(e,t){for(var o=Array.prototype.slice.call(arguments,2),a=e.split("."),r=a.pop(),i=0;i<a.length;i++)t=t[a[i]];return t[r].apply(t,o)},findCommonTags(t,{exclude_attachments:e=!0,excluded_tags:o=[],more_than:a=0}={}){let r=t.data.tags.map(e=>e.tag.toLowerCase()).filter(e=>!o.includes(e)),i=1==e?zoteroRoam.data.items.filter(e=>!["attachment","note","annotation"].includes(e.data.itemType)):zoteroRoam.data.items;return i=i.filter(e=>e.key!=t.key),i.map(e=>{let t=e.data.tags.map(e=>e.tag.toLowerCase()),o=0,a=[];return t.forEach(e=>{r.includes(e)&&(o+=1,a.push(e))}),{item:e,proximity:o,commons:a}}).filter(e=>e.proximity>a)},findSameDay(t,{exclude_attachments:e=!0}={}){let o=zoteroRoam.data.items.filter(e=>new Date(e.data.dateAdded).toDateString()==new Date(t.data.dateAdded).toDateString());return 0==o.length?[]:1==e?o.filter(e=>"attachment"!=e.data.itemType):o},formatBib(e){e=e.match('csl-entry">(.+)</div>')[1];let t=document.createElement("textarea");t.innerHTML=e;let o=t.innerText;o=o.replaceAll(/<\/?i>/g,"__");return o=o.replaceAll(/<a href="(.+)">(.+)<\/a>/g,"[$2]($1)"),o},splitNotes(e,t=zoteroRoam.config.params.notes.split_char){return 0!=e.length&&e.map(e=>e.data.note.split(t))},formatItemNotes(e){return e.flat(1).map(e=>zoteroRoam.utils.parseNoteBlock(e)).filter(e=>e.trim())},formatItemReference(o,a){switch(a){case"tag":return`#[[@${o.key}]]`;case"pageref":return`[[@${o.key}]]`;case"citation":let e=o.meta.creatorSummary||"";return e=o.meta.parsedDate?`${e} (${new Date(o.meta.parsedDate).getUTCFullYear()})`:e,e=`[${0<e.length?e:o.key}]([[@${o.key}]])`,e;case"popover":let t=o.meta.creatorSummary||"";return t=o.meta.parsedDate?`${t} (${new Date(o.meta.parsedDate).getUTCFullYear()})`:t,t=`{{=: ${0<t.length?t:o.key} | {{embed: [[@${o.key}]]}} }}`,t;case"zettlr":return(o.meta.creatorSummary||"")+(o.meta.parsedDate?` (${new Date(o.meta.parsedDate).getUTCFullYear()})`:"")+" : "+o.data.title;case"zettlr_accent":return"<strong>"+(o.meta.creatorSummary||"")+(o.meta.parsedDate?` (${new Date(o.meta.parsedDate).getUTCFullYear()})`:"")+"</strong>"+" : "+o.data.title;case"citekey":default:return`@${o.key}`}},getRoamPages(){return roamAlphaAPI.q("[:find [(pull ?e [:node/title])...] :where[?e :node/title ?t]]")},getAllRefPages(){return roamAlphaAPI.q('[:find [(pull ?e [:node/title :block/uid])...] :where[?e :node/title ?t][(clojure.string/starts-with? ?t "@")]]')},getItemPrefix(e){return`${e.library.type}s/${e.library.id}`},getTopBlockData(e){var t=window.roamAlphaAPI.q("[:find ?bUID ?bText :in $ ?pUID :where[?b :block/uid ?bUID][?b :block/string ?bText][?b :block/order 0][?p :block/children ?b][?p :block/uid ?pUID]]",e);if(void 0===t||null==t||0==t.length)return!1;try{return{uid:t[0][0],text:t[0][1]}}catch(e){console.error(e)}},getLibraries(){return zoteroRoam.config.requests.map(t=>{var e=zoteroRoam.data.keys.find(e=>e.key==t.apikey).access,{libType:o,libID:a}=t.library.split("/"),a="users"==o?e.user:Object.keys(e.groups).includes(a)?e.groups[a]:e.groups.all,e=zoteroRoam.data.collections.filter(e=>e.requestLabel==t.name);return{name:0<e.length?e[0].library.name:t.library,apikey:t.apikey,path:t.library,writeable:a.write,collections:e,version:zoteroRoam.data.libraries.find(e=>e.path==t.library).version}})},lookForPage(e){let t=null;e=window.roamAlphaAPI.q("[:find ?uid :in $ ?title :where[?p :block/uid ?uid][?p :node/title ?title]]",e);return t=0<e.length?{present:!0,uid:e[0][0]}:{present:!1},t},makeDNP(e,{brackets:t=!0}={}){e=`${["January","February","March","April","May","June","July","August","September","October","November","December"][(e=e.constructor!==Date?new Date(e):e).getMonth()]} ${zoteroRoam.utils.makeOrdinal(e.getDate())}, ${e.getFullYear()}`;return t?`[[${e}]]`:e},makeMetaString(e){let t="";var o=[e.data.publicationTitle,e.data.university,e.data.bookTitle].filter(Boolean);return 0<o.length&&(t+=` ${o[0]}`),e.data.publisher&&(t+=`, ${e.data.publisher}`,e.data.place&&(t+=`: ${e.data.place}`)),e.data.volume&&(t+=`, ${e.data.volume}`,e.data.issue&&(t+=`(${e.data.issue})`)),t+=e.data.pages?`, ${e.data.pages}.`:".",t},makeOrdinal(e){var t=e%10;return 1==t&11!=e?e+"st":2==t&12!=e?e+"nd":3==t&13!=e?e+"rd":e+"th"},makeLinkToPDF(e){var t="group"==e.library.type?`groups/${e.library.id}`:"library";return["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`[${e.data.filename||e.data.title}](zotero://open-pdf/${t}/items/${e.data.key})`:`[${e.data.title}](${e.data.url})`},makePDFLinks(e){return e.constructor===Array&&0<e.length?e.map(e=>zoteroRoam.utils.makeLinkToPDF(e)):e.constructor===Object&&zoteroRoam.utils.makeLinkToPDF(e)},multiwordMatch(e,t){var o=e.toLowerCase().split(" ");let a=t.toLowerCase(),r=!1;for(let e=0;e<o.length;e++){if(!a.includes(o[e])){r=!1;break}r=!0,a=a.replace(o[e],"")}if(r)return t},addToSidebar(e,t="outline"){window.roamAlphaAPI.ui.rightSidebar.addWindow({window:{type:t,"block-uid":e}})},parseDOI(e){return e.startsWith("10")?e:e.match(/10\.([0-9]+?)\/(.+)/g)[0]},parseNoteBlock(e){let t=e;var o={"</p>":"","</div>":"","<blockquote>":"> ","</blockquote>":"","<strong>":"**","</strong>":"**","<em>":"__","</em>":"__","<b>":"**","</b>":"**","<br />":"\n","<br>":"\n","<u>":"","</u>":""};for(prop in o)t=t.replaceAll(`${prop}`,`${o[prop]}`);["p","div","span","h1","h2","h3"].forEach(e=>{e=new RegExp(`<${e}>|<${e} .+?>`,"g");t=t.replaceAll(e,"")});return t=t.replaceAll(/<a href="(.+?)">(.+?)<\/a>/g,"[$2]($1)"),t=zoteroRoam.utils.cleanNewlines(t),t},cleanNewlines(e){let t=e;return t.startsWith("\n")?(t=t.slice(1),t=zoteroRoam.utils.cleanNewlines(t)):t.endsWith("\n")&&(t=t.slice(0,-1),t=zoteroRoam.utils.cleanNewlines(t)),t},renderBP3Button_link(e,{linkClass:t="",icon:o="",iconModifier:a="",target:r="",linkAttribute:i=""}={}){return`
            ...
            `},renderBP3ButtonGroup(e,{divClass:t="bp3-minimal bp3-fill bp3-align-left",buttonClass:o="",modifier:a="",icon:r="",buttonModifier:i=""}={}){return`<div class="bp3-button-group ${t}">
                    ...
                    </div>`},renderBP3_list(e,a,{varName:r,has_value:i,has_string:n,optClass:s="",selectFirst:l=!1,active_if:c=""}={}){return e.map((e,t)=>{let o="";return c&&(o=e[c]?"":"disabled",s+=e[c]?"":"bp3-disabled"),l&&0==t&&""==o&&(o="checked"),zoteroRoam.utils.renderBP3_option(string=e[n],a,{varName:r,optClass:s,modifier:o,optValue:e[i]})}).join("\n")},renderBP3_option(e,t,{varName:o,optClass:a="",modifier:r="",optValue:i=""}={}){return`
            <label class="bp3-control bp3-${t} ${a}">
                <input type="${t}" name="${o}" value="${i}" ${r} />
            ...
            <span tabindex="-1" class="rm-page-ref rm-page-ref--link">${e}</span></span>`},renderPageTag(e){return`<span tabindex="-1" data-tag="${e}" class="rm-page-ref rm-page-ref--tag">#${e}</span>`},setNativeValue(e,t){const o=Object.getOwnPropertyDescriptor(e,"value").set;var a=Object.getPrototypeOf(e);const r=Object.getOwnPropertyDescriptor(a,"value").set;(o&&o!==r?o:r).call(e,t)},sleep(t){return new Promise(e=>setTimeout(e,t))}},zoteroRoam.handlers={async addBlockObject(e,t){if(void 0===t.string)throw console.log(t),new Error("All blocks passed as an Object must have a string property");if(zoteroRoam.utils.addBlock(uid=e,blockString=t.string,order=0),void 0!==t.children){var o=await zoteroRoam.handlers.waitForBlockUID(e,t.string);for(let e=t.children.length-1;0<=e;e--)if(t.children[e].constructor===Object)await zoteroRoam.handlers.addBlockObject(o,t.children[e]);else{if(t.children[e].constructor!==String)throw new Error("All children array items should be of type String or Object");zoteroRoam.utils.addBlock(uid=o,blockString=t.children[e],order=0)}}},async addItemData(e){try{var t=e.parentElement.dataset.linkTitle.replace("@",""),o=e.parentElement.dataset.linkUid,a=zoteroRoam.data.items.find(e=>e.key==t);!a||0<(a=await zoteroRoam.handlers.formatData(a)).length&&await zoteroRoam.handlers.addMetadataArray(page_uid=o,arr=a)}catch(e){console.error(e)}},async addMetadataArray(e,t){if(0<t.length){for(k=t.length-1;0<=k;k--)if(t[k].constructor===Object)await zoteroRoam.handlers.addBlockObject(e,t[k]);else{if(t[k].constructor!==String)throw console.log(t[k]),new Error("All array items should be of type String or Object");zoteroRoam.utils.addBlock(uid=e,blockString=t[k],order=0)}return{success:!0}}return console.log("The metadata array was empty ; nothing was done."),{success:!1}},async addSearchResult(t,o,{popup:a=!0}={}){var r=t.replace("@",""),e=zoteroRoam.data.items.find(e=>e.key==r),i=await zoteroRoam.handlers.formatData(e);let n={};if(e&&0<i.length){var s;if(o)n=await zoteroRoam.handlers.addMetadataArray(page_uid=o,arr=i);else if(window.roamAlphaAPI.createPage({page:{title:t}}),null!=(s=await zoteroRoam.handlers.waitForPageUID(t))){n=await zoteroRoam.handlers.addMetadataArray(page_uid=s,arr=i);try{let e=document.querySelector(".item-in-graph");null!=e&&(e.innerHTML='<span class="bp3-icon-tick bp3-icon bp3-intent-success"></span><span> In the graph</span>');let t=document.querySelector(".item-go-to-page");null!=t&&(t.setAttribute("data-uid",s),t.setAttribute("href",`https://roamresearch.com/${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${s}`),t.removeAttribute("disabled"))}catch(e){}await zoteroRoam.utils.sleep(125)}else{var l=`There was a problem in obtaining the page's UID for ${t}.`;1==a?zoteroRoam.interface.popToast(l,"danger"):console.log(l)}l=n.success?"Metadata was successfully added.":"The metadata array couldn't be properly processed.";let e=n.success?"success":"danger";1==a?zoteroRoam.interface.popToast(message=l,e):console.log(l)}else console.log(e),console.log(i),zoteroRoam.interface.popToast(message="Something went wrong when formatting or importing the item's data.",intent="danger")},async addItemNotes(t,o,{popup:a=!0}={}){var r=t.startsWith("@")?t.slice(1):t,i=zoteroRoam.data.items.find(e=>e.key==r);try{var n=zoteroRoam.formatting.getItemChildren(i,{pdf_as:"raw",notes_as:"formatted",split_char:split_char=zoteroRoam.config.params.notes.split_char}).notes;let e={};var s;if(o)e=await zoteroRoam.handlers.addMetadataArray(page_uid=o,arr=n);else if(window.roamAlphaAPI.createPage({page:{title:t}}),null!=(s=await zoteroRoam.handlers.waitForPageUID(t))){e=await zoteroRoam.handlers.addMetadataArray(page_uid=s,arr=n);try{let e=document.querySelector(".item-in-graph");null!=e&&(e.innerHTML='<span class="bp3-icon-tick bp3-icon bp3-intent-success"></span><span> In the graph</span>');let t=document.querySelector(".item-go-to-page");null!=t&&(t.setAttribute("data-uid",s),t.disabled=!1)}catch(e){}await zoteroRoam.utils.sleep(125)}else{var l=`There was a problem in obtaining the page's UID for ${t}.`;1==a?zoteroRoam.interface.popToast(l,"danger"):console.log(l)}n=e.success?"Notes successfully imported.":"The notes couldn't be imported.",l=e.success?"success":"danger";1==a?zoteroRoam.interface.popToast(n,l):console.log(n)}catch(e){console.error(e),console.log(i),console.log(itemChildren)}},extractCitekeys(e){return e.map(e=>(void 0!==e.data.extra&&e.data.extra.includes("Citation Key: ")&&(e.key=e.data.extra.match("Citation Key: (.+)")[1]),e))},async fetchData(r,n,t){var o=`https://api.zotero.org/${n}?${t}`;let s=[];try{let e=await fetch(o,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":r}});if(1==e.ok){var l=e.headers.get("Total-Results");let a=new URLSearchParams(t);var c=a.has("start")?Number(a.get("start")):0,d=a.has("limit")?Number(a.get("limit")):100;s=await e.json();var m=c+s.length;if(m<l){var p=Math.ceil((l-m)/d);let e=[];for(i=1;i<=p;i++){var u=m+d*(i-1);a.set("start",u),a.set("limit",d),e.push(fetch(`https://api.zotero.org/${n}?${a.toString()}`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":r}}))}let t=await Promise.all(e),o=await Promise.all(t.map(e=>e.json()));o=o.flat(1),s.push(...o)}}else console.log(`The request for ${e.url} returned a code of ${e.status}`)}catch(e){console.error(e),zoteroRoam.interface.popToast("The extension encountered an error while requesting Zotero data. Please check the console for details.","danger")}finally{return{data:s}}},async formatData(e){var t=e.data.itemType;let o=zoteroRoam.funcmap.DEFAULT;zoteroRoam.config.userSettings.funcmap&&(o=zoteroRoam.config.userSettings.funcmap[`${t}`]||zoteroRoam.config.userSettings.funcmap.DEFAULT||o);try{return await zoteroRoam.utils.executeFunctionByName(o,window,e)}catch(e){return console.error(e),console.log(`There was a problem when formatting the item with function ${o}`),[]}},formatNotes(e,t=zoteroRoam.config.params.notes.use,o=zoteroRoam.config.params.notes.split_char){let a=[];var r=zoteroRoam.config.params.notes.func;try{switch(t){case"raw":return a=zoteroRoam.utils.executeFunctionByName(r,window,e),a;case"text":var i=zoteroRoam.utils.splitNotes(e,o);return a=zoteroRoam.utils.executeFunctionByName(r,window,i),a;default:console.error(`Unsupported format : ${t}`)}}catch(e){return console.error(e),console.log(`There was a problem when formatting the item with function ${r}`),[]}},setupUserRequests(){if(!zoteroRoam.config.userSettings.dataRequests)throw new Error("At least one data request object needs to be specified in order to use the extension. Read through the docs for basic setup examples.");{let e=zoteroRoam.config.userSettings.dataRequests;e=e.constructor===Array?e:[e];var n=e.find(e=>void 0!==e.apikey).apikey,s=e.find(e=>void 0!==e.params).params;e=e.map((e,t)=>{let{name:o=`${t}`,apikey:a=n,dataURI:r,params:i=s}=e;return{apikey:a,dataURI:r,params:i,name:o,library:r.match(/(users|groups)\/(.+?)\//g)[0].slice(0,-1)}});let t=Array.from(new Set(e.map(e=>e.library)));zoteroRoam.data.libraries=t.map(e=>({path:e,version:0})),zoteroRoam.config.requests=e}},async checkForScitations(e){try{var t=e.parentElement.dataset.linkTitle.replace("@",""),o=zoteroRoam.data.items.find(e=>e.key==t);o&&(o.data.DOI?0==(await zoteroRoam.handlers.requestScitations(o.data.DOI)).simplified.length?zoteroRoam.interface.popToast("This item has no available citing papers"):zoteroRoam.interface.popCitationsOverlay(o.data.DOI):zoteroRoam.interface.popToast("This item has no DOI (required for citations lookup).","danger"))}catch(e){console.error(e)}},async importSelectedItems(){var e=zoteroRoam.interface.activeImport.currentLib,t=Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll('.options-collections [name="collections"]')).filter(e=>e.checked).map(e=>e.value);let o=zoteroRoam.interface.activeImport.items;var a=zoteroRoam.interface.citations.overlay.querySelector(".options-tags_selection").dataset.tags,a=JSON.parse(a);let r=[];o.forEach(e=>{r.push(zoteroRoam.handlers.requestCitoid(query=e,{collections:t,tag_with:a}))});let i=await Promise.all(r);i=i.map(e=>e.data);var n=i.filter(e=>0!=e),s=o.filter((e,t)=>0==i[t]);console.log(s);e=await zoteroRoam.write.importItems(n,e);console.log(e)},async requestCitoid(t,{format:o="zotero",has_relation:a=!1,tag_with:r=[],collections:i=[]}={}){let n=!1;try{let e=await fetch(`https://en.wikipedia.org/api/rest_v1/data/citation/${o}/${encodeURIComponent(t)}`,{method:"GET"});var s,l,c,d;1==e.ok?0<(s=await e.json()).length&&({key:l,version:c,...d}=s[0],d.collections=i,d.relations={},0!=a&&(d.relations.dc_relation=`http://zotero.org/${zoteroRoam.utils.getItemPrefix(a)}/items/${a.data.key}`),0<r.length&&(r.constructor===Array?r.forEach(e=>d.tags.push({tag:e})):r.constructor===String?d.tags.push({tag:r}):console.log(`Unsupported tag input : ${r}`)),n=d):console.log(`The request for ${e.url} returned a code of ${e.status}`)}catch(e){console.error(e),zoteroRoam.interface.popToast("The extension encountered an error while accessing citation data. Please check the console for details.","danger")}finally{return{data:n}}},async requestScitations(t){var o=zoteroRoam.data.scite.findIndex(e=>e.doi==t);if(-1!=o)return zoteroRoam.data.scite[o];{let e=await fetch(`https://api.scite.ai/papers/sources/${t}`);o=await e.json(),o=Object.values(o.papers);let a={doi:t,citations:o||[]};return a.citations.forEach((e,t)=>{let o=zoteroRoam.data.items.filter(e=>e.data.DOI).map(e=>zoteroRoam.utils.parseDOI(e.data.DOI));o.includes(e.doi)&&(a.citations[t].inLibrary=!0)}),a.simplified=zoteroRoam.handlers.simplifyCitationsObject(a.citations),a.keywords=zoteroRoam.handlers.getCitationsKeywordsCounts(a.citations),zoteroRoam.data.scite.push(a),a}},async requestData(r){let o=[],a=[];if(0==r.length)throw new Error("No data requests were added to the config object - check for upstream problems");try{r.forEach(e=>{o.push(zoteroRoam.handlers.fetchData(apiKey=e.apikey,dataURI=e.dataURI,params=e.params)),a.push(fetch(`https://api.zotero.org/${e.library}/collections`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":e.apikey}}))});let e=await Promise.all(o);e=e.map((e,t)=>e.data.map(e=>(e.requestLabel=r[t].name,e.requestIndex=t,e))).flat(1),e=zoteroRoam.handlers.extractCitekeys(e);let t=await Promise.all(a);return t=await Promise.all(t.map((e,t)=>{var o=e.headers.get("Last-Modified-Version"),a=zoteroRoam.data.libraries.findIndex(e=>e.path==r[t].library);return o>zoteroRoam.data.libraries[a].version&&(zoteroRoam.data.libraries[a].version=o),e.json()})),t=t.map((e,t)=>e.map(e=>(e.requestLabel=r[t].name,e.requestIndex=t,e))).flat(1),{success:!0,data:{items:e,collections:t}}}catch(e){return console.error(e),console.log({dataCalls:o,collectionsCalls:a}),{success:!1}}},async requestItemBib(e,{include:t="bib",style:o,linkwrap:a,locale:r}={}){var i="user"==e.library.type?"users":"groups",n=zoteroRoam.config.requests[`${e.requestIndex}`].apikey;let s=await fetch(`https://api.zotero.org/${i}/${e.library.id}/items/${e.data.key}?include=${t}&style=${o}&linkwrap=${a}&locale=${r}`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":n}});return(await s.json())[`${t}`]},async requestItemChildren(e){var t=zoteroRoam.config.requests[`${e.requestIndex}`].apikey;let o=await fetch(`${e.links.self.href}/children`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":t}});return await o.json()},simplifyDataArray(e){let t=e.filter(e=>!["attachment","note","annotation"].includes(e.data.itemType));return t=t.map(e=>{let t={key:e.key,itemKey:e.data.key,title:`${e.data.title||""}`,abstract:`${e.data.abstractNote||""}`,authors:`${e.meta.creatorSummary||""}`,year:`${e.meta.parsedDate?new Date(e.meta.parsedDate).getUTCFullYear().toString():""}`,meta:`${zoteroRoam.utils.makeMetaString(e)}`,tags:e.data.tags.map(e=>e.tag),authorsFull:e.data.creators.map(e=>e.name||[e.firstName,e.lastName].filter(Boolean).join(" ")),authorsRoles:e.data.creators.map(e=>e.creatorType),authorsLastNames:e.data.creators.map(e=>e.lastName||e.name),authorsString:e.data.creators.map(e=>e.lastName||e.name).join(" "),tagsString:e.data.tags.map(e=>`#${e.tag}`).join(", "),location:zoteroRoam.utils.getItemPrefix(e)};return t._multiField=t.authorsString+" "+t.year+" "+t.title+" "+t.tagsString,t}),t},simplifyCitationsObject(e){return 0<e.length?e.map(e=>{let t={abstract:e.abstract||"",doi:e.doi||"",keywords:e.keywords||[],keywordsString:e.keywords?e.keywords.join(" "):"",links:{scite:`https://scite.ai/reports/${e.slug}`},title:e.title,year:`${e.year}`||"",meta:""},o=0<e.authors.length?e.authors.map(e=>e.family):[];return t.authorsLastNames=0<e.authors.length?e.authors.map(e=>e.family):[],t.authorsString=t.authorsLastNames.join(" "),o=0<o.length?2<o.length?o.slice(0,1).join(", ")+" et al.":o.map((e,t)=>0==t?e:t<o.length-1?`, ${e}`:` and ${e}`).join(""):"",t.authors=o,t.meta=`${e.journal||e.publisher}${e.volume?", "+e.volume+"("+e.issue+")":""}${e.page?", "+e.page+".":"."}`,e.inLibrary&&(t.inLibrary=!0),t.links.connectedPapers=`https://www.connectedpapers.com/${e.doi?"api/redirect/doi/"+e.doi:"search?q="+encodeURIComponent(e.title)}`,e.doi&&(t.links.semanticScholar=`https://api.semanticscholar.org/${e.doi}`),t.links.googleScholar=`https://scholar.google.com/scholar?q=${e.doi||encodeURIComponent(e.title)}`,t}):[]},getCitationsKeywordsCounts(o){if(0<o.length){let e=o.map(e=>e.keywords?e.keywords.map(e=>e.toLowerCase()):[]).flat(1),t=[];for(var a=0;a<e.length;a++){var r=e[a];t.push({keyword:r,count:e.filter(e=>e==r).length}),e=e.filter(e=>e!=r)}return t.sort((e,t)=>e.count<t.count?1:-1)}return[]},getLibItems(t="citekey",o="citekey"){return zoteroRoam.data.items.filter(e=>!["attachment","note","annotation"].includes(e.data.itemType)).map(e=>({key:e.key,value:zoteroRoam.utils.formatItemReference(e,t)||e.key,display:zoteroRoam.utils.formatItemReference(e,o)}))},async waitForBlockUID(e,t){let o=null,a=!1,r=0;try{do{if(o=zoteroRoam.utils.getTopBlockData(e),void 0!==o.text&&o.text==t)return a=!0,o.uid}while(r+=1,await zoteroRoam.utils.sleep(75),r<50&&!a);throw console.log(o),new Error("The top block couldn't be matched")}catch(e){console.error(e)}},async waitForPageUID(e){let t=!1,o=0;do{var a=zoteroRoam.utils.lookForPage(e);if(1==a.present)return t=!0,a.uid}while(o+=1,await zoteroRoam.utils.sleep(75),o<50&&!t);throw new Error(`The page with title "${e}" couldn\'t be found`)}},zoteroRoam.write={async patchItemData(t,e){let o=zoteroRoam.config.requests.find(e=>e.name==t.requestLabel);var a=o.dataURI.match(/(users|groups)\/(.+?)\//g)[0].slice(0,-1);let r=await fetch(`https://api.zotero.org/${a}/items/${t.data.key}`,{method:"PATCH",body:JSON.stringify(e),headers:{"Zotero-API-Version":3,"Zotero-API-Key":o.apikey,"If-Unmodified-Since-Version":t.version}});if(204!=r.status)return{success:!1,response:r};e=r.headers.get("Last-Modified-Version");return{success:!0,version:zoteroRoam.data.items.find(e=>e.key==t.key).version=e}},async editItemTags(e,{add:t=[],remove:o=[]}={}){let a=e.data.tags.map(e=>e.tag);t=a.filter(e=>!o.includes(e)).push(...t).map(e=>({tag:e}));return await zoteroRoam.write.patchItemData(e,{tags:t})},async toggleTags(a,r=[]){let i=a.data.tags.map(e=>e.tag);if(1<r.length){let o=-1;r.forEach((e,t)=>{-1==o&&(o=i.includes(e)?t:-1)});let e={};if(e=-1==o?await zoteroRoam.write.editItemTags(a,{add:[r[0]]}):o==r.length-1?await zoteroRoam.write.editItemTags(a,{add:[r[0]],remove:r.slice(1)}):await zoteroRoam.write.editItemTags(a,{add:[r[o]],remove:r.filter(t!=r[o])}),1==e.success)return r[o]}},async importItems(e,t){e=e.constructor===Array?e:[e];let o=!1,a=await fetch(`https://api.zotero.org/${t.path}/items`,{method:"POST",body:JSON.stringify(e),headers:{"Zotero-API-Version":3,"Zotero-API-Key":t.apikey,"If-Unmodified-Since-Version":t.version}});return 1==a.ok?(o=await a.json(),e=zoteroRoam.data.libraries.findIndex(e=>e.path==t.path),zoteroRoam.data.libraries[e].version=a.headers.get("Last-Modified-Version")):console.log(`The request for ${a.url} returned a code of ${a.status}`),o}},zoteroRoam.interface={icon:null,portal:{div:null,id:"zotero-roam-portal"},contextMenu:{div:null,class:"zotero-roam-context-menu",overlay:{div:null,class:"zotero-roam-context-overlay"},options:{list:[],class:"zotero-roam-context-menu-option",labels:["Import Zotero data to page","Convert to citation","Check for citing papers","View item information"]},visible:!1,targetElement:null,position({top:e,left:t}){zoteroRoam.interface.contextMenu.div.style.left=`${t}px`,zoteroRoam.interface.contextMenu.div.style.top=`${e}px`,zoteroRoam.interface.toggleContextOverlay("contextMenu","show")}},iconContextMenu:{div:null,class:"zotero-roam-icon-context-menu",overlay:{div:null,class:"zotero-roam-icon-context-overlay"},options:{list:[],class:"zotero-roam-icon-context-menu-option",labels:["Update Zotero data","Search in dataset..."]},visible:!1,position({top:e,left:t}){zoteroRoam.interface.iconContextMenu.div.style.left=t>=.9*window.innerWidth?`calc(${t}px - 10%)`:`${t}px`,zoteroRoam.interface.iconContextMenu.div.style.top=`calc(${e}px + 3%)`,zoteroRoam.interface.toggleContextOverlay("iconContextMenu","show")}},citations:{overlay:null,input:null,closeButton:null,overlayClass:"zotero-roam-citations-search"},search:{overlay:null,input:null,selectedItemDiv:null,closeButton:null,updateButton:null,overlayClass:"zotero-roam-search"},tributeTrigger:"",tributeBlockTrigger:null,tributeNewText:"",activeImport:null,create(){zoteroRoam.interface.createIcon(id="zotero-roam-icon"),zoteroRoam.interface.portal.div=zoteroRoam.interface.createPortal(id=zoteroRoam.interface.portal.id),zoteroRoam.interface.createContextMenu(elementKey="contextMenu"),zoteroRoam.interface.createContextMenu(elementKey="iconContextMenu"),zoteroRoam.interface.createOverlay(divClass=zoteroRoam.interface.search.overlayClass),zoteroRoam.interface.fillSearchOverlay(),zoteroRoam.interface.createOverlay(divClass=zoteroRoam.interface.citations.overlayClass),zoteroRoam.interface.fillCitationsOverlay(),zoteroRoam.interface.createToastOverlay()},setup(){zoteroRoam.interface.icon.addEventListener("click",zoteroRoam.extension.toggle),zoteroRoam.interface.setupContextMenus(["contextMenu","iconContextMenu"]),zoteroRoam.interface.search.updateButton.addEventListener("click",function(){zoteroRoam.extension.update(popup=!0)}),zoteroRoam.interface.search.closeButton.addEventListener("click",function(){zoteroRoam.interface.toggleSearchOverlay("hide")})},createIcon(e){try{document.getElementById(e).closest(".bp3-popover-wrapper").remove()}catch(e){}var t=document.createElement("span");t.classList.add("bp3-popover-wrapper"),t.setAttribute("style","margin-left: 4px;"),t.innerHTML=`<span class="bp3-popover-target"><span id="${e}" status="off" class="bp3-button bp3-icon-manual bp3-minimal bp3-small"></span>`,document.querySelector(".rm-topbar").appendChild(t),zoteroRoam.interface.icon=document.getElementById(e)},createPortal(e){try{document.getElementById(e).remove()}catch(e){}var t=document.createElement("div");return t.classList.add("bp3-portal"),t.id=e,document.getElementById("app").appendChild(t),t},createContextMenu(e){let t=zoteroRoam.interface[`${e}`];try{document.querySelector(`.${t.overlay.class}`).remove()}catch(e){}var o=t.options.labels.map(e=>`<li class="${t.options.class}"><a class="bp3-menu-item bp3-popover-dismiss"><div class="bp3-fill bp3-text-overflow-ellipsis">${e}</div></a></li>`).join(""),a=document.createElement("div");a.classList.add("bp3-overlay"),a.classList.add("bp3-overlay-open"),a.classList.add(`${t.overlay.class}`),a.style="display:none;",a.innerHTML=`<div class="bp3-overlay-backdrop bp3-popover-backdrop bp3-popover-appear-done bp3-popover-enter-done" style="z-index:25;"></div>
                                    ...
                                    </div>`,zoteroRoam.interface.portal.div.appendChild(a),zoteroRoam.interface[`${e}`].overlay.div=document.querySelector(`.${zoteroRoam.interface[`${e}`].overlay.class}`),zoteroRoam.interface[`${e}`].div=document.querySelector(`.${zoteroRoam.interface[`${e}`].class}`),zoteroRoam.interface[`${e}`].options.list=document.querySelectorAll(`.${zoteroRoam.interface[`${e}`].options.class}`)},createToastOverlay(){let e=document.createElement("div");e.classList.add("bp3-overlay"),e.classList.add("bp3-overlay-open"),e.classList.add("bp3-toast-container"),e.classList.add("bp3-toast-container-top"),e.classList.add("bp3-toast-container-in-portal"),e.classList.add("zotero-roam-toast-overlay"),zoteroRoam.interface.portal.div.appendChild(e)},async popToast(e,t="primary"){let o=zoteroRoam.interface.portal.div.querySelector(".zotero-roam-toast-overlay");o.innerHTML=zoteroRoam.utils.renderBP3Toast(string=e,{toastClass:`bp3-intent-${t}`}),o.querySelector(".bp3-toast").style.opacity="1",await zoteroRoam.utils.sleep(700),o.querySelector(".bp3-toast").style.top="-100px"},createOverlay(t,e="align-self:baseline;transition:0.5s;",o=!0){try{document.querySelector(`.${t}-overlay`).remove()}catch(e){}let a=document.createElement("div");if(a.classList.add("bp3-overlay"),a.classList.add("bp3-overlay-open"),a.classList.add("bp3-overlay-scroll-container"),a.classList.add(`${t}-overlay`),a.classList.add("zotero-roam-dialog-overlay"),a.setAttribute("overlay-visible","false"),a.style="display:none;",o){let e=document.createElement("div");e.classList.add("bp3-overlay-backdrop"),e.classList.add("bp3-overlay-appear-done"),e.classList.add("bp3-overlay-enter-done"),e.classList.add(`${t}-backdrop`),e.tabIndex="0",a.appendChild(e)}let r=document.createElement("div");r.classList.add("bp3-dialog-container"),r.classList.add("bp3-overlay-content"),r.classList.add("bp3-overlay-appear-done"),r.classList.add("bp3-overlay-enter-done"),r.tabIndex="0";let i=document.createElement("div");i.classList.add("bp3-dialog"),i.setAttribute("side-panel","hidden"),i.style=e;let n=document.createElement("div");n.classList.add("bp3-dialog-body");let s=document.createElement("div");s.classList.add("main-panel"),s.style="flex: 1 1 100%;";let l=document.createElement("div");l.classList.add("side-panel"),l.style="flex: 1 0 0%;";let c=document.createElement("div");c.classList.add("side-panel-contents"),l.appendChild(c),n.appendChild(s),n.appendChild(l),i.appendChild(n),r.appendChild(i),a.appendChild(r),zoteroRoam.interface.portal.div.appendChild(a)},fillSearchOverlay(e=zoteroRoam.interface.search.overlayClass){let t=document.querySelector(`.${e}-overlay .bp3-dialog-body .main-panel`),o=document.createElement("div");o.classList.add("bp3-input-group"),o.classList.add("header-content");let a=document.createElement("div");a.classList.add("header-left");let r=document.createElement("h5");r.innerText="Zotero Library";let i=document.createElement("p");i.classList.add("bp3-text-muted"),i.classList.add("bp3-text-small"),i.classList.add("panel-subtitle"),i.innerText="Search by title, year, authors (last names), citekey, tags";let n=document.createElement("input");n.id="zotero-roam-search-autocomplete",n.tabIndex="1",n.type="text",n.classList.add("bp3-input"),a.appendChild(r),a.appendChild(i),a.appendChild(n);let s=document.createElement("div");s.classList.add("header-right");let l=document.createElement("div");l.classList.add("controls-top"),l.innerHTML=`
            ...
            `;let c=document.createElement("label");c.classList.add("bp3-control"),c.classList.add("bp3-switch"),c.classList.add("bp3-text-small"),c.classList.add("quick-copy-element");let d=document.createElement("input");d.id="zotero-roam-quick-copy-mode",d.setAttribute("type","checkbox"),c.appendChild(d);let m=document.createElement("span");m.classList.add("bp3-control-indicator"),c.appendChild(m),c.innerHTML+="Quick Copy",s.appendChild(l),s.appendChild(c),o.appendChild(a),o.appendChild(s),t.appendChild(o);let p=document.createElement("div");p.id="zotero-roam-library-rendered",p.setAttribute("view","search");let u=document.createElement("div");u.id="zotero-roam-library-search-div";let g=document.createElement("div");g.classList.add("bp3-button-group"),g.classList.add("bp3-minimal"),g.innerHTML=`
            <span class="zotero-roam-library-results-count"></span>
            `,u.appendChild(g);let h=document.createElement("div");h.id="zotero-roam-search-selected-item",h.classList.add("bp3-card");let y=document.createElement("div");y.classList.add("selected-item-header");let f=document.createElement("div");f.classList.add("selected-item-body"),h.appendChild(y),h.appendChild(f),p.appendChild(u),p.appendChild(h),t.appendChild(p);let b=document.createElement("div");b.classList.add("bp3-dialog-footer-actions"),b.innerHTML=`
            ...
            `,d.appendChild(m),t.appendChild(a),t.appendChild(d);let p=document.createElement("div");p.style="display:flex;justify-content:space-between;margin-bottom:15px;align-items:center;",p.innerHTML=`
            <h4>Add to Zotero</h4>
            ...
            `;let u=document.createElement("div");u.classList.add("import-options"),u.style="display:flex;justify-content:space-between;flex-wrap:wrap;";let g=document.createElement("div");g.classList.add("options-library"),g.style="flex:1 0 50%;",g.innerHTML='<label class="bp3-label bp3-text-muted">Library</label><div class="options-library-list"></div>';let h=document.createElement("div");h.classList.add("options-collections"),h.style="flex:1 0 50%;",h.innerHTML='<label class="bp3-label bp3-text-muted">Collections</label><div class="options-collections-list"></div>';let y=document.createElement("div");y.classList.add("options-tags"),y.style="padding:20px 0px;flex: 1 0 100%;flex-wrap:wrap;display:flex;";let f=document.createElement("label");f.classList.add("bp3-label"),f.innerText="Roam Tags",f.style="flex: 1 0 100%;";let b=document.createElement("div");b.classList.add("options-tags-select"),b.classList.add("bp3-input-group"),b.classList.add("bp3-small"),b.style="flex: 1 0 50%;";let z=document.createElement("span");z.classList.add("bp3-icon"),z.classList.add("bp3-icon-tag"),z.classList.add("bp3-intent-primary");let v=document.createElement("input");v.id="zotero-roam-tags-autocomplete",v.tabIndex="1",v.type="text",v.classList.add("bp3-input"),v.classList.add("bp3-fill");let R=document.createElement("div");R.classList.add("options-tags_selection"),R.style="flex: 1 0 50%;padding:0px 8px;",R.setAttribute("data-tags","[]"),b.appendChild(z),b.appendChild(v),y.appendChild(f),y.appendChild(b),y.appendChild(R),u.appendChild(g),u.appendChild(h),u.appendChild(y);let k=document.createElement("h5");k.innerText="Selected Items";let w=document.createElement("div");w.classList.add("import-items"),w.classList.add("bp3-list-unstyled"),w.style="margin:20px 0;",o.appendChild(p),o.appendChild(u),o.appendChild(k),o.appendChild(w);let $=document.createElement("div");$.classList.add("bp3-dialog-footer-actions"),$.innerHTML=`
            <input class="bp3-input clipboard-copy-utility" type="text" readonly style="opacity:0;">
            `,t.appendChild($),zoteroRoam.interface.citations.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.citations.input=document.querySelector("#zotero-roam-citations-autocomplete"),zoteroRoam.interface.citations.closeButton=document.querySelector(`.${e}-overlay button.zotero-roam-search-close`),Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll(".zotero-roam-page-control")).forEach(t=>{t.addEventListener("click",e=>{zoteroRoam.interface.changePage(goto=t.getAttribute("goto"))})}),zoteroRoam.interface.citations.closeButton.addEventListener("click",zoteroRoam.interface.closeCitationsOverlay),zoteroRoam.interface.citations.overlay.querySelector(".import-button").addEventListener("click",zoteroRoam.handlers.importSelectedItems),zoteroRoam.interface.citations.overlay.querySelector(".import-cancel-button").addEventListener("click",zoteroRoam.interface.clearImportPanel),zoteroRoam.interface.citations.overlay.querySelector(".options-tags_selection").addEventListener("click",e=>{let o=e.target.closest(".bp3-tag-remove");if(null!==o){let t=o.closest(".bp3-tag");try{let e=zoteroRoam.interface.citations.overlay.querySelector(".options-tags_selection");e.dataset.tags=JSON.stringify(JSON.parse(e.dataset.tags).filter(e=>e!=t.dataset.tag)),t.remove()}catch(e){console.error(e)}}}),zoteroRoam.interface.citations.overlay.querySelector(".import-items").addEventListener("click",e=>{let o=e.target.closest("button.selected_remove-button");if(null!==o){let t=o.closest(".import-items_selected");try{zoteroRoam.interface.activeImport.items=zoteroRoam.interface.activeImport.items.filter(e=>e!=t.dataset.identifier),t.remove(),0==zoteroRoam.interface.activeImport.items.length&&zoteroRoam.interface.citations.overlay.querySelector(".import-button").setAttribute("disabled","")}catch(e){console.error(e)}}})},renderCitationsPagination(){let e=document.querySelector("#zotero-roam-citations-pagination"),t=e.querySelector("ul");null==t&&(t=document.createElement("ul"),t.classList.add("zotero-roam-citations-search-results-list"),t.classList.add("bp3-menu"),t.tabIndex="-1",t.setAttribute("role","listbox"),e.appendChild(t));let o=zoteroRoam.citations.pagination.getCurrentPageData();e.querySelector(".zotero-roam-citations-results-count").innerHTML=`
            ...
            `,t.innerHTML=o.map(t=>{var o,e=`<span class="zotero-roam-search-item-title" style="display:block;">${t.title} ${t.inLibrary?'<span icon="endorsed" class="bp3-icon bp3-icon-endorsed bp3-intent-success"></span>':""}</span>`,a=t.authors+(t.year?" ("+t.year+")":""),r=`<span class="zotero-roam-citation-metadata-contents">${zoteroRoam.utils.renderBP3Tag(a,{modifier:"bp3-intent-warning zotero-roam-citation-origin"})} ${t.meta}</span>`;let i="";for(o of Object.keys(t.links)){let e=[];switch(o){case"scite":e.push(`<span class="zotero-roam-citation-link" service="scite"><a href="${t.links[o]}" target="_blank">Scite</a></span>`);break;case"connectedPapers":e.push(`<span class="zotero-roam-citation-link" service="connected-papers"><a href="${t.links[o]}" target="_blank">Connected Papers</a></span>`);break;case"semanticScholar":e.push(`<span class="zotero-roam-citation-link" service="semantic-scholar"><a href="${t.links[o]}" target="_blank">Semantic Scholar</a></span>`);break;case"googleScholar":e.push(`<span class="zotero-roam-citation-link" service="google-scholar"><a href="${t.links[o]}" target="_blank">Google Scholar</a></span>`)}i+=e.join(" &#8226; ")}a=`
                <span class="bp3-menu-item-label zotero-roam-search-item-key">
                <a href="https://doi.org/${t.doi}" target="_blank" class="bp3-text-muted zotero-roam-citation-doi-link">${t.doi}</a>
                ...
                ${zoteroRoam.utils.renderBP3Button_group("Copy DOI",{buttonClass:"zotero-roam-citation-copy-doi bp3-small bp3-outlined",buttonAttribute:'data-doi="'+t.doi+'"'})}
                ...
                `}).join("");try{var a=Array.from(e.querySelectorAll("button.zotero-roam-citation-copy-doi"));if(0<a.length)for(const n of a)n.addEventListener("click",function(){zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value=n.dataset.doi,zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").select(),document.execCommand("copy")})}catch(e){}try{var r=Array.from(e.querySelectorAll("button.zotero-roam-citation-toggle-abstract"));if(0<r.length)for(const s of r)s.addEventListener("click",function(){let e=s.querySelector(".bp3-button-text"),t=s.closest(".zotero-roam-citations-search_result").querySelector(".zotero-roam-citation-abstract");"none"==t.style.display?(t.style.display="block",e.innerHTML="Hide Abstract"):(t.style.display="none",e.innerHTML="Show Abstract")})}catch(e){}try{var i=Array.from(e.querySelectorAll("button.zotero-roam-citation-add-import"));if(0<i.length)for(const l of i)l.addEventListener("click",function(){zoteroRoam.interface.addToImport(element=l.closest(".bp3-menu-item"))})}catch(e){}},setupContextMenus(t){window.addEventListener("click",e=>{t.forEach(e=>{zoteroRoam.interface[`${e}`].visible&&zoteroRoam.interface.toggleContextOverlay(e,command="hide")})}),t.forEach(o=>{zoteroRoam.interface[`${o}`].options.list.forEach((e,t)=>{switch(zoteroRoam.interface[`${o}`].options.labels[t]){case"Import Zotero data to page":e.addEventListener("click",()=>{zoteroRoam.handlers.addItemData(zoteroRoam.interface.contextMenu.targetElement)});break;case"Convert to citation":e.addEventListener("click",()=>{zoteroRoam.inPage.convertToCitekey(zoteroRoam.interface.contextMenu.targetElement)});break;case"Check for citing papers":e.addEventListener("click",()=>{zoteroRoam.handlers.checkForScitations(zoteroRoam.interface.contextMenu.targetElement)});break;case"View item information":e.addEventListener("click",()=>{zoteroRoam.interface.popItemInformation(zoteroRoam.interface.contextMenu.targetElement)});break;case"Update Zotero data":e.addEventListener("click",zoteroRoam.extension.update);break;case"Search in dataset...":e.addEventListener("click",()=>{zoteroRoam.interface.toggleSearchOverlay("show")})}})})},toggleContextOverlay(e,t){zoteroRoam.interface[`${e}`].overlay.div.style.display="show"==t?"block":"none",zoteroRoam.interface[`${e}`].visible="show"==t},async toggleSearchOverlay(e,{focus:t=!0}={}){zoteroRoam.interface.search.overlay.style.display="show"===e?"block":"none","show"==e?(console.log("Opening the Search Panel"),1==t&&(await zoteroRoam.utils.sleep(75),zoteroRoam.interface.search.input.focus()),document.querySelector(".zotero-roam-library-results-count").innerHTML="",zoteroRoam.interface.search.input.value="",zoteroRoam.interface.search.overlay.setAttribute("overlay-visible","true")):(console.log("Closing the Search Panel"),zoteroRoam.interface.clearSelectedItem(),document.querySelector(".zotero-roam-library-results-count").innerHTML="",zoteroRoam.interface.search.input.value="",zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value="",zoteroRoam.interface.search.overlay.setAttribute("overlay-visible","false"))},changePage(e){if(null!==zoteroRoam.citations.pagination&&0<zoteroRoam.citations.pagination.nbPages)switch(e){case"previous":zoteroRoam.citations.pagination.previousPage();break;case"next":zoteroRoam.citations.pagination.nextPage()}},popCitationsOverlay(t){zoteroRoam.citations.currentDOI=t;var e=zoteroRoam.data.scite.find(e=>e.doi==t).simplified;zoteroRoam.citations.pagination=new zoteroRoam.Pagination({data:e}),zoteroRoam.interface.renderCitationsPagination(),null==zoteroRoam.citations.autocomplete?zoteroRoam.citations.autocomplete=new autoComplete(zoteroRoam.config.citationsSearch):zoteroRoam.citations.autocomplete.init(),zoteroRoam.interface.citations.overlay.style.display="block",zoteroRoam.interface.citations.input.value="",zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value="",zoteroRoam.interface.citations.overlay.setAttribute("overlay-visible","true"),zoteroRoam.interface.citations.input.focus()},closeCitationsOverlay(){zoteroRoam.interface.citations.overlay.style.display="none",zoteroRoam.interface.citations.input.value="",zoteroRoam.interface.citations.overlay.querySelector("input.clipboard-copy-utility").value="",zoteroRoam.interface.clearImportPanel(),zoteroRoam.interface.citations.overlay.setAttribute("overlay-visible","false")},popContextOverlay(e,t){e.preventDefault();var o={left:e.pageX,top:e.pageY};return zoteroRoam.interface[`${t}`].position(o),"contextMenu"==t&&(zoteroRoam.interface.contextMenu.targetElement=e.target),!1},async popContextMenu(e){zoteroRoam.interface.popContextOverlay(e,"contextMenu"),await zoteroRoam.utils.sleep(200);try{document.querySelector("body > .bp3-context-menu+.bp3-portal").style.display="none"}catch(e){}},popIconContextMenu(e){zoteroRoam.interface.popContextOverlay(e,"iconContextMenu")},popItemInformation(e){e=e.parentElement.dataset.linkTitle.replace("@","");zoteroRoam.interface.renderItemInPanel(e)},renderItemInPanel(e){let a=e.startsWith("@")?e:"@"+e,r=zoteroRoam.data.items.find(e=>e.key==a.slice(1));var n=r.meta.parsedDate?` (${new Date(r.meta.parsedDate).getUTCFullYear().toString()})`:"",t=r.data.creators.map(e=>e.name||[e.firstName,e.lastName].filter(Boolean).join(" ")),o=r.data.creators.map(e=>e.creatorType);let s="";if(0<t.length)for(i=0;i<t.length;i++){var l=zoteroRoam.utils.lookForPage(title=t[i]),c=1==l.present?zoteroRoam.utils.renderPageReference(title=t[i],uid=l.uid):zoteroRoam.utils.renderBP3Tag(string=t[i],{modifier:"bp3-intent-primary item-creator-tag"}),l=o[i]&&"author"!=o[i]?` (${o[i]})`:"";s=s+c+l,i<t.length-2?s+=", ":i==t.length-2&&(s+=" & ")}var d=r.data.tags.map(e=>e.tag);let m="";if(0<d.length)for(m="<strong>Tags : </strong>",i=0;i<d.length;i++){var p=1==zoteroRoam.utils.lookForPage(title=d[i]).present?zoteroRoam.utils.renderPageTag(title=d[i]):zoteroRoam.utils.renderBP3Tag(string=d[i]);m=m+p+" "}let u=zoteroRoam.formatting.getItemCollections(r),g="";if(u){g="<strong>Collections : </strong>";try{g+=u.map(e=>zoteroRoam.utils.renderBP3Tag(string=e.data.name,{modifier:"bp3-intent-success bp3-round",icon:"projects"})).join(" ")}catch(e){console.log(u),console.log(e),console.error("Something went wrong while getting the item's collections data")}}var h=zoteroRoam.utils.lookForPage(a),y=1==h.present?"tick":"cross",e=1==h.present?"success":"danger";let f=1==h.present?"In the graph":"Not in the graph";if(1==h.present)try{var b=window.roamAlphaAPI.q("[:find (count ?chld) :in $ ?uid :where[?p :block/uid ?uid][?p :block/children ?chld]]",h.uid)[0][0];f+=` (<b>${b}</b> direct children)`}catch(e){}y=`
            ...
            <div class="item-basic-metadata">
                <h4 class="item-title" tabindex="0">${r.data.title||""}${n}</h4>
                <p class="item-metadata-string">${s}${zoteroRoam.utils.makeMetaString(r)}</p>
                </div>
            <div class="item-citekey-section">
                <div class="bp3-fill citekey-element">${a}</div>
            ...
            `;let v=document.querySelector(".selected-item-body"),R="";r.data.DOI&&r.data.DOI.startsWith("10.")?(k=`https://doi.org/${r.data.DOI}`,R=zoteroRoam.utils.renderBP3Button_link(string="Open in browser",{linkClass:"bp3-minimal bp3-fill bp3-align-left item-open-in-browser",icon:"share",iconModifier:"bp3-intent-primary",target:k,linkAttribute:'target="_blank"'})):r.data.url&&(R=zoteroRoam.utils.renderBP3Button_link(string="Open in browser",{linkClass:"bp3-minimal bp3-fill bp3-align-left item-open-in-browser",icon:"share",iconModifier:"bp3-intent-primary",target:r.data.url,linkAttribute:'target="_blank"'}));var e=1==h.present?`data-uid="${h.uid}"`:"disabled",y=zoteroRoam.shortcuts.sequences.goToItemPage?zoteroRoam.shortcuts.makeSequenceText("goToItemPage",pre=" "):"",k=1==h.present?`https://roamresearch.com/${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${h.uid}`:"javascript:void(0)",k=`
            <div class="bp3-button-group bp3-minimal bp3-fill bp3-align-left">
            ${zoteroRoam.utils.renderBP3Button_link(string="Go to Roam page"+y,{linkClass:"item-go-to-page",icon:"arrow-right",iconModifier:"bp3-intent-primary",target:k,linkAttribute:e})}
            </div>
            `,e=`Import metadata  ${zoteroRoam.shortcuts.sequences.importMetadata?zoteroRoam.shortcuts.makeSequenceText("importMetadata",pre=" "):""}`,e=zoteroRoam.utils.renderBP3ButtonGroup(string=e,{buttonClass:"item-add-metadata",divClass:"bp3-minimal bp3-fill bp3-align-left",icon:"add",modifier:"bp3-intent-primary"});let w=zoteroRoam.formatting.getItemChildren(r,{pdf_as:"raw",notes_as:"raw"}),$="";if(w.remoteChildren)$+="<p>This item has children, but they were not returned by the API data request. This might be due to a request for 'items/top' rather than 'items'.</p>";else try{var x=w.pdfItems?w.pdfItems.map(e=>{var t="group"==e.library.type?`groups/${e.library.id}`:"library",t=["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`zotero://open-pdf/${t}/items/${e.data.key}`:e.data.url,e=e.data.filename||e.data.title;return zoteroRoam.utils.renderBP3Button_link(string=e,{linkClass:"bp3-minimal item-pdf-link",icon:"paperclip",target:t,linkAttribute:'target="_blank"'})}).join(""):"No PDF attachments";$+=x,w.notes&&(x=zoteroRoam.shortcuts.sequences.toggleNotes?zoteroRoam.shortcuts.makeSequenceText("toggleNotes",pre=" "):"",$+=`${zoteroRoam.utils.renderBP3Button_group(string="Show Notes"+x,{buttonClass:"bp3-minimal bp3-align-left bp3-fill item-see-notes",icon:"comment"})}`,zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML=`
                        <h4>Notes</h4>
            ...
            <div class="item-additional-metadata">
                <p class="item-abstract bp3-running-text bp3-text-small bp3-blockquote">${r.data.abstractNote}</p>
            ...
            `;var S=h.uid||"";document.querySelector("button.item-add-metadata").addEventListener("click",function(){console.log("Importing metadata..."),zoteroRoam.handlers.addSearchResult(a,S,{popup:!0})}),Array.from(document.querySelectorAll(".item-citekey-section .copy-buttons a.bp3-button[format]")).forEach(o=>{o.addEventListener("click",e=>{switch(o.getAttribute("format")){case"citekey":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`${a}`;break;case"citation":var t=`${r.meta.creatorSummary||""}${n||""}`;zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`[${t}]([[${a}]])`;break;case"tag":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`#[[${a}]]`;break;case"page-reference":zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").value=`[[${a}]]`}zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility").select(),document.execCommand("copy")})});try{let t=document.querySelector("button.item-see-notes");t.addEventListener("click",function(){let e=t.querySelector(".bp3-button-text").innerHTML;switch(!0){case e.startsWith("Show"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Show","Hide");break;case e.startsWith("Hide"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Hide","Show")}})}catch(e){}switch(document.querySelector("#zotero-roam-library-rendered").setAttribute("view","item"),zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")){case"true":document.querySelector("h4.item-title").focus();break;case"false":zoteroRoam.interface.toggleSearchOverlay("show",{focus:!1})}},clearSelectedItem(){try{zoteroRoam.interface.search.selectedItemDiv.children.forEach(e=>{e.innerHTML=""})}catch(e){Array.from(zoteroRoam.interface.search.selectedItemDiv.children).forEach(e=>{e.innerHTML=""})}zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML="","visible"==zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").getAttribute("side-panel")&&zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),document.querySelector("#zotero-roam-library-rendered").setAttribute("view","search")},checkEditingMode(){let e=document.querySelector("textarea.rm-block-input");e&&null==e.getAttribute("zotero-tribute")&&(document.querySelectorAll(".zotero-roam-tribute").forEach(e=>e.remove()),e.setAttribute("zotero-tribute","active"),new Tribute(zoteroRoam.config.tribute).attach(e),e.addEventListener("tribute-replaced",e=>{let t=document.querySelector("textarea.rm-block-input");var o=e.detail.context.mentionTriggerChar+e.detail.context.mentionText,a=e.detail.context.mentionPosition,r=e.detail.item.original.value;let i=e.target.defaultValue;e=zoteroRoam.utils.escapeRegExp(o),e=new RegExp(e,"g"),e=i.replaceAll(e,(e,t)=>t==a?r:e);zoteroRoam.interface.tributeTrigger=o,zoteroRoam.interface.tributeBlockTrigger=t,zoteroRoam.interface.tributeNewText=e,Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value").set.call(t,e);e=new Event("input",{bubbles:!0});t.dispatchEvent(e)}))},addToImport(e){var t=e.querySelector(".zotero-roam-citation-doi-link").innerText,o=e.querySelector(".zotero-roam-search-item-title").innerText,a=e.querySelector(".zotero-roam-citation-origin").innerText;null==zoteroRoam.interface.activeImport?(zoteroRoam.interface.activeImport={libraries:zoteroRoam.utils.getLibraries(),items:[],currentLib:{}},zoteroRoam.interface.renderImportOptions(),zoteroRoam.interface.addToImport(e),zoteroRoam.interface.citations.overlay.querySelector(".import-button").removeAttribute("disabled"),zoteroRoam.interface.citations.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible")):zoteroRoam.interface.activeImport.items.includes(t)||(zoteroRoam.interface.activeImport.items.push(t),zoteroRoam.interface.citations.overlay.querySelector(".import-items").innerHTML+=`
                    <li class="import-items_selected bp3-blockquote" style="display:flex;justify-content:space-between;padding:5px 0 5px 15px;background:#f9fafb;" data-identifier="${t}">
                    <div class="selected_info">
                    <span class="selected_title bp3-text-muted" style="font-weight:500;">${o}</span>
                    <span class="selected_origin" style="display:block;font-weight:300;">${a}</span>
                    </div>
                    ...
                    `)},renderImportOptions(){let e=zoteroRoam.interface.activeImport.libraries;var t=zoteroRoam.utils.renderBP3_list(e,"radio",{varName:"library",has_value:"path",has_string:"name",selectFirst:!0,active_if:"writeable"});let o="";1==e[0].writeable&&(zoteroRoam.interface.activeImport.currentLib=e[0],o=zoteroRoam.utils.renderBP3_list(e[0].collections.map(e=>({name:e.data.name,key:e.key})),"checkbox",{varName:"collections",has_value:"key",has_string:"name"})),zoteroRoam.interface.citations.overlay.querySelector(".options-library-list").innerHTML=t,zoteroRoam.interface.citations.overlay.querySelector(".options-collections-list").innerHTML=o,Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll('input[name="library"]')).forEach(e=>e.addEventListener("click",zoteroRoam.interface.selectImportLibrary))},selectImportLibrary(){var t,e;null!==zoteroRoam.interface.activeImport&&(e=zoteroRoam.interface.activeImport.currentLib.path,(t=Array.from(zoteroRoam.interface.citations.overlay.querySelectorAll('.options-library [name="library"]')).find(e=>1==e.checked).value)!=e&&(zoteroRoam.interface.activeImport.currentLib=zoteroRoam.interface.activeImport.libraries.find(e=>e.path==t),e=zoteroRoam.utils.renderBP3_list(zoteroRoam.interface.activeImport.currentLib.collections.map(e=>({name:e.data.name,key:e.key})),"checkbox",{varName:"collections",has_value:"key",has_string:"name"}),zoteroRoam.interface.citations.overlay.querySelector(".options-collections-list").innerHTML=e))},clearImportPanel(){zoteroRoam.interface.citations.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),zoteroRoam.interface.activeImport=null,zoteroRoam.interface.citations.overlay.querySelector(".import-button").setAttribute("disabled",""),zoteroRoam.interface.citations.overlay.querySelector(".options-library-list").innerHTML="",zoteroRoam.interface.citations.overlay.querySelector(".options-collections-list").innerHTML="",zoteroRoam.interface.citations.overlay.querySelector("#zotero-roam-import-tags-list").value="",zoteroRoam.interface.citations.overlay.querySelector(".options-tags_selection").innerHTML="",zoteroRoam.interface.citations.overlay.querySelector(".options-tags_selection").dataset.tags="[]",zoteroRoam.interface.citations.overlay.querySelector(".import-items").innerHTML=""}},zoteroRoam.extension={async load(){zoteroRoam.interface.icon.style="background-color: #fd9d0d63!important;";var e=await zoteroRoam.handlers.requestData(zoteroRoam.config.requests);if(!e.success)throw zoteroRoam.interface.icon.style="background-color:#f9a3a3 !important",zoteroRoam.interface.popToast(message="There was a problem with the Zotero data request. Please check your specification !",intent="danger"),new Error("The API request encountered a problem. Please check your request specification, and the console for any registered errors.");try{let t=[];Array.from(new Set(zoteroRoam.config.requests.map(e=>e.apikey))).forEach(e=>{t.push(fetch(`https://api.zotero.org/keys/${e}`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":e}}))});let e=await Promise.all(t);e=await Promise.all(e.map(e=>e.json())),e=e.flat(1),zoteroRoam.data.keys=e}catch(e){console.error(e)}zoteroRoam.data.items=e.data.items,zoteroRoam.data.collections=e.data.collections,zoteroRoam.interface.icon.setAttribute("status","on"),zoteroRoam.inPage.checkReferences(),document.addEventListener("blur",zoteroRoam.inPage.checkReferences,!0),window.addEventListener("locationchange",zoteroRoam.inPage.checkReferences,!0),zoteroRoam.config.ref_checking=setInterval(zoteroRoam.inPage.checkReferences,1e3),zoteroRoam.inPage.addPageMenus(),window.addEventListener("locationchange",zoteroRoam.inPage.addPageMenus,!0),zoteroRoam.config.page_checking=setInterval(zoteroRoam.inPage.addPageMenus,1e3),zoteroRoam.config.userSettings.autoupdate&&(zoteroRoam.config.auto_update=setInterval(function(){zoteroRoam.extension.update(popup=!1)},6e4)),null==zoteroRoam.librarySearch.autocomplete?zoteroRoam.librarySearch.autocomplete=new autoComplete(zoteroRoam.config.autoComplete):zoteroRoam.librarySearch.autocomplete.init(),1==zoteroRoam.config.params.autocomplete.enabled&&(zoteroRoam.config.editingObserver=new MutationObserver(zoteroRoam.interface.checkEditingMode),zoteroRoam.config.editingObserver.observe(document,{childList:!0,subtree:!0})),null==zoteroRoam.tagSelection.autocomplete?zoteroRoam.tagSelection.autocomplete=new autoComplete(zoteroRoam.config.tagSelection):zoteroRoam.tagSelection.autocomplete.init(),zoteroRoam.interface.icon.addEventListener("contextmenu",zoteroRoam.interface.popIconContextMenu),window.addEventListener("keyup",zoteroRoam.shortcuts.verify),window.addEventListener("keydown",zoteroRoam.shortcuts.verify),roamAlphaAPI.ui.commandPalette.addCommand({label:"zoteroRoam : Open the search panel",callback:()=>{zoteroRoam.interface.toggleSearchOverlay("show")}}),zoteroRoam.interface.icon.style="background-color: #60f06042!important;",zoteroRoam.interface.popToast(message="Zotero data successfully loaded !",intent="success"),console.log("The results of the API request have been received ; you can check them by inspecting the value of the zoteroRoam.data object. Data import context menu should now be available.")},unload(){zoteroRoam.interface.icon.setAttribute("status","off"),zoteroRoam.data.items=[],zoteroRoam.data.collections=[],zoteroRoam.data.scite=[],zoteroRoam.data.keys=[],null!==zoteroRoam.librarySearch.autocomplete&&zoteroRoam.librarySearch.autocomplete.unInit(),null!==zoteroRoam.citations.autocomplete&&zoteroRoam.citations.autocomplete.unInit(),null!==zoteroRoam.tagSelection.autocomplete&&zoteroRoam.tagSelection.autocomplete.unInit(),Array.from(document.querySelectorAll(".zotero-roam-page-div")).forEach(e=>e.remove());let e=document.querySelectorAll("ref-citekey");e.forEach(e=>{e.removeAttribute("data-zotero-bib"),e.querySelector(".rm-page-ref").removeEventListener("contextmenu",zoteroRoam.interface.popContextMenu)}),zoteroRoam.interface.icon.removeEventListener("contextmenu",zoteroRoam.interface.popIconContextMenu),document.removeEventListener("blur",zoteroRoam.inPage.checkReferences,!0),window.removeEventListener("locationchange",zoteroRoam.inPage.checkReferences,!0);try{clearInterval(zoteroRoam.config.ref_checking)}catch(e){}try{clearInterval(zoteroRoam.config.page_checking)}catch(e){}try{clearInterval(zoteroRoam.config.auto_update)}catch(e){}try{zoteroRoam.config.editingObserver.disconnect()}catch(e){}window.removeEventListener("keyup",zoteroRoam.shortcuts.verify),window.removeEventListener("keydown",zoteroRoam.shortcuts.verify),roamAlphaAPI.ui.commandPalette.removeCommand({label:"zoteroRoam : Open the search panel"}),zoteroRoam.interface.icon.removeAttribute("style"),zoteroRoam.interface.popToast(message="All Zotero data was cleared. Bye for now !",intent="success"),console.log("Data and request outputs have been removed")},toggle(){"off"==zoteroRoam.interface.icon.getAttribute("status")?zoteroRoam.extension.load():zoteroRoam.extension.unload()},async update(t="true"){zoteroRoam.interface.icon.style="background-color: #fd9d0d63!important;";var o=zoteroRoam.config.requests.map(t=>{var e=zoteroRoam.data.libraries.find(e=>e.path==t.library).version,{apikey:o,dataURI:a,params:r,name:i,library:n}=t;let s=new URLSearchParams(r);return s.set("since",e),{apikey:o,dataURI:a,params:s.toString(),name:i,library:n}}),o=await zoteroRoam.handlers.requestData(o);if(1==o.success){zoteroRoam.data.collections=o.data.collections;let e=o.data.items;if(0==e.length)t&&zoteroRoam.interface.popToast("No new items were found since the data was last loaded. Data on collections was refreshed.","primary"),zoteroRoam.interface.icon.style="background-color: #60f06042!important;";else{let o=zoteroRoam.handlers.extractCitekeys(e).length,a=0;e.forEach(t=>{var e=zoteroRoam.data.items.findIndex(e=>e.key==t.key&e.requestLabel==t.requestLabel);-1==e?zoteroRoam.data.items.push(t):(zoteroRoam.data.items[e]=t,a+=1,--o)}),zoteroRoam.inPage.checkCitekeys(update=!0),t?zoteroRoam.interface.popToast(`${o} new items and ${a} modified items were added.`,"primary"):console.log(`${o} new items and ${a} modified items were added.`),zoteroRoam.interface.icon.style="background-color: #60f06042!important;"}}else t?zoteroRoam.interface.popToast("Something went wrong when updating the data. Check the console for any errors.","warning"):console.log("Something went wrong when updating the data. Check the console for any errors.")}},zoteroRoam.inPage={addContextMenuListener(){for(var e=document.querySelectorAll(".ref-citekey"),t=0;t<e.length;t++){var o=e[t];o.dataset.zoteroBib||(zoteroRoam.data.items.find(e=>e.key==o.dataset.linkTitle.replace("@",""))?o.dataset.zoteroBib="inLibrary":o.dataset.zoteroBib="notFound"),"inLibrary"==o.dataset.zoteroBib&&o.querySelector(".rm-page-ref").addEventListener("contextmenu",zoteroRoam.interface.popContextMenu)}},checkReferences(e=!1){var t;setTimeout(function(){do{var e=document.getElementsByClassName("rm-page-ref");t=zoteroRoam.inPage.identifyCitekeys(e)}while(1==t)},300),zoteroRoam.inPage.checkCitekeys(e),zoteroRoam.inPage.addContextMenuListener()},identifyCitekeys(t){let o=!1;for(i=0;i<t.length;i++){let e=t[i].parentElement;void 0!==e.dataset.linkTitle&&e.dataset.linkTitle.startsWith("@")&&(o=!e.classList.contains("ref-citekey")&&(e.classList.add("ref-citekey"),!0))}return o},checkCitekeys(e=!1){let t=document.querySelectorAll(".ref-citekey"),o=0,a=0;t.forEach(t=>{if(t.dataset.zoteroBib)1==e&&"notFound"==t.dataset.zoteroBib&&(zoteroRoam.data.items.find(e=>e.key==t.dataset.linkTitle.replace("@",""))?(t.dataset.zoteroBib="inLibrary",o+=1):a+=1);else switch(t.dataset.zoteroBib=zoteroRoam.data.items.find(e=>e.key==t.dataset.linkTitle.replace("@",""))?"inLibrary":"notFound",t.dataset.zoteroBib){case"inLibrary":o+=1;break;case"notFound":a+=1}}),0<o|0<a&&console.log(`New matched citekeys: ${o}, New unmatched citekeys: ${a}`)},convertToCitekey(t){var r=zoteroRoam.data.items.find(e=>e.key==t.innerText.slice(1));let e=t.closest(".roam-block");var o=e.id.slice(-9),a=Array.from(e.querySelectorAll(".ref-citekey")).findIndex(e=>e==t.parentNode),i=window.roamAlphaAPI.q("[:find ?text :in $ ?uid :where[?b :block/uid ?uid][?b :block/string ?text]]",o)[0];if(0<i.length){let e=i[0];a=new RegExp(`(.*?(?:\\[\\[@.+?\\]\\].*?){${a}})(\\[\\[@.+?\\]\\])(.*)`,"g"),a=e.replace(a,(e,t,o,a)=>`${t}${zoteroRoam.utils.formatItemReference(r,"citation")}${a}`);window.roamAlphaAPI.updateBlock({block:{uid:o,string:a}})}},async addPageMenus(){for(const h of Array.from(document.querySelectorAll("h1.rm-title-display"))){let m=h.querySelector("span")?h.querySelector("span").innerText:"";if(m.startsWith("@")){var p=zoteroRoam.data.items.find(e=>e.key==m.slice(1));if(void 0!==p){var u=p.data.DOI?zoteroRoam.utils.parseDOI(p.data.DOI):"";if(null==h.parentElement.querySelector(".zotero-roam-page-div")){let e=document.createElement("div");e.classList.add("zotero-roam-page-div"),u&&(e.innerHTML=`
                                <span class="zotero-roam-page-doi" data-doi="${u}">
                                <a href="https://doi.org/${u}" class="bp3-text-muted" target="_blank">${u}</a>
                                </span>
                                `),h.parentElement.appendChild(e)}let d=zoteroRoam.config.params.pageMenu.defaults;if(null==h.parentElement.querySelector(".zotero-roam-page-menu")){let a=document.createElement("div");a.classList.add("zotero-roam-page-menu"),h.parentElement.querySelector(".zotero-roam-page-div").appendChild(a);let e="";d.includes("addMetadata")&&(e=zoteroRoam.utils.renderBP3Button_group(string="Add metadata",{buttonClass:"bp3-minimal zotero-roam-page-menu-add-metadata",icon:"add"}));let t=zoteroRoam.formatting.getItemChildren(p,{pdf_as:"raw",notes_as:"raw"}),o="";d.includes("importNotes")&&(o=t.notes?zoteroRoam.utils.renderBP3Button_group(string="Import notes",{buttonClass:"bp3-minimal zotero-roam-page-menu-import-notes",icon:"comment"}):"");let r="";d.includes("viewItemInfo")&&(r=zoteroRoam.utils.renderBP3Button_group(string="View item information",{buttonClass:"bp3-minimal zotero-roam-page-menu-view-item-info",icon:"info-sign"}));let i="";d.includes("openZoteroLocal")&&(i=zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero (local)",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-local",target:zoteroRoam.formatting.getLocalLink(p,{format:"target"}),linkAttribute:'target="_blank"'}));let n="";d.includes("openZoteroWeb")&&(n=zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero (web)",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-web",target:zoteroRoam.formatting.getWebLink(p,{format:"target"}),linkAttribute:'target="_blank"'}));let s="";d.includes("pdfLinks")&&(s=t.pdfItems?t.pdfItems.map(e=>{var t="group"==e.library.type?`groups/${e.library.id}`:"library",t=["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`zotero://open-pdf/${t}/items/${e.data.key}`:e.data.url,e=e.data.filename||e.data.title;return zoteroRoam.utils.renderBP3Button_link(string=e,{linkClass:"bp3-minimal zotero-roam-page-menu-pdf-link",icon:"paperclip",target:t,linkAttribute:'target="_blank"'})}).join(""):"");let l=[];d.includes("connectedPapers")&&l.push(zoteroRoam.utils.renderBP3Button_link(string="Connected Papers",{icon:"layout",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-connected-papers",linkAttribute:'target="_blank"',target:`https://www.connectedpapers.com/${p.data.DOI?"api/redirect/doi/"+u:"search?q="+encodeURIComponent(p.data.title)}`})),d.includes("semanticScholar")&&l.push(p.data.DOI?zoteroRoam.utils.renderBP3Button_link(string="Semantic Scholar",{icon:"bookmark",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-semantic-scholar",linkAttribute:'target="_blank"',target:`https://api.semanticscholar.org/${u}`}):""),d.includes("googleScholar")&&l.push(zoteroRoam.utils.renderBP3Button_link(string="Google Scholar",{icon:"learning",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-google-scholar",linkAttribute:'target="_blank"',target:`https://scholar.google.com/scholar?q=${p.data.DOI?u:encodeURIComponent(p.data.title)}`}));let c="";if(d.includes("citingPapers")&&p.data.DOI){let e=await zoteroRoam.handlers.requestScitations(u),o=e.citations.map(e=>e.doi);if(0<o.length){let e=zoteroRoam.data.items.filter(e=>e.data.DOI),t=e.filter(e=>o.includes(zoteroRoam.utils.parseDOI(e.data.DOI)));c="<hr>",c+=zoteroRoam.utils.renderBP3Button_group(string=`${0<t.length?t.length:"No"} citations in library`,{buttonClass:"bp3-minimal bp3-intent-success zotero-roam-page-menu-backlinks-button",icon:"caret-down bp3-icon-standard rm-caret rm-caret-closed"}),c+=zoteroRoam.utils.renderBP3Button_group(string=`${o.length} citations available`,{buttonClass:"bp3-minimal bp3-intent-warning zotero-roam-page-menu-backlinks-total",icon:"citation",buttonAttribute:`data-doi=${u}`}),0<t.length&&(c+=`
                                        ...
                                        ${t.map(e=>{var t=zoteroRoam.utils.lookForPage("@"+e.key);return!0!==t.present?`
                                                    ...
                                                    ${zoteroRoam.utils.renderBP3Button_group(string="",{buttonClass:"bp3-minimal bp3-small zotero-roam-page-menu-backlink-add-sidebar",icon:"add-column-right",buttonAttribute:`data-title="@${e.key}" title="Add & open in sidebar"`})}
                                                    ${zoteroRoam.utils.formatItemReference(e,"zettlr_accent")}
                                                    </li>`:`
                                                    <li class="zotero-roam-page-menu-backlinks-item">
                                                    ${zoteroRoam.utils.renderBP3Button_group(string="",{buttonClass:"bp3-minimal bp3-small zotero-roam-page-menu-backlink-open-sidebar",icon:"two-columns",buttonAttribute:`data-uid="${t.uid}" title="Open in sidebar"`})}
                                                    <a href="${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${t.uid}">${zoteroRoam.utils.formatItemReference(e,"zettlr_accent")}</a>
                                                    </li>`}).join("")}
                                        </ul>
                                        `)}}a.innerHTML=`
