...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.91",data:{items:[],collections:[],semantic:new Map,libraries:new Map,keys:[],roamPages:[]},librarySearch:{autocomplete:null},activeImport:{libraries:[],currentLib:{}},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations",activeImport:null},webImport:{currentBlock:null,activeImport:null},tagSelection:{cit_panel:null,aux_panel:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{var o=e.sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1);return Array.from(new Set(o.map(e=>e.value.key))).map(t=>o.find(e=>e.value.key==t))}},selector:"#zotero-roam-search-autocomplete",placeHolder:"Search by title, year, authors (last names), citekey, tags",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",document.getElementById("zotero-roam-library-rendered").removeAttribute("has-results"),!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t,highlight=['<span class="zr-search-match">',"</span>"]),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,tabSelect:!0,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
            ...
            `,i.appendChild(n),a.appendChild(r),a.appendChild(i);let s=document.createElement("div");s.classList.add("rendered-div"),s.style="width:96%;margin:0 auto;",o.appendChild(a),o.appendChild(s),e.appendChild(o);let l=document.createElement("div");l.classList.add("import-header"),l.innerHTML=`
            ...
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,a.appendChild(r);let i=document.createElement("div");i.classList.add("header-bottom");let n=document.createElement("span");n.classList.add("zr-search-scope"),n.innerHTML='Zotero library <span class="bp3-icon bp3-icon-chevron-right"></span>';let s=document.createElement("input");s.id="zotero-roam-search-autocomplete",s.tabIndex="1",s.type="text",s.classList.add("bp3-input"),i.appendChild(n),i.appendChild(s),o.appendChild(a),o.appendChild(i),t.appendChild(o);let l=document.createElement("div");l.id="zotero-roam-library-rendered",l.setAttribute("view","search");let c=document.createElement("div");c.id="zotero-roam-library-search-div";let m=document.createElement("div");m.id="zotero-roam-search-selected-item",m.classList.add("bp3-card");let d=document.createElement("div");d.classList.add("selected-item-header");let p=document.createElement("div");p.classList.add("selected-item-body"),m.appendChild(d),m.appendChild(p),l.appendChild(c),l.appendChild(m),t.appendChild(l);let u=document.createElement("div");u.classList.add("bp3-dialog-footer-actions"),u.innerHTML=`
            <div>
            ...
            <button type="button" aria-label="Close" class="zotero-roam-search-close bp3-button bp3-minimal bp3-dialog-close-button">
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,n.appendChild(s);let l=document.createElement("div");l.classList.add("header-bottom");let c=document.createElement("input");c.id="zotero-roam-citations-autocomplete",c.tabIndex="1",c.type="text",c.classList.add("bp3-input"),l.appendChild(c),a.appendChild(r),a.appendChild(n),a.appendChild(l);let m=document.createElement("div");m.id="zotero-roam-citations-pagination",t.appendChild(a),t.appendChild(m);let d=document.createElement("div");d.classList.add("import-header"),d.innerHTML=`
            ...
            `,t.innerHTML=o.map(t=>{var o,e=`<span class="zotero-roam-search-item-title" style="display:block;">${t.title}</span>`,a=`<span class="zotero-roam-citation-origin zr-highlight-2">${t.authors+(t.year?" ("+t.year+")":"")}</span><span class="zr-secondary">${t.meta}</span>`;let r="";for(o of Object.keys(t.links)){let e=[];switch(o){case"scite":e.push(`<span class="zotero-roam-citation-link" service="scite"><a href="${t.links[o]}" target="_blank">Scite</a></span>`);break;case"connectedPapers":e.push(`<span class="zotero-roam-citation-link" service="connected-papers"><a href="${t.links[o]}" target="_blank">Connected Papers</a></span>`);break;case"semanticScholar":e.push(`<span class="zotero-roam-citation-link" service="semantic-scholar"><a href="${t.links[o]}" target="_blank">Semantic Scholar</a></span>`);break;case"googleScholar":e.push(`<span class="zotero-roam-citation-link" service="google-scholar"><a href="${t.links[o]}" target="_blank">Google Scholar</a></span>`)}r+=e.join(" - ")}let i=`
                <span class="bp3-menu-item-label zotero-roam-search-item-key">
            ...
            `,Array.from(document.querySelectorAll(".item-citekey-section .copy-buttons a.bp3-button[format]")).forEach(a=>{a.addEventListener("click",e=>{let t=zoteroRoam.interface.search.overlay.querySelector("input.clipboard-copy-utility");switch(a.getAttribute("format")){case"citekey":t.value=`${r}`;break;case"citation":var o=`${n.meta.creatorSummary||""}${s||""}`;t.value=`[${o}]([[${r}]])`;break;case"tag":t.value=`#[[${r}]]`;break;case"page-reference":t.value=`[[${r}]]`}t.select(),document.execCommand("copy")})});try{let t=document.querySelector("button.item-see-notes");t.addEventListener("click",function(){let e=t.querySelector(".bp3-button-text").innerHTML;switch(!0){case e.startsWith("Show"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","visible"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Show","Hide");break;case e.startsWith("Hide"):zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),t.querySelector(".bp3-button-text").innerHTML=e.replace("Hide","Show")}})}catch(e){}switch(document.querySelector("#zotero-roam-library-rendered").setAttribute("view","item"),zoteroRoam.interface.search.overlay.getAttribute("overlay-visible")){case"true":document.querySelector("h4.item-title").focus();break;case"false":zoteroRoam.interface.toggleSearchOverlay("show",{focus:!1})}},clearSelectedItem(){try{zoteroRoam.interface.search.selectedItemDiv.children.forEach(e=>{e.innerHTML=""})}catch(e){Array.from(zoteroRoam.interface.search.selectedItemDiv.children).forEach(e=>{e.innerHTML=""})}zoteroRoam.interface.search.overlay.querySelector(".side-panel-contents").innerHTML="","visible"==zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").getAttribute("side-panel")&&zoteroRoam.interface.search.overlay.querySelector(".bp3-dialog").setAttribute("side-panel","hidden"),document.querySelector("#zotero-roam-library-rendered").setAttribute("view","search")},checkEditingMode(){let e=document.querySelector("textarea.rm-block-input");e&&null==e.getAttribute("zotero-tribute")&&(document.querySelectorAll(".zotero-roam-tribute").forEach(e=>e.remove()),e.setAttribute("zotero-tribute","active"),new Tribute(zoteroRoam.config.tribute).attach(e),e.addEventListener("tribute-replaced",o=>{if("zotero"==o.detail.item.original.source){let e=document.querySelector("textarea.rm-block-input");var a=o.detail.context.mentionTriggerChar+o.detail.context.mentionText,r=o.detail.context.mentionPosition,i=o.detail.item.original.value;let t=o.target.defaultValue;o=zoteroRoam.utils.escapeRegExp(a),o=new RegExp(o,"g"),o=t.replaceAll(o,(e,t)=>t==r?i:e);zoteroRoam.interface.tributeTrigger=a,zoteroRoam.interface.tributeBlockTrigger=e,zoteroRoam.interface.tributeNewText=o,Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value").set.call(e,o);o=new Event("input",{bubbles:!0});e.dispatchEvent(o)}}))},triggerImport(e="citations",t=null){let o=document.querySelector(`[zr-import="${e}"]`);var a=("citations"==e?zoteroRoam.citations:zoteroRoam.webImport).activeImport;null==a?(zoteroRoam.data.roamPages=new Map(zoteroRoam.utils.getRoamPages()),zoteroRoam.tagSelection["citations"==e?"cit_panel":"aux_panel"].init(),zoteroRoam.activeImport.libraries=zoteroRoam.utils.getLibraries(),zoteroRoam.interface.renderImportOptions(e)):"citations"==e&&o.querySelector('button[role="done"]')&&zoteroRoam.interface.clearImportPanel(action="reset",e),"citations"==e?zoteroRoam.interface.renderImportCitations(t):"weblinks"==e&&zoteroRoam.interface.renderImportWeblinks(),!!a&&0<a.items.length&&zoteroRoam.activeImport.currentLib?o.querySelector('button[role="add"]').removeAttribute("disabled"):o.querySelector('button[role="add"]').setAttribute("disabled","")},renderImportCitations(e){let t=document.querySelector('[zr-import="citations"]');var o=e.querySelector(".zotero-roam-citation-identifier-link").innerText,a=e.querySelector(".zotero-roam-search-item-title").innerText,r=e.querySelector(".zotero-roam-citation-origin").innerText;null==zoteroRoam.citations.activeImport?(zoteroRoam.citations.activeImport={items:[],outcome:null},zoteroRoam.interface.triggerImport(type="citations",e),t.closest(".bp3-dialog").setAttribute("side-panel","visible")):zoteroRoam.citations.activeImport.items.includes(o)||(zoteroRoam.citations.activeImport.items.push(o),t.querySelector(".import-items").innerHTML+=`
                ...
                </div>`,o.querySelector(".main-panel .rendered-div").innerHTML="",o.querySelector(".bp3-dialog").setAttribute("side-panel","visible"),zoteroRoam.interface.triggerImport(type="weblinks"),o.style.display="block",o.setAttribute("overlay-visible","true");let a=[];t.forEach(e=>{a.push(zoteroRoam.handlers.requestCitoid(query=e))});let r=await Promise.all(a);zoteroRoam.webImport.activeImport={items:null};i=r.filter(e=>1==e.success);0<(zoteroRoam.webImport.activeImport.harvest=i).length?zoteroRoam.interface.fillWebImportDialog(i):o.querySelector(".main-panel .header-left").innerHTML="<p>No data successfully retrieved</p>"}},async renderCitekeyMenu(n,o,a){var s=o.slice(1),l=zoteroRoam.utils.parseDOI(n.data.DOI)||"",c=zoteroRoam.utils.lookForPage(o);let m=zoteroRoam.formatting.getItemChildren(n,{pdf_as:"raw",notes_as:"raw"}),d=zoteroRoam.config.params.pageMenu.defaults,p=a.parentElement.querySelector(".zotero-roam-page-div");if(null==p){p=document.createElement("div"),p.classList.add("zotero-roam-page-div"),p.setAttribute("data-uid",c.uid),p.setAttribute("data-title",o),p.innerHTML=l?`
                <span class="zotero-roam-page-doi" data-doi="${l}">
                <a href="https://doi.org/${l}" class="bp3-text-muted" target="_blank">${l}</a>
                </span>
                `:"",a.insertAdjacentElement("afterend",p);let e=a.parentElement.querySelector(".zotero-roam-page-menu");null==e&&(e=document.createElement("div"),e.classList.add("zotero-roam-page-menu"),e.classList.add("bp3-card"),zoteroRoam.config.params.theme&&e.classList.add(zoteroRoam.config.params.theme),p.appendChild(e));var u=d.includes("addMetadata")?zoteroRoam.utils.renderBP3Button_group(string="Add metadata",{buttonClass:"bp3-minimal zotero-roam-page-menu-add-metadata",icon:"add"}):"",g=d.includes("importNotes")&&m.notes?zoteroRoam.utils.renderBP3Button_group(string="Import notes",{buttonClass:"bp3-minimal zotero-roam-page-menu-import-notes",icon:"comment"}):"",b=d.includes("viewItemInfo")?zoteroRoam.utils.renderBP3Button_group(string="View item information",{buttonClass:"bp3-minimal zotero-roam-page-menu-view-item-info",icon:"info-sign"}):"",h=d.includes("openZoteroLocal")?zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-local",target:zoteroRoam.formatting.getLocalLink(n,{format:"target"}),linkAttribute:'target="_blank"',icon:"application"}):"",y=d.includes("openZoteroWeb")?zoteroRoam.utils.renderBP3Button_link(string="Open in Zotero",{linkClass:"bp3-minimal zotero-roam-page-menu-open-zotero-web",target:zoteroRoam.formatting.getWebLink(n,{format:"target"}),linkAttribute:'target="_blank"',icon:"cloud"}):"",f=d.includes("pdfLinks")&&m.pdfItems?m.pdfItems.map(e=>{var t="group"==e.library.type?`groups/${e.library.id}`:"library",t=["linked_file","imported_file","imported_url"].includes(e.data.linkMode)?`zotero://open-pdf/${t}/items/${e.data.key}`:e.data.url,e=e.data.filename||e.data.title;return zoteroRoam.utils.renderBP3Button_link(string=e,{linkClass:"bp3-minimal zotero-roam-page-menu-pdf-link",icon:"paperclip",target:t,linkAttribute:'target="_blank"'})}).join(""):"";let t=[];d.includes("connectedPapers")&&t.push(zoteroRoam.utils.renderBP3Button_link(string="Connected Papers",{icon:"layout",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-connected-papers",linkAttribute:'target="_blank"',target:`https://www.connectedpapers.com/${n.data.DOI?"api/redirect/doi/"+l:"search?q="+encodeURIComponent(n.data.title)}`})),d.includes("semanticScholar")&&t.push(l?zoteroRoam.utils.renderBP3Button_link(string="Semantic Scholar",{icon:"bookmark",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-semantic-scholar",linkAttribute:'target="_blank"',target:`https://api.semanticscholar.org/${l}`}):""),d.includes("googleScholar")&&t.push(zoteroRoam.utils.renderBP3Button_link(string="Google Scholar",{icon:"learning",linkClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-google-scholar",linkAttribute:'target="_blank"',target:`https://scholar.google.com/scholar?q=${n.data.DOI?l:encodeURIComponent(n.data.title)}`}));let r="",i=null;try{if(d.includes("citingPapers")&&l&&(i=await zoteroRoam.handlers.getSemantic(l),i.data)){let a=i.citations.map(e=>zoteroRoam.utils.parseDOI(e.doi)).filter(Boolean);var z=i.references.map(e=>zoteroRoam.utils.parseDOI(e.doi)).filter(Boolean);let t=[...a,...z];if(0<t.length){let e=zoteroRoam.data.items.filter(e=>zoteroRoam.utils.parseDOI(e.data.DOI)),o=t.map(t=>e.find(e=>zoteroRoam.utils.parseDOI(e.data.DOI)==t)).filter(Boolean);o.forEach((e,t)=>{a.includes(e.data.DOI)?o[t].type="citing":o[t].type="cited"}),r="",r+=zoteroRoam.utils.renderBP3Button_group(string=`${0<i.references.length?i.references.length:"No"} references`,{buttonClass:"bp3-minimal bp3-intent-primary zotero-roam-page-menu-references-total",icon:"citation",buttonAttribute:`data-doi="${l}" data-citekey="${s}" ${0<z.length?"":"disabled"}`}),r+=zoteroRoam.utils.renderBP3Button_group(string=`${0<i.citations.length?i.citations.length:"No"} citing papers`,{buttonClass:"bp3-minimal bp3-intent-warning zotero-roam-page-menu-backlinks-total",icon:"chat",buttonAttribute:`data-doi="${l}" data-citekey="${s}" ${0<a.length?"":"disabled"}`}),r+=zoteroRoam.utils.renderBP3Button_group(string=`${0<o.length?o.length:"No"} related library items`,{buttonClass:`${0<o.length?"":"bp3-disabled"} bp3-minimal zotero-roam-page-menu-backlinks-button`,icon:"caret-down bp3-icon-standard rm-caret rm-caret-closed"}),0<o.length&&(r+=`
                                    <ul class="zotero-roam-page-menu-backlinks-list bp3-list-unstyled bp3-text-small" style="display:none;">
                                    ${zoteroRoam.inPage.renderBacklinksList_year(o,origin_year=n.meta.parsedDate?new Date(n.meta.parsedDate).getUTCFullYear():"")}
                                    </ul>
                ...
                `,d.includes("sciteBadge")&&n.data.DOI&&null==a.parentElement.querySelector(".scite-badge")&&(f=zoteroRoam.inPage.makeSciteBadge(doi=l),a.parentElement.querySelector(".zotero-roam-page-menu-header").appendChild(f),window.__SCITE.insertBadges()),zoteroRoam.events.emit("menu-ready",{title:o,item:n,doi:l,uid:c.uid,children:m,semantic:i,div:p,context:p.closest(".roam-article")?"main":"sidebar"})}},renderCitekeyRefs(){var o=document.querySelectorAll("span[data-link-title^='@']");for(i=0;i<o.length;i++){let e=o[i],t=e.getElementsByClassName("rm-page-ref")[0];var a,r=e.getAttribute("data-zotero-bib"),n=e.getAttribute("data-link-title").slice(1);"inLibrary"==r&&(a=zoteroRoam.data.items.find(e=>e.key==n))?t.textContent=zoteroRoam.utils.formatItemReference(a,"inline"):t.textContent!="@"+n&&(t.textContent="@"+n)}},renderBacklinksItem_year(e,t,o=null){var a="reference"==t?"zr-highlight":"zr-highlight-2",r="reference"==t?"bp3-intent-primary":"bp3-intent-warning";return o?`
                <li class="related-item_listed" item-type="${t}" data-key="@${e.key}" data-item-type="${e.data.itemType}" data-item-year="${e.meta.parsedDate?new Date(e.meta.parsedDate).getUTCFullYear():""}" in-graph="true">
                    ...
                    <div class="related_info">
                        <span class="zotero-roam-search-item-authors ${a}">${e.meta.creatorSummary||""}</span><span class="zr-secondary">${e.data.publicationTitle||e.data.bookTitle||""}</span>
                        <a class="zotero-roam-search-item-title" href="${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${o}">
                            ${e.data.title}
                        </a>
                    </div>
                    <div class="related_state">
                        ${zoteroRoam.utils.renderBP3Button_group(string="",{buttonClass:`bp3-minimal bp3-small ${r} zotero-roam-page-menu-backlink-open-sidebar`,icon:"inheritance",buttonAttribute:`data-uid="${o}" title="Open in sidebar"`})}
                    </div>
                </li>`:`
                ...
                </li>`},renderBacklinksItem(e,t,o=null){var a="reference"==t?"citation":"chat",r="reference"==t?"zr-highlight":"zr-highlight-2";return o?`
                <li class="related-item_listed" item-type="${t}" data-key="@${e.key}" in-graph="true">
                <div class="related_info">
                <a class="related_info-wrapper" href="${window.location.hash.match(/#\/app\/([^\/]+)/g)[0]}/page/${o}"><span><span class="bp3-icon bp3-icon-${a}"></span>${zoteroRoam.utils.formatItemReference(e,"zettlr_accent",{accent_class:r})}</span></a>
                </div>
                <div class="related_state">
                ...
                <div class="related_info">
                <span class="related_info-wrapper"><span class="bp3-icon bp3-icon-${a}"></span>${zoteroRoam.utils.formatItemReference(e,"zettlr_accent",{accent_class:r})}</span>
                </div>
                <div class="related_state">
                ...
                </li>`},renderBacklinksList_year(e,t){let o=new Map(zoteroRoam.utils.getAllRefPages()),a=e.sort((e,t)=>{if(e.meta.parsedDate){if(t.meta.parsedDate){var o=new Date(e.meta.parsedDate).getUTCFullYear()-new Date(t.meta.parsedDate).getUTCFullYear();return o<0||0==o&&e.meta.creatorSummary<t.meta.creatorSummary?-1:1}return-1}return!t.meta.parsedDate&&e.meta.creatorSummary<t.meta.creatorSummary?-1:1}),r=a.filter(e=>"cited"==e.type).map(e=>{var t=o.get("@"+e.key)||null;return zoteroRoam.inPage.renderBacklinksItem_year(e,"reference",uid=t)}),i=a.filter(e=>"citing"==e.type).map(e=>{var t=o.get("@"+e.key)||null;return zoteroRoam.inPage.renderBacklinksItem_year(e,"citation",uid=t)});return`
