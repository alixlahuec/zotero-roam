            ...
            <span tabindex="-1" class="rm-page-ref rm-page-ref--link">${e}</span></span>`},renderPageTag(e){return`<span tabindex="-1" data-tag="${e}" class="rm-page-ref rm-page-ref--tag">#${e}</span>`},sleep(t){return new Promise(e=>setTimeout(e,t))}},zoteroRoam.handlers={async addBlockObject(e,t){if(void 0===t.string)throw console.log(t),new Error("All blocks passed as an Object must have a string property");if(zoteroRoam.utils.addBlock(uid=e,blockString=t.string,order=0),void 0!==t.children){var o=await zoteroRoam.handlers.waitForBlockUID(e,t.string);for(j=t.children.length-1;0<=j;j--)if(t.children[j].constructor===Object)await zoteroRoam.handlers.addBlockObject(o,t.children[j]);else{if(t.children[j].constructor!==String)throw new Error("All children array items should be of type String or Object");zoteroRoam.utils.addBlock(uid=o,blockString=t.children[j],order=0)}}},async addItemData(e){try{var t=e.parentElement.dataset.linkTitle.replace("@",""),o=e.parentElement.dataset.linkUid,a=zoteroRoam.data.items.find(e=>e.key==t);!a||0<(a=await zoteroRoam.handlers.formatData(a)).length&&await zoteroRoam.handlers.addMetadataArray(page_uid=o,arr=a)}catch(e){console.error(e)}},async addMetadataArray(e,t){if(0<t.length){for(k=t.length-1;0<=k;k--)if(t[k].constructor===Object)await zoteroRoam.handlers.addBlockObject(e,t[k]);else{if(t[k].constructor!==String)throw console.log(t[k]),new Error("All array items should be of type String or Object");zoteroRoam.utils.addBlock(uid=e,blockString=t[k],order=0)}return{success:!0}}return console.log("The metadata array was empty ; nothing was done."),{success:!1}},async addSearchResult(e,t){var o=e.replace("@",""),a=zoteroRoam.data.items.find(function(e){return e.key==o}),r=await zoteroRoam.handlers.formatData(a);let n={};if(a&&0<r.length){var s=t||"";if(t)n=await zoteroRoam.handlers.addMetadataArray(page_uid=t,arr=r);else{window.roamAlphaAPI.createPage({page:{title:e}});var i=await zoteroRoam.handlers.waitForPageUID(e);if(null!=i){n=await zoteroRoam.handlers.addMetadataArray(page_uid=i,arr=r);try{let e=document.querySelector(".item-in-graph");null!=e&&(e.innerHTML='<span class="bp3-icon-tick bp3-icon bp3-intent-success"></span><span> In the graph</span>');let t=document.querySelector("item-go-to-page");null!=t&&(t.setAttribute("data-uid",i),t.disabled=!1)}catch(e){}await zoteroRoam.utils.sleep(125)}else console.log(i),alert("There was a problem in obtaining the page's UID.")}if(n.success){let e=window.roamAlphaAPI.q("[:find (count ?chld) :in $ ?uid :where[?p :block/uid ?uid][?p :block/children ?chld]]",s);s=0<e.length?e.toString():"__";alert(`This Roam page now has ${s} child blocks.`)}else alert("The metadata array couldn't be properly processed.")}else console.log(a),console.log(r),alert("Something went wrong when formatting or importing the item's data.")},extractCitekeys(e){return e.map(e=>(void 0!==e.data.extra&&e.data.extra.includes("Citation Key: ")&&(e.key=e.data.extra.match("Citation Key: (.+)")[1]),e))},async fetchData(r,n,t){var o=`https://api.zotero.org/${n}?${t}`;let s=[];try{let e=await fetch(o,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":r}});if(1==e.ok){var l=e.headers.get("Total-Results");let a=new URLSearchParams(t);var c=a.has("start")?Number(a.get("start")):0,d=a.has("limit")?Number(a.get("limit")):100;s=await e.json();var m=c+s.length;if(m<l){var u=Math.ceil((l-m)/d);let e=[];for(i=1;i<=u;i++){var p=m+d*(i-1);a.set("start",p),a.set("limit",d),e.push(fetch(`https://api.zotero.org/${n}?${a.toString()}`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":r}}))}let t=await Promise.all(e),o=await Promise.all(t.map(e=>e.json()));o=o.flat(1),s.push(...o)}}else console.log(`The request for ${e.url} returned a code of ${e.status}`)}catch(e){console.error(e),alert("The extension encountered at least one error during the data request process. Please check the console for details on the problem.")}finally{return{data:s}}},async formatData(e){var t=e.data.itemType;let o=zoteroRoam.funcmap.DEFAULT;zoteroRoam.config.userSettings.funcmap&&(o=zoteroRoam.config.userSettings.funcmap[`${t}`]||zoteroRoam.config.userSettings.funcmap.DEFAULT||o);try{return await zoteroRoam.utils.executeFunctionByName(o,window,e)}catch(e){return console.error(e),console.log(`There was a problem when formatting the item with function ${o}`),[]}},setupUserRequests(){if(!zoteroRoam.config.userSettings.dataRequests)throw new Error("At least one data request object needs to be specified in order to use the extension. Read through the docs for basic setup examples.");{let e=zoteroRoam.config.userSettings.dataRequests;e=e.constructor===Array?e:[e];var r=e.find(e=>void 0!==e.apikey).apikey,n=e.find(e=>void 0!==e.params).params;e=e.map((e,t)=>{var{name:o=`${t}`,apikey:a=r,dataURI:e,params:t=n}=e;return{apikey:a,dataURI:e,params:t,name:o}}),zoteroRoam.config.requests=e}},async requestData(r){if(0==r.length)throw new Error("No data requests were added to the config object - check for upstream problems");try{let o=[],a=[];r.forEach(e=>{var t=e.dataURI.match(/(users|groups)\/(.+?)\//g)[0].slice(0,-1);o.push(zoteroRoam.handlers.fetchData(apiKey=e.apikey,dataURI=e.dataURI,params=e.params)),a.push(fetch(`https://api.zotero.org/${t}/collections`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":e.apikey}}))});let e=await Promise.all(o);e=e.map((e,t)=>e.data.map(e=>(e.requestLabel=r[t].name,e.requestIndex=t,e))).flat(1),e=zoteroRoam.handlers.extractCitekeys(e);let t=await Promise.all(a);return t=await Promise.all(t.map(e=>e.json())),t=t.flat(1),{success:!0,data:{items:e,collections:t}}}catch(e){return console.error(e),{success:!1}}},async requestItemBib(e,t,o,a){var r="user"==e.library.type?"users":"groups",n=zoteroRoam.config.requests[`${e.requestIndex}`].apikey;let s=await fetch(`https://api.zotero.org/${r}/${e.library.id}/items/${e.data.key}?include=bib&style=${t}&linkwrap=${o}&locale=${a}`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":n}});return(await s.json()).bib},async requestItemChildren(e){var t=zoteroRoam.config.requests[`${e.requestIndex}`].apikey;let o=await fetch(`${e.links.self.href}/children`,{method:"GET",headers:{"Zotero-API-Version":3,"Zotero-API-Key":t}});return await o.json()},simplifyDataArray(e){let t=e.filter(e=>!["attachment","note","annotation"].includes(e.data.itemType));return t=t.map(e=>{let t={key:e.key,title:`${e.data.title||""}`,abstract:`${e.data.abstractNote||""}`,authors:`${e.meta.creatorSummary||""}`,year:`${e.meta.parsedDate?new Date(e.meta.parsedDate).getUTCFullYear().toString():""}`,meta:"",tags:e.data.tags.map(e=>e.tag),authorsFull:e.data.creators.map(e=>e.name||[e.firstName,e.lastName].filter(Boolean).join(" ")),authorsRoles:e.data.creators.map(e=>e.creatorType),authorsLastNames:e.data.creators.map(e=>e.lastName),tagsString:e.data.tags.map(e=>`#${e.tag}`).join(", ")};var o=[e.data.publicationTitle,e.data.university,e.data.bookTitle].filter(Boolean);return 0<o.length&&(t.meta+=`, ${o[0]}`),e.data.publisher&&(t.meta+=`, ${e.data.publisher}`,e.data.place&&(t.meta+=`: ${e.data.place}`)),e.data.volume&&(t.meta+=`, ${e.data.volume}`,e.data.issue&&(t.meta+=`(${e.data.issue})`)),t.meta=e.data.pages?t.meta+`, ${e.data.pages}.`:".",t}),t},async waitForBlockUID(e,t){let o=null,a=!1,r=0;try{do{if(o=zoteroRoam.utils.getTopBlockData(e),void 0!==o.text&&o.text==t)return a=!0,o.uid}while(r+=1,await zoteroRoam.utils.sleep(75),r<50&&!a);throw console.log(o),new Error("The top block couldn't be matched")}catch(e){console.error(e)}},async waitForPageUID(e){let t=!1,o=0;do{var a=zoteroRoam.utils.lookForPage(e);if(1==a.present)return t=!0,a.uid}while(o+=1,await zoteroRoam.utils.sleep(75),o<50&&!t);throw new Error(`The page with title "${e}" couldn\'t be found`)}},zoteroRoam.interface={icon:null,portal:{div:null,id:"zotero-data-importer-portal"},contextMenu:{div:null,class:"zotero-context-menu",overlay:{div:null,class:"zotero-context-overlay"},options:{list:[],class:"zotero-context-menu-option",labels:["Import Zotero data to page"]},visible:!1,targetElement:null,position({top:e,left:t}){zoteroRoam.interface.contextMenu.div.style.left=`${t}px`,zoteroRoam.interface.contextMenu.div.style.top=`${e}px`,zoteroRoam.interface.toggleContextOverlay("contextMenu","show")}},iconContextMenu:{div:null,class:"zotero-icon-context-menu",overlay:{div:null,class:"zotero-icon-context-overlay"},options:{list:[],class:"zotero-icon-context-menu-option",labels:["Update Zotero data","Search in dataset..."]},visible:!1,position({top:e,left:t}){zoteroRoam.interface.iconContextMenu.div.style.left=t>=.9*window.innerWidth?`calc(${t}px - 10%)`:`${t}px`,zoteroRoam.interface.iconContextMenu.div.style.top=`calc(${e}px + 3%)`,zoteroRoam.interface.toggleContextOverlay("iconContextMenu","show")}},search:{overlay:null,input:null,selectedItemDiv:null,closeButton:null,updateButton:null,visible:!1},create(){zoteroRoam.interface.createIcon(id="zotero-data-icon"),zoteroRoam.interface.portal.div=zoteroRoam.interface.createPortal(id=zoteroRoam.interface.portal.id),zoteroRoam.interface.createContextMenu(elementKey="contextMenu"),zoteroRoam.interface.createContextMenu(elementKey="iconContextMenu"),zoteroRoam.interface.createSearchOverlay()},setup(){zoteroRoam.interface.icon.addEventListener("click",zoteroRoam.extension.toggle),zoteroRoam.interface.setupContextMenus(["contextMenu","iconContextMenu"]),zoteroRoam.interface.search.updateButton.addEventListener("click",zoteroRoam.extension.update),zoteroRoam.interface.search.closeButton.addEventListener("click",function(){zoteroRoam.interface.toggleSearchOverlay("hide")}),zoteroRoam.interface.search.input.addEventListener("rendered",zoteroRoam.interface.renderNbResults)},createIcon(e){try{document.getElementById(e).closest(".bp3-popover-wrapper").remove()}catch(e){}var t=document.createElement("span");t.classList.add("bp3-popover-wrapper"),t.setAttribute("style","margin-left: 4px;"),t.innerHTML=`<span class="bp3-popover-target"><span id="${e}" status="off" class="bp3-button bp3-icon-manual bp3-minimal bp3-small"></span>`,document.querySelector(".rm-topbar").appendChild(t),zoteroRoam.interface.icon=document.getElementById(e)},createPortal(e){try{document.getElementById(e).remove()}catch(e){}var t=document.createElement("div");return t.classList.add("bp3-portal"),t.id=e,document.getElementById("app").appendChild(t),t},createContextMenu(e){let t=zoteroRoam.interface[`${e}`];try{document.querySelector(`.${t.overlay.class}`).remove()}catch(e){}var o=t.options.labels.map(e=>`<li class="${t.options.class}"><a class="bp3-menu-item bp3-popover-dismiss"><div class="bp3-fill bp3-text-overflow-ellipsis">${e}</div></a></li>`).join(""),a=document.createElement("div");a.classList.add("bp3-overlay"),a.classList.add("bp3-overlay-open"),a.classList.add(`${t.overlay.class}`),a.style="display:none;",a.innerHTML=`<div class="bp3-overlay-backdrop bp3-popover-backdrop bp3-popover-appear-done bp3-popover-enter-done" style="z-index:25;"></div>
                            ...
                            <br>(* searchable fields are : title, year, authors, tags. A more fully-featured search will be available down the road)`,n.appendChild(i);let l=document.createElement("div");l.classList.add("bp3-input-group");let c=document.createElement("input");c.id="zotero-search-autocomplete",c.tabIndex="1",c.type="text",c.classList.add("bp3-input"),c.classList.add("bp3-fill"),c.style="margin-bottom:20px;",l.appendChild(c),n.appendChild(l);let d=document.createElement("div");d.id="zotero-search-selected-item",d.classList.add("bp3-card"),d.style="width:95%;margin:0 auto;display:none;";let m=document.createElement("div");m.classList.add("selected-item-header");let u=document.createElement("div");u.classList.add("selected-item-body"),d.appendChild(m),d.appendChild(u),n.appendChild(d),s.innerHTML=`<div class="bp3-dialog-footer-actions">
                                    ...
                                    <div class="item-citekey">
                                        ...
                                        ${f}
                                    </div>`;let b=document.querySelector(".selected-item-body");a=1==g.present?`data-uid="${g.uid}"`:"disabled",f=`Go to Roam page  ${zoteroRoam.shortcuts.sequences.goToItemPage?zoteroRoam.shortcuts.makeSequenceText("goToItemPage",pre=" "):""}`,f=zoteroRoam.utils.renderBP3ButtonGroup(string=f,{buttonClass:"item-go-to-page",icon:"arrow-right",modifier:"bp3-intent-primary",buttonModifier:`${a}`}),a=`Import metadata  ${zoteroRoam.shortcuts.sequences.importMetadata?zoteroRoam.shortcuts.makeSequenceText("importMetadata",pre=" "):""}`,a=zoteroRoam.utils.renderBP3ButtonGroup(string=a,{buttonClass:"item-add-metadata",icon:"add",modifier:"bp3-intent-primary"});let z=zoteroRoam.formatting.getItemChildren(e,{pdf_as:"raw",notes_as:"raw"}),v="";if(z.remoteChildren)v+="<p>This item has children, but they were not returned by the API data request. This might be due to a request for 'items/top' rather than 'items'.</p>";else try{var R=z.pdfItems?z.pdfItems.map(e=>{e=`<a href="${"linked_file"==e.data.linkMode?`zotero://open-pdf/library/items/${e.data.key}`:e.data.url}">${e.data.title}</a>`;return zoteroRoam.utils.renderBP3ButtonGroup(string=e,{icon:"document-open"})}):"No PDF attachments";v+=R;R=z.notes?zoteroRoam.utils.renderBP3ButtonGroup(string="Show notes below",{buttonClass:"item-see-notes",icon:"comment"}):"";v+=R}catch(e){console.log(z),console.log(pdfDiv),console.log(e),console.log("Something went wrong while getting the item's children data")}b.innerHTML=`<div class="item-additional-metadata">
