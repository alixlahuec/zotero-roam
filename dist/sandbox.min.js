/* @alixlahuec/zotero-roam | 0.6.65 | 2021-10-25 */
...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.updateStartIndex=function(){this.startIndex=(this.currentPage-1)*this.itemsPerPage+1},this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),this.updateStartIndex(),zoteroRoam.interface.renderCitationsPagination()}},version:"0.6.65",data:{items:[],collections:[],semantic:[],libraries:[],keys:[],roamPages:[]},librarySearch:{autocomplete:null},activeImport:{libraries:[],currentLib:{}},citations:{pagination:null,autocomplete:null,currentDOI:"",currentCitekey:"",currentType:"citations",activeImport:null},webImport:{currentBlock:null,activeImport:null},tagSelection:{cit_panel:null,aux_panel:null},config:{autoComplete:{data:{src:async function(){let e=[];return 0<zoteroRoam.data.items.length&&(e=zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)),e},keys:["title","authorsString","year","tagsString","key","_multiField"],cache:!1,filter:e=>{const t=Array.from(new Set(e.map(e=>e.value.key))).map(t=>e.filter(e=>e.value.key==t).sort((t,o)=>zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.keys.findIndex(e=>e==o.key)?-1:1)[0]);return t.sort((e,t)=>0==e.value.authors.length?2:e.value.authors.toLowerCase()<t.value.authors.toLowerCase()||0==t.value.authors.length?-1:0)}},selector:"#zotero-roam-search-autocomplete",placeHolder:"Search by title, year, authors (last names), citekey, tags",wrapper:!1,trigger:e=>0!=e.length||(document.querySelector(".zotero-roam-library-results-count").innerHTML="",!1),searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),resultsList:{class:"zotero-roam-search-results-list",id:"zotero-roam-search-results-list",destination:"#zotero-roam-library-search-div",position:"beforeend",maxResults:100,element:(e,t)=>{e.classList.add("bp3-menu"),t.results&&0<t.results.length&&(document.querySelector(".zotero-roam-library-results-count").innerHTML=`
                            ...
                            `)}},resultItem:{tag:"li",class:"zotero-roam-search_result",id:"zotero-roam-search_result",element:(e,t)=>{var o=`<span class="zotero-roam-search-item-metadata zr-secondary"> ${t.value.meta}</span>`,a=`<span class="zotero-roam-search-item-title" style="display:block;">${"title"==t.key?t.match:t.value.title}</span>`;let r="";r=t.value.inGraph?(e.setAttribute("in-graph","true"),'<span class="bp3-icon bp3-icon-symbol-circle"></span>'):(e.setAttribute("in-graph","false"),'<span class="bp3-icon bp3-icon-minus"></span>'),e.setAttribute("data-item-type",t.value.itemType);var i=t.value.year?` (${t.value.year})`:"",i=`<span class="zotero-roam-search-item-authors zr-highlight">${t.value.authors+i}</span>`;e.innerHTML=`<div label="${t.value.key}" class="bp3-menu-item bp3-popover-dismiss">
            ...
            <span icon="small-cross" class="bp3-icon bp3-icon-small-cross"></span></button>
            `,r.appendChild(i);let n=document.createElement("div");n.classList.add("header-bottom");let s=document.createElement("span");s.classList.add("zr-search-scope"),s.innerHTML='Zotero library <span class="bp3-icon bp3-icon-chevron-right"></span>';let l=document.createElement("input");l.id="zotero-roam-search-autocomplete",l.tabIndex="1",l.type="text",l.classList.add("bp3-input"),n.appendChild(s),n.appendChild(l),o.appendChild(a),o.appendChild(r),o.appendChild(n),t.appendChild(o);let c=document.createElement("div");c.id="zotero-roam-library-rendered",c.setAttribute("view","search");let m=document.createElement("div");m.id="zotero-roam-library-search-div";let d=document.createElement("div");d.id="zotero-roam-search-selected-item",d.classList.add("bp3-card");let p=document.createElement("div");p.classList.add("selected-item-header");let u=document.createElement("div");u.classList.add("selected-item-body"),d.appendChild(p),d.appendChild(u),c.appendChild(m),c.appendChild(d),t.appendChild(c);let g=document.createElement("div");g.classList.add("bp3-dialog-footer-actions"),g.innerHTML=`
