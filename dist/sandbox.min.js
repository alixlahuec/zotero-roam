...
var zoteroRoam={};(()=>{zoteroRoam={Shortcut:function(e){for(k in this.action=e.action,this.template={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},this.watcher={altKey:!1,ctrlKey:!1,metaKey:!1,shiftKey:!1},e.template)this.template[`${k}`]=e.template[`${k}`],this.watcher[`${k}`]=!1;Object.keys(this.template).every(e=>!1===this.template[e])&&(this.template={})},Pagination:function(e){this.data=e.data,this.itemsPerPage=e.itemsPerPage||zoteroRoam.config.params.citations.itemsPerPage,this.currentPage=1,this.nbPages=Math.ceil(this.data.length/this.itemsPerPage),this.startIndex=(this.currentPage-1)*this.itemsPerPage+1,this.getCurrentPageData=function(){return this.getPageData(this.currentPage)},this.getPageData=function(e){return this.data.slice(start=this.itemsPerPage*(e-1),end=this.itemsPerPage*e)},this.previousPage=function(){--this.currentPage,this.currentPage<1&&(this.currentPage=1),zoteroRoam.interface.renderCitationsPagination()},this.nextPage=function(){this.currentPage+=1,this.currentPage>this.nbPages&&(this.currentPage=this.nbPages),zoteroRoam.interface.renderCitationsPagination()}},data:{items:[],collections:[],scite:[]},autoComplete:null,citations:{pagination:null,autocomplete:null},config:{autoComplete:{data:{src:async function(){return 0==zoteroRoam.data.items.length?[]:zoteroRoam.handlers.simplifyDataArray(zoteroRoam.data.items)},key:["title","authorsLastNames","year","tagsString","key","_multiField"],cache:!1,results:e=>{return Array.from(new Set(e.map(e=>e.index))).map(t=>e.filter(e=>e.index===t).sort((t,o)=>zoteroRoam.config.autoComplete.data.key.findIndex(e=>e==t.key)<zoteroRoam.config.autoComplete.data.key.findIndex(e=>o.key)?-1:1)[0])}},selector:"#zotero-search-autocomplete",searchEngine:(e,t)=>zoteroRoam.utils.multiwordMatch(e,t),trigger:{event:["input","focus"]},highlight:!0,maxResults:100,sort:(e,t)=>e.value.authors.toLowerCase()<t.value.authors.toLowerCase()?-1:e.value.authors.toLowerCase()>t.value.authors.toLowerCase()?1:0,resultsList:{className:"zotero-search-results-list",idName:"zotero-search-results-list",container:e=>{e.classList.add("bp3-menu")}},resultItem:{element:"li",className:"zotero-search_result",idName:"zotero-search_result",content:(e,t)=>{var o,a=`<span class="zotero-search-item-metadata"> ${e.value.meta}</span>`,r=`<span class="zotero-search-item-title" style="display:block;">${"title"==e.key?e.match:e.value.title}</span>`,n=`<span class="bp3-menu-item-label zotero-search-item-key">${"key"==e.key?e.match:e.value.key}</span>`;let i="";e.value.year&&(o="year"==e.key?e.match:e.value.year,i=`<span class="zotero-search-item-year"> (${o})</span>`);let s="";e.value.authors&&(s="authorsLastNames"==e.key?`<span class="zotero-search-item-authors autoComplete_highlighted">${e.value.authors}</span>`:`<span class="zotero-search-item-authors">${e.value.authors}</span>`);let l="";e.value.tagsString&&(o="tagsString"==e.key?e.match:e.value.tagsString,l=`<span class="zotero-search-item-tags" style="display:block;">${o}</span>`),t.innerHTML=`<a label="${e.value.key}" class="bp3-menu-item bp3-popover-dismiss">
            ...
            `,r.appendChild(n);let i=document.createElement("ul");i.id="zotero-roam-citations-pagination",i.classList.add("zotero-search-results-list"),i.classList.add("bp3-menu"),i.tabIndex="-1",i.setAttribute("role","listbox"),i.innerText="Loading",r.appendChild(i),o.appendChild(r),t.appendChild(o),zoteroRoam.interface.citations.overlay=document.querySelector(`.${e}-overlay`),zoteroRoam.interface.citations.input=document.querySelector("#zotero-roam-citations-autocomplete"),zoteroRoam.interface.citations.closeButton=document.querySelector(`.${e}-overlay button.zotero-search-close`)},renderCitationsPagination(){let e=document.querySelector("#zotero-roam-citations-pagination ul"),t=zoteroRoam.citations.pagination.getCurrentPageData();e.setAttribute("aria-label",`${zoteroRoam.citations.pagination.startIndex}-${zoteroRoam.citations.pagination.startIndex+t.length-1} out of ${zoteroRoam.citations.pagination.data.length} results`),e.innerHTML=t.map(e=>{var t,o=`<span class="zotero-search-item-title" style="display:block;">${e.title}${e.year?" ("+e.year+")":""}</span>`,a=0<e.keywords.length?`<span class="zotero-search-item-tags">${e.keywords.map(e=>"#"+e).join(", ")}</span>`:"";let r="";for(t of Object.keys(e.links))switch(t){case"scite":r+=`<span class="zotero-roam-citation-link-scite"><a href="${e.links[t]}" target="_blank">Scite</a></span>`;break;case"connectedPapers":r+=`<span class="zotero-roam-citation-link-connected-papers"><a href="${e.links[t]}" target="_blank">Connected Papers</a></span>`;break;case"semanticScholar":r+=`<span class="zotero-roam-citation-link-semantic-scholar"><a href="${e.links[t]}" target="_blank">Semantic Scholar</a></span>`;break;case"googleScholar":r+=`<span class="zotero-roam-citation-link-google-scholar"><a href="${e.links[t]}" target="_blank">Google Scholar</a></span>`}var n=`<span class="bp3-menu-item-label zotero-search-item-key">${e.authors}</span>`;return`
